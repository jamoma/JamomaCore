...
% FIXME: correct Trond's author information
...
%TODO: [NP] I think we should spend at least one sentence that (and why) we are going to use temperature as an symbolic example. Just to start with this big XML-code is a bit awkward. 
...
\texttt{/path/to/the/temperature:/unit Fahrenheit}  %FIXME: "Fahrenheit" Do we want to allow capitals in the namespace or not...maybe its better not to decide this now and write "fahrenheit" instead. [NP]
...
\begin{small}
\bibliographystyle{abbrv} %TODO: the references might be shrinked. eg. "Proc."  for Proceedings etc.; I am also not sure about naming the publisher; "NIME ’03: Proceedings of the 2003 International Conference on New Interfaces for Musical Expression," takes 3 lines..... can we shrink that to "Proc. of 2003 International Conference on New Interfaces for Musical Expression" ? [NP]
