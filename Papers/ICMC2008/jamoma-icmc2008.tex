...
% TODO: We might have to develop the horizontal/vertical a bit in the following paragraph, so that it's not retorically kicking the feet under the rest of the paper...
