...
% TODO: Citation of Csound, SC, ChucK or maybe CMJ article by Jones and Nevile for this control rate notion.
...
The implementation presented for performing ramps provides a simple way of creating complex developments in time from  ...   ADSR - combining simplicity of access with complexity of the result.



Discuss how this can be combined with the WAIT syntax so that one might compose complex curves as combination of the elementary ones.


EXPANDING THE IDEA OF DYNAMICALLY CHANGING VALUES OF PARAMETERS
...
Function Lib can be used outside the context of jcom.parameter and jcom.value: jcom.map

Similarly the Ramp Lib can be used outside the context of jcom.parameter for other scheduled tasks.
...
The authors would like to thank all Jamoma developers, in particular Pascal Baltazar, for valuable contributions. A workshop hosted by iMAL Center for Digital Cultures and Technology\footnote{\url{http://imal.org/}}, Brussels, with additional support from GMEA, Centre National de Création Musicale\footnote{\url{http://www.gmea.net}} was of particular importance in the process of developing the issues presented in this paper.
