...
% CHANGED [TAP] The abstract should be in the third person.
...
Plans to extend %CHANGED: move this from the FunctionLib to Future Work [NP] 
...
% 4 ramp units times 5 function units = 20 ramping modes (see Figure \ref{fig:combinations}).
...
%
%La de da...right now 1ºC in Montreal %TODO: not necessary, or should go to the Dataspace subsection [NP]
