...
% CHANGED [ARJ] I think it is good that the introduction is conceptual, but we need to also clearly state the problem, define key terms, and explain what is the purpose of the paper. 
...
% NOTE [ARJ] I think these reflections are important to explain what we are doing, so I have added them back in.
