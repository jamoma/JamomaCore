...
Fundamental to the development of musical or artistic content is the ability to transform raw \emph{materials}. This ability implies the facility to master many facets of the material, and to shape it with plasticity. In our contexts, the \emph{materials} we are working with are media related to time-based art, such as real-time processing of audio, video, midi or other kinds of data as part of a performance. The plasticity we refer to means we want to easily shape and mold our materials into a final sonic or visual output.
