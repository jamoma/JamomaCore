...
% TODO: In passing mention mapping as a third archetype, and throw in a reference to a recent paper reviewing research on mapping. This should not be more than one sentence, elseway we start sidestepping.
