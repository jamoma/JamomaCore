...
Jamoma\footnote{\url{http://www.jamoma.org}} is a collaborative set of software tools\cite{Place:2006jamoma}. It consists of a DSP libraries and a framework for structuring Max/MSP patches.\\
...
The signals can also carry encoded audio signals such as the Ambisonics B-format of the Nth order.
