...
Examples of such hierarchical rendering methods are Directional Audio Coding (DIRAC) \cite{Pulkki2007dirac_1}, Ambisonics B-Format, Higher-order Ambisonics, MPEG Surround, DTS, or AC-3.
...
This layer contains all software applications that enables the end-user to create spatial audio content without the need to control underlying processes directly. Authoring applications may differ remarkably from each other in order to serve the requirements for varicolored approaches to spatialization.
