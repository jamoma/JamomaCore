...
Because all modules have been equipped with a standardized OSC namespace, users can rapidly combine or substituted modules in order to adapt to specific requirements. For example the interoperability with Holo-Edit, ICST Ambimonitor and physical interfaces, such as Jazzmutant's Lemur %\footnote{\url{http://www.jazzmutant.com}} 
or TUIO-compliant \cite{kaltenbrunner2005tpt} multitouch devices through MMF\footnote{\url{http://code.google.com/p/mmf}} facilitates the individual control of Jamoma.
