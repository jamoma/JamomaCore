...
Further listening tests and usage experimentations

Hull Combination with weights : A hull is created for each source Including all speakers with non null weights
Representation : Convex hulls : Spatial fade
