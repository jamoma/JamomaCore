...
The Score framework is based on the Jamoma Foundation which allows to setup a Peer Object Model mechanism in order to embedded easily the features inside many environments (such as Max) or inside specific application dealing with logical and temporal constraints. It also provides a tree structure to manage the namespace of an application in order to organize and access its services.

Documentation / API
Jamoma Modular API is described at http://api.jamoma.org/group__score.html


License
Jamoma Score framework is licensed as open source software under the terms of the "CeCILL-C".


Known Issues & Wish List
See the issue tracker at https://github.com/jamoma/JamomaCore/labels/lib/Score
