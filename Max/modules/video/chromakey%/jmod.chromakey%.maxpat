	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "jcom.parameter chromakey/color @repetitions/allow 0 @type array @range/bounds 0. 1. @range/clipmode both @description \"Chroma keying color (RGB in the range 0-1).\"",
					"varname" : "key/blue[1]"
				}
