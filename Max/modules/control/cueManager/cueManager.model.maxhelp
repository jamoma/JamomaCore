...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 67.0, 341.0, 104.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.0, 244.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 205.0, 345.0, 150.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 65.0, 401.0, 100.0, 17.0 ],
					"text" : "degrade~.model"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 374.0, 100.0, 17.0 ],
					"text" : "mouse.model"
				}
