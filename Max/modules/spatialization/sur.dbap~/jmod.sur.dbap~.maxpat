...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter.array 32 source weight @type decimalArray @range/bounds 0. 1. @description \"Set spatial weight of the nth source.\""
				}
