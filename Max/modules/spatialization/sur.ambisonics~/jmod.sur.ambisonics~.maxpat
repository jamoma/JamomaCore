{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 111.0, 79.0, 1123.0, 562.0 ],
		"bglocked" : 0,
		"defrect" : [ 111.0, 79.0, 1123.0, 562.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 493.0, 300.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 68.0, 295.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 810.0, 495.0, 100.0, 17.0 ],
					"text" : "range/bounds 1 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 704.0, 497.0, 100.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 712.0, 465.0, 221.0, 19.0 ],
					"text" : "sel Furse-Malham N3D"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 424.0, 431.0, 596.0, 31.0 ],
					"text" : "jcom.parameter flavor @repetitions/allow 0 @type string @description \"Ambisonics type of decoding and encoding. Furse-Malham or N3D\"",
...
, 			{
				"box" : 				{
					...
					"id" : "obj-38",
					"items" : [ "Furse-Malham", ",", "N3D" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 308.0, 434.744507, 112.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 26.0, 41.744507, 112.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 398.0, 523.0, 34.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 139.0, 42.0, 33.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 438.0, 521.0, 596.0, 31.0 ],
					"text" : "jcom.parameter order @repetitions/allow 0 @type integer @range/bounds 1 8 @range/clipmode both @description \"Ambisonics order of decoding and encoding\"",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 69.0, 516.0, 47.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 84.0, 48.0, 19.0 ],
					"text" : "Center:"
				}
...
,
					"patching_rect" : [ 345.0, 140.0, 69.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 329.0, 243.0, 614.0, 187.0 ],
						"bglocked" : 0,
						"defrect" : [ 329.0, 243.0, 614.0, 187.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 151.0, 6.0, 70.0, 18.0 ],
									"text" : "/source. $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 89.0, 30.0, 60.0, 18.0 ],
									"text" : "/source.1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 89.0, 8.0, 55.0, 20.0 ],
									"text" : "jcom.init"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 197.0, 250.0, 150.0, 20.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "bang" ],
									"patching_rect" : [ 246.0, 5.0, 50.0, 20.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 301.0, 7.0, 77.0, 18.0 ],
									"text" : "maximum $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 336.0, 105.0, 188.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 88.0, 106.0, 216.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 88.0, 82.0, 137.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 151.0, 28.0, 125.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 87.0, 53.0, 85.0, 20.0 ],
									"text" : "jcom.oscroute"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 336.0, 82.0, 199.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 69.0, 273.485443, 19.0, 19.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 73.0, 247.485443, 19.0, 19.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 18.0, 211.485443, 150.0, 20.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 95.0, 325.941742, 150.0, 20.0 ],
									"presentation" : 1,
...
,
									"patching_rect" : [ 88.0, 168.504852, 440.0, 19.0 ],
									"saved_object_attributes" : 									{
										"default_fontname" : "Verdana",
										"fontname" : "Verdana",
										"default_fontsize" : 10.0,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 88.0, 196.825241, 534.0, 129.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 310.0, 238.0, 128.0, 128.0 ],
									"presentation" : 1,
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-50", 0 ],
									"hidden" : 1,
									"midpoints" : [ 97.5, 194.665039, 97.5, 194.665039 ],
									"source" : [ "obj-48", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"hidden" : 0,
									"midpoints" : [ 162.5, 76.5, 345.5, 76.5 ],
									"source" : [ "obj-5", 1 ]
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 271.0, 84.0, 27.0, 18.0 ],
					"rounded" : 8.0,
					"text" : "plot"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 213.0, 516.0, 150.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 62.0, 127.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 168.0, 518.0, 40.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 192.0, 84.0, 38.0, 19.0 ],
					"text" : "decay"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 122.0, 516.0, 40.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 127.0, 84.0, 37.0, 19.0 ],
					"text" : "curve"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 516.0, 40.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 69.0, 84.0, 28.0, 19.0 ],
					"text" : "size"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 225.0, 84.0, 35.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 160.0, 84.0, 32.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 96.0, 84.0, 33.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 334.0, 119.0, 100.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 189.0, 62.0, 31.0, 19.0 ],
					"truncate" : 0,
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 277.0, 166.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 223.0, 62.0, 34.0, 19.0 ],
					"triangle" : 0,
					"varname" : "daFact"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 272.0, 138.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 224.0, 62.0, 34.0, 19.0 ],
					"triangle" : 0,
					"varname" : "dBunit"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 150.0, 62.0, 34.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 259.0, 62.0, 35.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 476.0, 160.0, 587.0, 31.0 ],
