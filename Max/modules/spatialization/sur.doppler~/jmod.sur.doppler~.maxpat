...
, 			{
				"box" : 				{
					...
					"text" : "jcom.message.array 32 source position @type array @dataspace position @dataspace/unit xyz @value/default 0. 0. 0. @description \"Position of the Nth source. In cartesian coordinates (xyz) by default \""
				}
