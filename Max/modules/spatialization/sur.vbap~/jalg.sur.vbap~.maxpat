...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 261.0, 356.0, 812.0, 326.0 ],
						"bglocked" : 0,
						"defrect" : [ 261.0, 356.0, 812.0, 326.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 469.0, 159.0, 59.0, 19.0 ],
									"text" : "jcom.thru"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 469.0, 134.0, 81.0, 17.0 ],
									"text" : "numInputs $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 376.0, 133.0, 89.0, 17.0 ],
									"text" : "numOutputs $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 6,
									"outlettype" : [ "", "", "", "", "", "" ],
									"patching_rect" : [ 265.0, 105.0, 507.0, 19.0 ],
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"hidden" : 0,
									"midpoints" : [ 478.5, 238.0, 34.5, 238.0 ],
									"source" : [ "obj-13", 0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 180.0, 162.0, 600.0, 426.0 ],
										"bglocked" : 0,
										"defrect" : [ 180.0, 162.0, 600.0, 426.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 53.0, 213.0, 196.0, 41.0 ],
													"text" : "script connect multiout 0 matrix 0, script connect messages 0 matrix 0, script connect matrix 0 multiin 0"
												}
...
,
									"patching_rect" : [ 375.0, 394.0, 98.0, 19.0 ],
									"saved_object_attributes" : 									{
										"default_fontface" : 0,
										"default_fontname" : "Verdana",
										"fontname" : "Verdana",
									...
									"patcher" : 									{
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 30.0, 118.0, 583.0, 31.0 ],
													"text" : "sprintf script newobject newobj @text \\\"jcom.matrix≈ @numInputs %ld @numOutputs %ld \\\" @varname matrix @patching_position 275. 187."
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-11", 1 ],
													"hidden" : 0,
													"midpoints" : [ 120.5, 63.0, 603.5, 63.0 ],
													"source" : [ "obj-12", 0 ]
												}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									"destination" : [ "obj-28", 0 ],
									"hidden" : 0,
									"midpoints" : [ 384.5, 432.5, 249.5, 432.5 ],
									"source" : [ "obj-10", 0 ]
								}
...
,
					"patching_rect" : [ 45.0, 125.0, 63.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Verdana",
						"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 45.0, 155.0, 67.0, 19.0 ],
