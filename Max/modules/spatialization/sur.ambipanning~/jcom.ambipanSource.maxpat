...
, 			{
				"box" : 				{
					...
					"text" : "jcom.message source.1/distance/dBUnit @type decimal @range/bounds 0. 100. @range/clipmode both @ramp/drive scheduler @ramp/function linear @description \"Sets the distance unit for the exponential distance model.\" @dataspace gain @dataspace/unit/active dB"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.message source.1/gain @type decimal @ramp/drive scheduler @ramp/function linear @range/bounds 0. 127. @range/clipmode low @dataspace gain @dataspace/unit/active midi @description \"Input gain for the nth source.\""
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.message source.1/position @type array @dataspace position @dataspace/unit/active xyz @description \"Position of the nth source.\""
				}
