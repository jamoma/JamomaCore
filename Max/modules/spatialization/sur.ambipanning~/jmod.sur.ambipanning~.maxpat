...
, 			{
				"box" : 				{
					...
					"text" : "jcom.message.array 32 speaker position @type array @dataspace position @dataspace/unit/active xyz @dataspace/unit/native xyz @description \"Position of the nth source.\""
				}
