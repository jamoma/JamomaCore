...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter aux.3/gain @repetitions/allow 0 @type decimal @range/bounds 0 127 @range/clipmode both @ramp/drive scheduler @dataspace gain @dataspace/unit midi @description \"gain of the input cable applied to all aux bus 3\"",
					"varname" : "aux.3/gain"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter aux.2/gain @repetitions/allow 0 @type decimal @range/bounds 0 127 @range/clipmode both @ramp/drive scheduler @dataspace gain @dataspace/unit midi @description \"gain of the input cable applied to aux bus 2\"",
					"varname" : "aux.2/gain"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter aux.1/gain @repetitions/allow 0 @type decimal @range/bounds 0 127 @range/clipmode both @ramp/drive scheduler @dataspace gain @dataspace/unit midi @description \"gain of the input cable applied to aux bus 1\"",
					"varname" : "aux.1/gain"
				}
