...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter frequency @type decimal @range/bounds 0. 20000. @ramp/drive scheduler @description \"Frequency used.\" @dataspace time @dataspace/unit/active Hz",
					"varname" : "frequency"
				}
