	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.0, 286.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 140.0, 319.0, 152.0, 19.0 ],
					"text" : "jcom.in~ 4"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 140.0, 464.0, 86.0, 19.0 ],
					"text" : "jcom.out~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 174.0, 502.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.hub @context model @type audio @description \"Allows crossfades between 2 stereo sources. The first two inputs are the first source while the second 2 inputs are the second source\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 140.0, 437.0, 152.0, 19.0 ],
					"text" : "jcom.xfade~ 2"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 325.5, 395.5, 282.5, 395.5 ],
					"source" : [ "obj-23", 0 ]
				}
