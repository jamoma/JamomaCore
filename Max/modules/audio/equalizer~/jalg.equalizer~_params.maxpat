{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ -74.0, 44.0, 1325.0, 785.0 ],
		"bglocked" : 0,
		"defrect" : [ -74.0, 44.0, 1325.0, 785.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 480.0, 465.0, 518.0, 43.0 ],
					"text" : "jcom.parameter filter.0/gain @type decimal @range/bounds -24 24 @range/clipmode both @ramp/drive scheduler @repetitions/allow 0 @description \"Gain (dB)\" @dataspace gain @dataspace/unit/active dB @dataspace/unit/native dB"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter filter.0/frequency @type decimal @range/bounds 30. 11025. @range/clipmode both @ramp/drive scheduler @repetitions/allow 0 @description \"Center frequency (Hz)\" @dataspace time @dataspace/unit/active Hz @dataspace/unit/native Hz"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter filter.0/q @type decimal @ramp/drive scheduler @range/bounds 0. 100. @range/clipmode both @repetitions/allow 0 @description \"Resonance (Q)\""
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter filter.0/type @type string @description \"What kind of filter to use. Possible values: lowpass | highpass | bandpass | bandstop | peaknotch | lowshelf | highshelf\""
				}
