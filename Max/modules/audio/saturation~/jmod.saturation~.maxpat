					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 130.0, 125.0, 52.0, 17.0 ],
									"text" : "drive $2"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"hidden" : 0,
									"midpoints" : [ 139.5, 169.0, 344.5, 169.0 ],
									"source" : [ "obj-6", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter depth @ramp/drive scheduler @repetitions/allow 0 @type decimal @range/bounds 0 99 @range/clipmode both @description \"Saturation: Depth.\"",
					"varname" : "depth"
				}
