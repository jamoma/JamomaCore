...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter preamp @ramp/drive scheduler @repetitions/allow 0 @type decimal @range/bounds -12 48 @range/clipmode none @description \"Preamp (dB).\" @dataspace gain @dataspace/unit/active dB",
					"varname" : "preamp"
				}
