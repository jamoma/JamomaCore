	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 374.0, 566.0, 50.0, 17.0 ],
					"text" : "address"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 374.0, 544.0, 54.0, 19.0 ],
					"text" : "jcom.init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 374.0, 586.0, 70.0, 19.0 ],
					"text" : "jcom.preset"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.return audio/amplitude.2 @type decimal @range/bounds 0. 1. @enable 0 @description \"instant amplitude of the signal number 2\" @repetitions/allow 1 @dataspace gain @dataspace/unit/native linear"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.return audio/amplitude.1 @type decimal @range/bounds 0. 1. @enable 0 @description \"instant amplitude of the signal number 1\" @repetitions/allow 1 @dataspace gain @dataspace/unit/native linear"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 293.0, 166.0, 204.0, 199.0 ],
						"bglocked" : 0,
						"defrect" : [ 293.0, 166.0, 204.0, 199.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 347.0, 618.0, 46.0, 19.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"fontface" : 0,
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 19.0, 543.0, 347.0, 31.0 ],
					"text" : "jcom.hub @description \"A generic module for stereo audio output. Includes saturation , limiter and recording device\" @has_panel 1",
					"varname" : "jcom.hub"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 166.0, 149.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 441.0, 131.0, 805.0, 593.0 ],
						"bglocked" : 0,
						"defrect" : [ 441.0, 131.0, 805.0, 593.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 100.0, 128.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										...
										"bglocked" : 0,
										"defrect" : [ 203.0, 207.0, 724.0, 623.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										...
										"bglocked" : 0,
										"defrect" : [ 351.0, 67.0, 929.0, 366.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 650.0, 150.0, 104.0, 19.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 209.0, 309.0, 24.0, 24.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "signal", "signal", "" ],
													"patching_rect" : [ 135.0, 270.0, 166.0, 19.0 ],
													"text" : "jcom.overdrive~ @dcBlocker 1"
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 322.0, 136.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										...
										"bglocked" : 0,
										"defrect" : [ 273.0, 87.0, 628.0, 368.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										...
										"bglocked" : 0,
										"defrect" : [ 728.0, 103.0, 547.0, 407.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 193.0, 149.0, 79.0, 19.0 ],
					"text" : "-- audio in --"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-85", 2 ],
					"hidden" : 0,
					"midpoints" : [ 177.0, 239.0, 199.5, 239.0 ],
					"source" : [ "obj-7", 1 ]
				}
