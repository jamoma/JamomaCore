...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter release @type decimal @range/bounds 0 500 @range/clipmode low @dataspace time @dataspace/unit/active ms @ramp/drive scheduler @description \"The release time (ms).\"",
					"varname" : "release"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter lookahead @type integer @range/bounds 0 256 @range/clipmode both @ramp/drive scheduler @repetitions/allow 0 @dataspace time @dataspace/unit/active sample @description \"The number of samples (up to 256) to look ahead into the signal to see what is coming.\"",
					"varname" : "lookahead"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter threshold @type decimal @range/bounds -48 6 @range/clipmode none @ramp/drive scheduler @dataspace gain @dataspace/unit/active dB @description \"The limiter threshold (in dB below full scale). When the input signal level exceeds this threshold, it will be attenuated as necessary to keep the level below the threshold.\"",
					"varname" : "threshold"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter postamp @type decimal @range/bounds -6 48 @range/clipmode none @dataspace gain @dataspace/unit/active dB @ramp/drive scheduler @description \"The gain in dB applied to the signal after limiting. \"",
					"varname" : "postamp"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter preamp @type decimal @range/bounds -6 48 @range/clipmode none @ramp/drive scheduler @dataspace gain @dataspace/unit/active dB @ramp/function linear @description \"The gain in dB applied to the signal before limiting.\"",
					"varname" : "preamp"
				}
