...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter rolloff @type decimal @range/bounds -96 0. @range/clipmode high @ramp/drive scheduler @ramp/function linear @description \"Rolloff in dB for the Gaussian windowing function.\" @dataspace gain @dataspace/unit/active dB",
					"varname" : "rolloff"
				}
