...
, 			{
				"box" : 				{
					...
					"id" : "obj-59",
					"items" : [ "/interface/view/documentation/generate", ",", "/interface/ui/out/mute", ",", "/player.A/preset", ",", "/interface/ui/panel", ",", "/interface/ui/size", ",", "/player.B/preset", ",", "/interface/file/load", ",", "/player.A/preset/write", ",", "/player.A/preset/store/current", ",", "/player.B/play", ",", "/interface/view/internals", ",", "/player.A/preset/remove/next", ",", "/interface/ui/freeze", ",", "/player.B/model/class", ",", "/player.A/preset/remove", ",", "/interface/ui/color/contentBackground", ",", "/player.A/file/path", ",", "/player.B/out/preview", ",", "/player.B/file/path", ",", "/player.A/model/reference", ",", "/player.B/preset/read/again", ",", "/player.B/preset/remove/next", ",", "/player.A/preset/recall/current", ",", "/interface/model/address", ",", "/player.A/rate", ",", "/player.B/preset/write/again", ",", "/player.B/file/load", ",", "/player.B/out/mute", ",", "/player.A/preset/read/again", ",", "/player.A/out/preview", ",", "/interface", ",", "/player.B/out/freeze", ",", "/player.B/preset/recall/next", ",", "/player.B/preset/recall", ",", "/interface/view/mute", ",", "/interface/ui/out/freeze", ",", "/player.A/preset/write/again", ",", "/player.B/preset/store/current", ",", "/interface/file/path", ",", "/player.B/rate", ",", "/player.A/preset/remove/previous", ",", "/interface/fps", ",", "/player.B/preset/recall/previous", ",", "/interface/play", ",", "/player.A/model/class", ",", "/player.B/preset/store/next", ",", "/player.A/preset/store/next", ",", "/player.A/preset/recall", ",", "/player.B/preset/store", ",", "/interface/ui/color/toolbarBackground", ",", "/player.A/fps", ",", "/interface/rate", ",", "/player.A/file/load", ",", "/player.A/model/internals", ",", "/player.B/preset/remove/previous", ",", "/interface/view/help", ",", "/player.A/preset/remove/current", ",", "/interface/ui/out/preview", ",", "/interface/view/class", ",", "/player.A/model/address", ",", "/player.A/out", ",", "/player.A/model/documentation/generate", ",", "/player.A/model/help", ",", "/player.A/preset/store/previous", ",", "/player.B/model/address", ",", "/player.B/preset/remove", ",", "/player.B/preset/read", ",", "/player.A", ",", "/player.A/preset/names", ",", "/player.B/preset/store/previous", ",", "/player.B/out", ",", "/interface/view/reference", ",", "/player.B/fps", ",", "/player.B/model/internals", ",", "/player.B/model/documentation/generate", ",", "/player.A/preset/recall/next", ",", "/player.B/model/reference", ",", "/player.A/model/mute", ",", "/player.A/preset/recall/previous", ",", "/player.B/preset/remove/current", ",", "/player.A/preset/store", ",", "/interface/ui/color/border", ",", "/player.A/out/mute", ",", "/player.B", ",", "/player.B/preset/names", ",", "/interface/ui/color/toolbarText", ",", "/player.B/model/mute", ",", "/player.B/model/help", ",", "/interface/ui/refresh", ",", "/player.A/out/freeze", ",", "/player.A/play", ",", "/player.A/preset/read", ",", "/player.B/preset/recall/current", ",", "/player.B/preset/write" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
