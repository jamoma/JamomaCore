...
void TTNodeLibInit()
{
    ...
    ttRegexForDirectory = new TTRegex(R"(([-\w]+):/)");
    ttRegexForAttribute = new TTRegex(":+", 0);
    ttRegexForParent = new TTRegex(R"((.*)/+(\S+))");
    ttRegexForInstance = new TTRegex("[.]", 0);
    ttRegexForInstanceZero = new TTRegex(R"(\.0)", 0);
