...
const float TTLookupEqualPower[] = {			// 512 point equal-power table
...
const float TTLookupHalfPaddedWelch[] = {		// 256 point window table
...
const float TTLookupQuarterSine[] = {		// 128 point quarter sine wave table
...
// TODO: Need to implement accessors for the global sample-rate
// TODO: Do we need an inherited and global vector-size for objects?
