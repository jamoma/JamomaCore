...
// DSP LOOP - STEREO
void tt_limiter::dsp_vector_calc_stereo(tt_audio_signal *in1, tt_audio_signal *in2, tt_audio_signal *out1, tt_audio_signal *out2)
{
...
void tt_limiter::dsp_vector_calc_mono(tt_audio_signal *in, tt_audio_signal *out)
{
	double left_sample, right_sample, curgain, newgain, inc;
	double acc, maybe;
	long ind, flag, bbp, i;
...
// DSP LOOP - STEREO
void tt_limiter::dsp_vector_calc_stereo_nodcblock(tt_audio_signal *in1, tt_audio_signal *in2, tt_audio_signal *out1, tt_audio_signal *out2)
{
	double left_sample, right_sample, curgain, newgain, inc;
	double acc, maybe;
	long ind, flag, bbp, i;
...
// DSP LOOP - MONO
// NOTE: This is no more efficient than the stereo version - need to optimize sometime
void tt_limiter::dsp_vector_calc_mono_nodcblock(tt_audio_signal *in, tt_audio_signal *out)
{
	double left_sample, right_sample, curgain, newgain, inc;
	double acc, maybe;
	long ind, flag, bbp, i;
