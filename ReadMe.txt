Jamoma Graph
Asynchronous Control Graph Layer built on the Jamoma Foundation API
_________________________________________________________________


Introduction
Jamoma Graph is an open source wrapper for JamomaFoundation classes to create dynamic asynchronous topographies of interacting objects.


Features
- graph conversion between various representations
...
License
Jamoma Graph is licensed as open source software under the terms of the "New BSD License".


Known Issues & Wish List
See the issue tracker at http://redmine.jamoma.org/projects/graph/issues
