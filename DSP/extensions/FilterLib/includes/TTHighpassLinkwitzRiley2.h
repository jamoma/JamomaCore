 ...
 *
 * 2nd order Linkwitz-Riley filters are typically used as crossover filters, with the following properties:
 *
 ...
 *
 */
class TTHighpassLinkwitzRiley2 : public TTAudioObjectBase {
...
#endif // __TT_HIGHPASS_LINKWITZ_RILEY_2_H__
