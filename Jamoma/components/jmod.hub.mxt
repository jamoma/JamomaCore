...
#P newex 872 200 63 196617 fromsymbol;
#P newex 857 144 92 196617 tap.typecheck;
...
#P window setfont "Sans Serif" 9.;
#P newex 171 107 51 196617 tap.round;
...
#N vpatcher 237 245 753 645;
#P window setfont "Sans Serif" 9.;
#P newex 174 124 51 196617 tap.round;
#P window setfont "Lucida Grande" 12.;
...
#P connect 32 6 124 0;
#P connect 29 2 12 0;
#P connect 43 1 12 0;
#P connect 86 0 88 0;
#P connect 88 0 87 0;
#P connect 101 0 11 0;
#P connect 32 1 11 0;
#P connect 124 0 58 0;
#P connect 58 0 60 0;
#P connect 60 0 59 0;
#P connect 60 1 61 0;
#P connect 58 1 59 1;
...
#P connect 62 0 96 0;
#P connect 97 0 96 0;
#P connect 113 0 96 0;
#P connect 114 0 96 0;
#P connect 32 4 112 0;
#P connect 112 0 89 0;
#P connect 89 0 90 0;
#P connect 106 0 90 0;
#P connect 85 0 100 0;
#P connect 96 1 98 0;
#P connect 63 1 64 0;
#P connect 96 3 115 0;
#P connect 116 0 65 0;
#P connect 115 0 65 0;
#P connect 99 0 65 0;
#P connect 98 0 65 0;
#P connect 96 2 33 0;
#P connect 65 0 33 0;
#P connect 100 0 33 0;
#P connect 116 1 33 0;
#P connect 63 2 97 0;
#P connect 96 4 116 0;
#P connect 63 3 113 0;
#P fasten 30 1 31 0 597 474 364 474;
#P connect 31 0 107 0;
#P connect 108 0 111 0;
#P connect 111 0 106 0;
#P connect 63 4 114 0;
#P connect 101 0 96 1;
...
#P fasten 109 1 111 1 461 579 440 579;
#P connect 32 2 53 0;
#P connect 53 0 49 0;
#P connect 32 3 49 0;
#P connect 49 0 51 0;
...
#P connect 83 0 78 0;
#P connect 78 0 81 0;
#P fasten 123 0 71 0 779 400 734 400;
#P connect 117 1 71 0;
#P connect 117 0 71 0;
#P connect 81 0 71 0;
#P fasten 74 0 71 0 816 402 734 402;
#P fasten 92 0 71 0 886 404 734 404;
#P connect 32 5 121 0;
#P connect 103 0 101 0;
#P connect 70 0 75 0;
#P connect 77 0 75 0;
#P connect 94 0 118 0;
#P connect 118 1 95 0;
#P connect 93 0 117 0;
#P connect 95 0 117 0;
#P connect 119 1 93 0;
#P connect 84 0 119 0;
#P connect 118 0 117 1;
#P fasten 78 1 80 0 753 320 779 320;
#P connect 80 0 123 0;
#P connect 75 0 102 0;
#P connect 102 0 103 0;
#P connect 119 0 117 2;
#P connect 76 0 74 0;
#P connect 105 0 103 1;
#P connect 104 1 103 1;
#P connect 104 2 103 1;
#P connect 104 3 103 1;
#P connect 104 5 103 1;
#P connect 102 1 104 0;
#P connect 104 4 105 0;
#P connect 76 0 77 0;
#P connect 76 0 122 0;
#P connect 121 0 120 0;
#P connect 122 0 120 0;
#P connect 76 0 92 0;
#P pop;
