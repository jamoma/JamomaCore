...
#P message 116 316 50 196617;
#P newex 98 315 14 196617 _;
#P flonum 72 383 35 9 0 0 0 3 0 0 0 221 221 221 222 222 222 0 0 0;
...
#P inlet 53 133 15 0;
#P newex 53 531 61 196617 prepend set;
#P newex 110 414 103 196617 loadmess -2000000.;
#P newex 53 414 55 196617 tap.change;
#P newex 53 453 115 196617 pattr gain_master_midi;
#X prestore 1 0 -206.333313;
#P objectname gain_master_midi;
...
#P connect 7 1 9 1;
#P connect 2 0 8 0;
#P fasten 12 0 23 0 58 487 207 487;
#P connect 23 0 24 0;
#P fasten 27 0 24 0 472 539 207 539;
#P connect 2 2 3 0;
#P connect 3 0 5 0;
