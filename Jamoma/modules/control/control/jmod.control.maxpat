{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 223.0, 94.0, 791.0, 451.0 ],
		"bglocked" : 0,
		"defrect" : [ 223.0, 94.0, 791.0, 451.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"texton" : "Audio (On)",
					"presentation_rect" : [ 2.0, 22.0, 80.0, 20.0 ],
					"id" : "obj-26",
					"fontname" : "Verdana",
					"text" : "Audio (Off)",
					"outlettype" : [ "int", "", "int" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 3,
					"presentation_rect" : [ 331.0, 229.0, 70.0, 20.0 ],
					"id" : "obj-23",
					"fontname" : "Verdana",
					"text" : "Refresh",
					"outlettype" : [ "int", "", "int" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 3,
					"presentation_rect" : [ 2.0, 47.0, 80.0, 20.0 ],
					"id" : "obj-24",
					"fontname" : "Verdana",
					"text" : "Init",
					"outlettype" : [ "int", "", "int" ],
