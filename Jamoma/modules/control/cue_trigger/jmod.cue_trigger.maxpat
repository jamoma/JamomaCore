...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 924.0, 153.0, 631.0, 583.0 ],
						"bglocked" : 0,
						"defrect" : [ 924.0, 153.0, 631.0, 583.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 16.0, 52.0, 386.0, 17.0 ],
									"text" : "jcom.message go @type msg_none @repetitions/allow 1 @description \"Trigger selected cue.\""
								}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"hidden" : 0,
					"midpoints" : [ 539.5, 147.0, 499.0, 147.0, 499.0, 257.0, 550.0, 257.0, 550.0, 300.0, 499.5, 300.0 ],
					"source" : [ "obj-2", 0 ]
				}
