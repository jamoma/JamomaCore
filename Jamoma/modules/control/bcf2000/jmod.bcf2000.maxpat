{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 10.0, 250.0, 1014.0, 577.0 ],
		"bglocked" : 0,
		"defrect" : [ 10.0, 250.0, 1014.0, 577.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 320.0, 80.0, 116.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 518.0, 486.0, 99.0, 19.0 ],
					"text" : "s #1_outport"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 242.0, 486.0, 91.0, 19.0 ],
					"text" : "s #1_inport"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"id" : "obj-8",
					"items" : [ "BCF2000", ",", "Fireface (2F) Port 1", ",", "to MaxMSP 1", ",", "to MaxMSP 2" ],
					"labelclick" : 1,
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"id" : "obj-9",
					"items" : [ "AU DLS Synth 1", ",", "BCF2000", ",", "Fireface (2F) Port 1", ",", "from MaxMSP 1", ",", "from MaxMSP 2" ],
					"labelclick" : 1,
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 254.0, 203.0, 543.0, 328.0 ],
						"bgcolor" : [ 0.188235, 0.188235, 0.188235, 1.0 ],
						"bglocked" : 0,
						"defrect" : [ 254.0, 203.0, 543.0, 328.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 0,
									"numoutlets" : 0,
									"patching_rect" : [ 393.0, 23.0, 51.0, 316.0 ],
									"presentation" : 1,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 203.0, 199.0, 97.0, 18.0 ],
													"text" : "r #0__outport"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 69.0, 27.0, 89.0, 18.0 ],
													"text" : "r #0__inport"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 195.0, 190.0, 97.0, 18.0 ],
													"text" : "r #0__outport"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 179.0, 209.0, 97.0, 18.0 ],
													"text" : "r #0__outport"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 224.0, 179.0, 97.0, 18.0 ],
													"text" : "r #0__outport"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 190.0, 190.0, 97.0, 18.0 ],
													"text" : "r #0__outport"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 193.0, 194.0, 97.0, 18.0 ],
													"text" : "r #0__outport"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 69.0, 33.0, 89.0, 18.0 ],
													"text" : "r #0__inport"
												}
...
, 							{
								"box" : 								{
									...
									"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "grow", "close", "zoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 2, 2, 32768, 32768, ";", "#Q", "window", "size", 254, 203, 797, 531, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ],
									"text" : "thispatcher"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 231.0, 309.0, 155.0, 17.0 ],
					"text" : "/panel/open"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 129.5, 276.0, 376.5, 276.0 ],
					"source" : [ "obj-14", 0 ]
				}
