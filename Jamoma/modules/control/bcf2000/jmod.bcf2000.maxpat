{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 156.0, 73.0, 801.0, 727.0 ],
		"bglocked" : 0,
		"defrect" : [ 156.0, 73.0, 801.0, 727.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 33.0, 548.0, 215.0, 31.0 ],
					"fontsize" : 10.0,
					"numinlets" : 1,
					"id" : "obj-5",
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					"maxclass" : "umenu",
					"varname" : "MIDIIN",
					"patching_rect" : [ 127.0, 399.0, 100.0, 19.0 ],
					"outlettype" : [ "int", "", "" ],
					"presentation" : 1,
					"fontsize" : 10.0,
					...
					"labelclick" : 1,
					"id" : "obj-8",
					"presentation_rect" : [ 79.0, 21.0, 100.0, 19.0 ],
					"fontname" : "Verdana",
					"numoutlets" : 3
				}
...
, 			{
				"box" : 				{
					...
					"labelclick" : 1,
					"id" : "obj-9",
					"presentation_rect" : [ 79.0, 42.0, 100.0, 19.0 ],
					"fontname" : "Verdana",
					"numoutlets" : 3
				}
...
, 							{
								"box" : 								{
									...
									"fontname" : "Verdana",
									"numoutlets" : 2,
									"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "grow", "close", "zoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 2, 2, 32768, 32768, ";", "#Q", "window", "size", 100, 100, 644, 458, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"id" : "obj-15",
					"presentation_rect" : [ 4.0, 43.0, 65.0, 19.0 ],
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"text" : ";\rmax refresh",
					"linecount" : 2,
					"patching_rect" : [ 23.0, 383.0, 69.0, 29.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 10.0,
					"numinlets" : 2,
					"id" : "obj-19",
