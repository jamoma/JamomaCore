{
	"patcher" : 	{
		"rect" : [ 111.0, 68.0, 472.0, 723.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 111.0, 68.0, 472.0, 723.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 175.0, 605.0, 109.0, 17.0 ],
					"fontname" : "Verdana",
					"id" : "obj-2",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"patching_rect" : [ 137.0, 603.0, 35.0, 17.0 ],
					"triscale" : 0.9,
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 137.0, 575.0, 105.0, 17.0 ],
					"fontname" : "Verdana",
					"id" : "obj-4",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"patching_rect" : [ 266.0, 527.0, 152.0, 38.0 ],
					"fontname" : "Verdana",
					"id" : "obj-5",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"patching_rect" : [ 266.0, 350.0, 158.0, 38.0 ],
					"fontname" : "Verdana",
					"id" : "obj-6",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 29.0, 373.0, 35.0, 17.0 ],
					"triscale" : 0.9,
					"fontname" : "Verdana",
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"id" : "obj-9",
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 135.0, 373.0, 35.0, 17.0 ],
					"triscale" : 0.9,
					"fontname" : "Verdana",
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"id" : "obj-10",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 29.0, 350.0, 223.0, 17.0 ],
					"fontname" : "Verdana",
					"id" : "obj-11",
					"numinlets" : 1,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 137.0, 545.0, 35.0, 17.0 ],
					"triscale" : 0.9,
					"fontname" : "Verdana",
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"id" : "obj-13",
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 31.0, 545.0, 35.0, 17.0 ],
					"triscale" : 0.9,
					"fontname" : "Verdana",
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"id" : "obj-14",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 31.0, 520.0, 222.0, 17.0 ],
					"fontname" : "Verdana",
					"id" : "obj-15",
					"numinlets" : 1,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 171.0, 225.0, 35.0, 17.0 ],
					"triscale" : 0.9,
					"fontname" : "Verdana",
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"id" : "obj-17",
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 100.0, 225.0, 35.0, 17.0 ],
					"triscale" : 0.9,
					"fontname" : "Verdana",
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"id" : "obj-18",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 29.0, 201.0, 223.0, 17.0 ],
					"fontname" : "Verdana",
					"id" : "obj-19",
					"numinlets" : 1,
					"numoutlets" : 4,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 16.0, 32.0, 326.0, 17.0 ],
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					"maxclass" : "bpatcher",
					"varname" : "\/mouse",
					"patching_rect" : [ 29.0, 114.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"linecount" : 4,
					"patching_rect" : [ 266.0, 204.0, 159.0, 49.0 ],
					"fontname" : "Verdana",
					"id" : "obj-24",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 242.5, 344.0, 38.5, 344.0 ]
				}
