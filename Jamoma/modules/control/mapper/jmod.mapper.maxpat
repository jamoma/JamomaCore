{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 10.0, 85.0, 941.0, 586.0 ],
		"bglocked" : 0,
		"defrect" : [ 10.0, 85.0, 941.0, 586.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"texton" : "recording",
					"presentation_rect" : [ 231.0, 23.0, 39.287197, 15.000001 ],
					"border" : 1,
					"fontsize" : 8.0,
					"text" : "Clear",
					"outlettype" : [ "int", "", "int" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"texton" : "recording",
					"presentation_rect" : [ 5.0, 94.0, 113.287193, 15.000001 ],
					"border" : 1,
					"fontsize" : 8.0,
					"text" : "Create mapping",
					"outlettype" : [ "int", "", "int" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"texton" : "recording",
					"presentation_rect" : [ 6.0, 23.0, 39.287197, 15.000001 ],
					"border" : 1,
					"fontsize" : 8.0,
					"text" : "Load",
					"outlettype" : [ "int", "", "int" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"texton" : "recording",
					"presentation_rect" : [ 50.0, 23.0, 39.287197, 15.000001 ],
					"border" : 1,
					"fontsize" : 8.0,
					"text" : "Save",
					"outlettype" : [ "int", "", "int" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"texton" : "recording",
					"presentation_rect" : [ 187.0, 23.0, 39.287197, 15.000001 ],
					"border" : 1,
					"fontsize" : 8.0,
					"text" : "Update",
					"outlettype" : [ "int", "", "int" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"texton" : "recording",
					"presentation_rect" : [ 145.477203, 23.0, 39.287197, 15.000001 ],
					"border" : 1,
					"fontsize" : 8.0,
					"text" : "View",
					"outlettype" : [ "int", "", "int" ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-20",
					"numoutlets" : 0,
					"presentation_rect" : [ 125.0, 92.0, 57.0, 19.0 ],
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"wordwrap" : 0,
					"numoutlets" : 3,
					"presentation_rect" : [ 181.0, 92.0, 93.0, 17.0 ],
					"clickmode" : 1,
					"fontsize" : 10.0,
					"lines" : 1,
					"outlettype" : [ "", "int", "" ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-22",
					"numoutlets" : 1,
					"presentation_rect" : [ 147.0, 72.0, 125.0, 17.0 ],
					"fontsize" : 10.0,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-23",
					"numoutlets" : 1,
					"presentation_rect" : [ 147.0, 54.0, 15.0, 15.0 ],
					"outlettype" : [ "int" ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-24",
					"numoutlets" : 0,
					"presentation_rect" : [ 164.0, 55.0, 43.0, 19.0 ],
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"id" : "obj-25",
					"numoutlets" : 1,
					"presentation_rect" : [ 6.0, 72.0, 116.0, 17.0 ],
					"fontsize" : 10.0,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-26",
					"numoutlets" : 1,
					"presentation_rect" : [ 7.0, 54.0, 15.0, 15.0 ],
					"outlettype" : [ "int" ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-27",
					"numoutlets" : 0,
					"presentation_rect" : [ 23.0, 56.0, 56.0, 19.0 ],
					"fontsize" : 10.0,
