{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 586.0, 71.0, 834.0, 588.0 ],
		"bglocked" : 0,
		"defrect" : [ 586.0, 71.0, 834.0, 588.0 ],
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"numinlets" : 1,
					"presentation_rect" : [ 410.0, 22.0, 39.0, 19.0 ],
					"id" : "obj-3",
					"numoutlets" : 0,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"numinlets" : 1,
					"presentation_rect" : [ 455.0, 21.0, 113.0, 18.0 ],
					"id" : "obj-8",
					"numoutlets" : 3,
					"hidden" : 1,
					"lines" : 1,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"numinlets" : 1,
					"presentation_rect" : [ 455.0, 46.0, 114.0, 17.0 ],
					"id" : "obj-4",
					"numoutlets" : 3,
					"hidden" : 1,
					"lines" : 1,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"numinlets" : 1,
					"presentation_rect" : [ 410.0, 49.0, 39.0, 19.0 ],
					"id" : "obj-5",
					"numoutlets" : 0,
					"hidden" : 1,
					"frgb" : [ 0.658824, 0.658824, 0.658824, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"numinlets" : 1,
					"presentation_rect" : [ 354.0, 2.0, 35.0, 19.0 ],
					"id" : "obj-17",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"numinlets" : 1,
					"presentation_rect" : [ 478.0, 2.0, 35.0, 19.0 ],
					"id" : "obj-18",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"numinlets" : 1,
					"presentation_rect" : [ 277.0, 48.0, 47.0, 19.0 ],
					"id" : "obj-22",
					"numoutlets" : 0,
					"frgb" : [ 0.658824, 0.658824, 0.658824, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"numinlets" : 1,
					"presentation_rect" : [ 277.0, 22.0, 47.0, 19.0 ],
					"id" : "obj-23",
					"numoutlets" : 0,
					"frgb" : [ 0.658824, 0.658824, 0.658824, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-51",
					"numoutlets" : 3,
					"patching_rect" : [ 240.0, 495.0, 394.0, 30.0 ],
					"fontsize" : 9.873845,
					"outlettype" : [ "", "", "" ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-53",
					"numoutlets" : 3,
					"patching_rect" : [ 170.0, 602.0, 380.0, 30.0 ],
					"fontsize" : 9.873845,
					"outlettype" : [ "", "", "" ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-58",
					"numoutlets" : 3,
					"patching_rect" : [ 362.0, 332.0, 346.0, 30.0 ],
					"fontsize" : 9.873845,
					"outlettype" : [ "", "", "" ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-60",
					"numoutlets" : 3,
					"patching_rect" : [ 373.0, 397.0, 343.0, 30.0 ],
					"fontsize" : 9.873845,
					"outlettype" : [ "", "", "" ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-76",
					"numoutlets" : 3,
					"patching_rect" : [ 348.0, 458.0, 330.0, 30.0 ],
					"fontsize" : 9.873845,
					"outlettype" : [ "", "", "" ]
				}
