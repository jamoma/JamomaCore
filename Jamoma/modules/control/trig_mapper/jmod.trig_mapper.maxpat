{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 34.0, 51.0, 1242.0, 663.0 ],
		"bglocked" : 0,
		"defrect" : [ 34.0, 51.0, 1242.0, 663.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation" : 1,
					"outlettype" : [ "int", "", "" ],
					"items" : [ "/mouse", ",", "/Ztaptempo", ",", "/cueManager", ",", "/trig_mapper", ",", "/cont_mapper", ",", "/Zlooper~", ",", "/multiZloopertrigger", ",", "/bufferpool", ",", "/Zspat", ",", "/layout", ",", "/control", ",", "/editing_this_module" ],
					"arrow" : 0,
					"fontname" : "Verdana",
					"types" : [  ],
					"id" : "obj-1",
