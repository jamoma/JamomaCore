...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"id" : "obj-6",
					"presentation_rect" : [ 200.881836, 1.917304, 48.287197, 15.000001 ],
					"border" : 1,
					"fontsize" : 8.0,
					"text" : "New color",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "jcom.hub",
					"text" : "jcom.hub jmod.palette @module_type control @description \"Create various blends of the RGB colors available.\"",
					"linecount" : 3,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"fontname" : "Verdana",
