	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"id" : "obj-1",
					"items" : [ "/editing_this_module", ",", "/cont_mapper" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 651.0, 732.0, 17.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 652.0, 677.0, 603.0, 31.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 45.0, 130.0, 173.0, 114.0 ],
									"text" : "module_in, module_out, module_in_fct, module_out_fct, module_in#, module_out#, in_min, in_max, out_min, out_max, slide_down, slide_up, clipmode, ramp, curve, curve_slid, param1_value, param2_value, power_menu, function_menu"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 250.0, 130.0, 174.0, 114.0 ],
									"text" : "module_in, module_out, module_in_fct, module_out_fct, module_in#, module_out#, in_min, in_max, out_min, out_max, slide_down, slide_up, clipmode, ramp, curve, curve_slid, param1_value, param2_value, power_menu, function_menu"
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 102.0, 47.0, 20.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "module_out#"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 516.0, 188.0, 425.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 568.0, 147.0, 366.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 536.0, 153.0, 27.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 488.0, 192.0, 27.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 102.0, 22.0, 20.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "module_in#"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 643.0, 351.0, 197.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 472.0, 187.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 21.0, 44.0, 1194.0, 824.0 ],
						"bglocked" : 0,
						"defrect" : [ 21.0, 44.0, 1194.0, 824.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 314.0, 606.0, 100.0, 19.0 ],
...
,
													"patching_rect" : [ 465.0, 586.0, 45.0, 19.0 ],
													"saved_object_attributes" : 													{
														"default_fontface" : 0,
														"fontname" : "Verdana",
														"default_fontname" : "Verdana",
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 464.0, 556.0, 25.0, 25.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 387.0, 660.0, 105.0, 19.0 ],
													"text" : "s #0to.thispatcher"
												}
...
,
													"patching_rect" : [ 337.0, 614.0, 38.0, 19.0 ],
													"saved_object_attributes" : 													{
														"default_fontface" : 0,
														"fontname" : "Verdana",
														"default_fontname" : "Verdana",
...
,
													"patching_rect" : [ 381.0, 615.0, 51.0, 19.0 ],
													"saved_object_attributes" : 													{
														"default_fontface" : 0,
														"fontname" : "Verdana",
														"default_fontname" : "Verdana",
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 419.0, 637.0, 65.0, 19.0 ],
													"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
													"text" : "thispatcher"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 337.0, 593.0, 88.0, 19.0 ],
													"text" : "sel msg_list"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 251.0, 571.0, 190.0, 19.0 ],
													...
													"patcher" : 													{
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "int" ],
																	"patching_rect" : [ 80.0, 80.0, 24.0, 19.0 ],
																	"text" : "t 2"
																}
...
, 															{
																"box" : 																{
																	...
																	"numinlets" : 1,
																	"numoutlets" : 0,
																	"patching_rect" : [ 40.0, 125.0, 25.0, 25.0 ]
																}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 205.0, 635.0, 87.0, 19.0 ],
									"text" : "append ramp 0"
								}
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 720.0, 86.0, 506.0, 687.0 ],
										"bglocked" : 0,
										"defrect" : [ 720.0, 86.0, 506.0, 687.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-18", 0 ],
									"hidden" : 0,
									"midpoints" : [ 323.5, 629.5, 214.5, 629.5 ],
									"source" : [ "obj-6", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-6", 0 ],
									"hidden" : 0,
									"midpoints" : [ 674.833313, 591.5, 323.5, 591.5 ],
									"source" : [ "obj-8", 2 ]
								}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-40", 0 ],
					"hidden" : 0,
					"midpoints" : [ 577.5, 180.0, 531.0, 180.0, 531.0, 148.0, 545.5, 148.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-41", 0 ],
					"hidden" : 0,
					"midpoints" : [ 525.5, 222.0, 510.0, 222.0, 510.0, 186.0, 497.5, 186.0 ],
					"source" : [ "obj-31", 0 ]
				}
