{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 179.0, 46.0, 1083.0, 793.0 ],
		"bgcolor" : [ 0.1, 0.1, 0.1, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 179.0, 46.0, 1083.0, 793.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"align" : 0,
					"prefix" : "",
					"items" : [ "/input~", ",", "/filter~", ",", "/mapper", ",", "/control", ",", "/mouse", ",", "/editing_this_module" ],
					"pattrmode" : 1,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"align" : 0,
					"prefix" : "",
					"items" : [ "audio/active", ",", "audio/gain", ",", "balance", ",", "ch.1", ",", "ch.2", ",", "soundfile/loop", ",", "soundfile/play", ",", "source", ",", "ui/freeze", ",", "<separator>", ",", "audio/panic", ",", "documentation/generate", ",", "dsp_status", ",", "init", ",", "module/view_internals", ",", "panel/open", ",", "preset/clear", ",", "preset/copy", ",", "preset/default", ",", "preset/dump", ",", "preset/interpolate", ",", "preset/post", ",", "preset/read", ",", "preset/recall", ",", "preset/store", ",", "preset/storenext", ",", "preset/write", ",", "soundfile/direct", ",", "soundfile/open", ",", "ui/refresh" ],
					"pattrmode" : 1,
					"numoutlets" : 3,
