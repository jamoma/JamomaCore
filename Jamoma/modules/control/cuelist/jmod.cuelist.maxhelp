{
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "number",
					"patching_rect" : [ 685.0, 165.0, 35.0, 18.0 ],
					"id" : "obj-35",
					"fontname" : "Verdana",
					"minimum" : 0,
					"numinlets" : 1,
					...
					"fontsize" : 9.873845,
					"numoutlets" : 2,
					"presentation_rect" : [ 685.0, 167.0, 0.0, 0.0 ],
					"triscale" : 0.9,
					"outlettype" : [ "int", "bang" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "/filter~/filtergain $1",
					"patching_rect" : [ 560.0, 200.0, 110.0, 16.0 ],
					"id" : "obj-34",
					"fontname" : "Verdana",
					"numinlets" : 2,
					"fontsize" : 9.873845,
					"numoutlets" : 1,
					"presentation_rect" : [ 558.0, 199.0, 0.0, 0.0 ],
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 585.0, 225.0, 180.0, 18.0 ],
					"id" : "obj-33",
					"fontname" : "Verdana",
					"numinlets" : 1,
					"fontsize" : 9.873845,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "print b",
					"patching_rect" : [ 635.0, 150.0, 47.0, 20.0 ],
					"id" : "obj-32",
					"fontname" : "Verdana",
					"numinlets" : 1,
					"fontsize" : 10.970939,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "print",
					"patching_rect" : [ 412.0, 214.0, 32.0, 18.0 ],
					"id" : "obj-1",
					"fontname" : "Verdana",
					"numinlets" : 1,
					"fontsize" : 9.873845,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "/remote /filter~/filtergain 65",
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"patching_rect" : [ 496.0, 148.0, 35.0, 18.0 ],
					"id" : "obj-7",
					"fontname" : "Verdana",
					"minimum" : 0,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 496.0, 173.0, 156.0, 16.0 ],
					"id" : "obj-8",
					"fontname" : "Verdana",
					"numinlets" : 2,
					"fontsize" : 9.873845,
