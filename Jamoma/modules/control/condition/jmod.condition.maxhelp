	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : ";\rmax refresh",
					"linecount" : 2,
					"patching_rect" : [ 575.0, 32.0, 73.0, 26.0 ],
					"fontname" : "Verdana",
					"numinlets" : 2,
					"id" : "obj-1",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "loadmess 1",
					"patching_rect" : [ 45.0, 85.0, 60.0, 17.0 ],
					"fontname" : "Verdana",
					"numinlets" : 1,
					"hidden" : 1,
					"id" : "obj-2",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "change",
					"patching_rect" : [ 605.0, 466.0, 40.0, 15.0 ],
					"fontname" : "Verdana",
					"numinlets" : 2,
					"id" : "obj-3",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "scale",
					"patching_rect" : [ 570.0, 466.0, 33.0, 15.0 ],
					"fontname" : "Verdana",
					"numinlets" : 2,
					"id" : "obj-4",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "clip",
					"patching_rect" : [ 544.0, 466.0, 24.0, 15.0 ],
					"fontname" : "Verdana",
					"numinlets" : 2,
					"id" : "obj-5",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "jcom.autoscale",
					"patching_rect" : [ 511.0, 486.0, 77.0, 15.0 ],
					"fontname" : "Verdana",
					"numinlets" : 2,
					"id" : "obj-6",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "see also:",
					"patching_rect" : [ 463.0, 467.0, 50.0, 17.0 ],
					"fontname" : "Verdana",
					"numinlets" : 1,
					"id" : "obj-7",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "slide",
					"patching_rect" : [ 511.0, 466.0, 31.0, 15.0 ],
					"fontname" : "Verdana",
					"numinlets" : 2,
					"id" : "obj-8",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "phelp",
					"text" : "prepend help",
					"patching_rect" : [ 511.0, 514.0, 64.0, 17.0 ],
					"fontname" : "Verdana",
					"numinlets" : 1,
					"hidden" : 1,
					"id" : "obj-9",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "pcontrol",
					"patching_rect" : [ 511.0, 534.0, 45.0, 17.0 ],
					"fontname" : "Verdana",
					"numinlets" : 1,
					"hidden" : 1,
					"id" : "obj-10",
...
, 			{
				"box" : 				{
					...
					"linecount" : 22,
					"patching_rect" : [ 462.0, 150.0, 181.0, 238.0 ],
					"fontname" : "Verdana",
					"numinlets" : 1,
					"id" : "obj-11",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"patching_rect" : [ 120.0, 106.0, 35.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 22.0, 106.0, 91.0, 17.0 ],
					"fontname" : "Verdana",
					"numinlets" : 1,
					"id" : "obj-15",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 301.0, 337.0, 35.0, 17.0 ],
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"fontname" : "Verdana",
					"numinlets" : 1,
					"id" : "obj-18",
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 22.0, 238.0, 35.0, 17.0 ],
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"fontname" : "Verdana",
					"numinlets" : 1,
					"id" : "obj-19",
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 285.0, 37.0, 280.0, 28.0 ],
					"fontname" : "Verdana",
					"numinlets" : 1,
					"id" : "obj-23",
					"numoutlets" : 0,
