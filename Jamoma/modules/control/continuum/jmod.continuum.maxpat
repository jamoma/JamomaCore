...
, 			{
				"box" : 				{
					...
					"labelclick" : 1,
					"id" : "obj-3",
					"presentation_rect" : [ 79.0, 28.0, 129.0, 19.0 ],
					"fontname" : "Verdana",
					"numoutlets" : 3
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"id" : "obj-5",
					"presentation_rect" : [ 11.0, 28.0, 65.0, 19.0 ],
					"fontname" : "Verdana",
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 495.0, 98.0, 254.0, 30.0 ],
					"outlettype" : [ "", "", "" ],
					"fontsize" : 9.873845,
					"numinlets" : 1,
					"id" : "obj-6",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "pcontrol",
					"patching_rect" : [ 72.0, 219.0, 49.0, 18.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.873845,
					"numinlets" : 1,
					"id" : "obj-7",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t open",
					"patching_rect" : [ 72.0, 195.0, 40.0, 18.0 ],
					"outlettype" : [ "open" ],
					"fontsize" : 9.873845,
					"numinlets" : 1,
					"id" : "obj-8",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 72.0, 171.0, 163.0, 18.0 ],
					"outlettype" : [ "", "" ],
					"fontsize" : 9.873845,
					"numinlets" : 1,
					"id" : "obj-9",
...
, 			{
				"box" : 				{
					...
					"varname" : "inspector",
					"text" : "p inspector",
					"patching_rect" : [ 72.0, 243.0, 64.0, 18.0 ],
					"fontsize" : 9.873845,
					"numinlets" : 1,
					"id" : "obj-10",
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 213.0, 305.0, 221.0, 18.0 ],
					"outlettype" : [ "", "" ],
					"fontsize" : 9.873845,
					"numinlets" : 1,
					"id" : "obj-12",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jcom.in",
					"patching_rect" : [ 72.0, 149.0, 45.0, 18.0 ],
					"outlettype" : [ "", "" ],
					"fontsize" : 9.873845,
					"numinlets" : 1,
					"id" : "obj-13",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "pcontrol",
					"patching_rect" : [ 213.0, 223.0, 49.0, 18.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.873845,
					"numinlets" : 1,
					"id" : "obj-14",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jcom.pass open",
					"patching_rect" : [ 213.0, 199.0, 86.0, 18.0 ],
					"outlettype" : [ "", "" ],
					"fontsize" : 9.873845,
					"numinlets" : 1,
					"id" : "obj-15",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jalg.continuum",
					"patching_rect" : [ 213.0, 280.0, 96.0, 18.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.873845,
					"numinlets" : 1,
					"id" : "obj-18",
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 16.0, 114.0, 411.0, 30.0 ],
					"outlettype" : [ "", "" ],
					"fontsize" : 9.873845,
					"numinlets" : 1,
					"id" : "obj-19",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "/ui/freeze 0",
					"patching_rect" : [ 319.0, 281.0, 172.0, 16.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.873845,
					"numinlets" : 2,
					"id" : "obj-22",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "prepend set",
					"patching_rect" : [ 319.0, 260.0, 68.0, 18.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 9.873845,
					"numinlets" : 1,
					"id" : "obj-23",
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 289.5, 251.0, 328.5, 251.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-18", 0 ],
					"hidden" : 0,
					"midpoints" : [ 289.5, 271.0, 222.5, 271.0 ]
				}
