...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "jcom.hub",
					"text" : "jcom.hub jmod.continuum @module_type control @inspector 1 @description \"A module receving input from the Haken Continuum Fingerboard.\"",
					"linecount" : 3,
					"fontname" : "Verdana",
					"numinlets" : 1,
					"id" : "obj-19",
					...
					"fontsize" : 9.873845,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 114.0, 338.0, 42.0 ]
				}
