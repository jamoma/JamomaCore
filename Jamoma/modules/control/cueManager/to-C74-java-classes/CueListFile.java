...
public class CueListFile extends MaxObject
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void clear(Atom[] args){
		...
		cc_t_out[0] = Atom.newAtom("/currentCueType");
		...
		if(cuelist.size()>0){
			...
			if(cc_i != -1){
				...
				if(args.length == 0 || args[0].getString().equals("currentCueName")|| args[0].getString().equals("currentCue"))
					infoOut(cc_n_out);
				if(args.length == 0 || args[0].getString().equals("currentCueType")|| args[0].getString().equals("currentCue"))
					infoOut(cc_t_out);
			}
		}
	}
...
final class Data {
	...
	public boolean isCtl(){
		return this.type == CueListFile._CTL;
	}
	
	public boolean isWait(){
		return this.type == CueListFile._WAIT;
	}
	
	public boolean isCmt(){
		return this.type == CueListFile._CMT;
	}
}
