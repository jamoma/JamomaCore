...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"outlettype" : [ "int", "", "" ],
					"items" : [ "Cue___Menu", ",", "Initialisation", ",", "scene_I", ",", "Noir", ",", "scene_II_p1", ",", "scene_II_t12", ",", "scene_II_p2", ",", "Noir", ",", "Scene_III", ",", "Noir" ],
					"fontname" : "Arial",
					"types" : [  ],
					"id" : "obj-41",
...
, 											{
												"box" : 												{
													"maxclass" : "message",
													"text" : "\"D:/Mes documents/ECHO ROOM/patches/data_mapping/presets/CueList.txt\"",
													"linecount" : 2,
