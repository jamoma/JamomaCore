...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 120.0, 326.0, 35.0, 17.0 ],
					"triscale" : 0.9,
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 351.0, 403.0, 35.0, 17.0 ],
					"triscale" : 0.9,
					"fontname" : "Verdana",
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"id" : "obj-5",
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 309.0, 403.0, 35.0, 17.0 ],
					"triscale" : 0.9,
					"fontname" : "Verdana",
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"id" : "obj-6",
...
, 			{
				"box" : 				{
					"maxclass" : "flonum",
					"patching_rect" : [ 267.0, 403.0, 35.0, 17.0 ],
					"triscale" : 0.9,
					"fontname" : "Verdana",
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"id" : "obj-7",
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 266.0, 431.0, 163.0, 30.0 ],
					"fontname" : "Verdana",
					"id" : "obj-8",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jcom.oscroute \/16 \/17 \/18",
					"patching_rect" : [ 267.0, 370.0, 145.0, 18.0 ],
					"fontname" : "Verdana",
					"id" : "obj-9",
					"numinlets" : 1,
					"numoutlets" : 4,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jcom.oscroute \/note \/cc \/bend",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "\/device_menu 0",
					"patching_rect" : [ 199.0, 285.0, 91.0, 16.0 ],
					"fontname" : "Verdana",
					"id" : "obj-12",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 340.0, 202.0, 80.0, 26.0 ],
					"fontname" : "Verdana",
					"id" : "obj-14",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 17.0, 46.0, 396.0, 18.0 ],
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					"maxclass" : "bpatcher",
					"varname" : "\/midiin",
					"patching_rect" : [ 28.0, 176.0, 301.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"patching_rect" : [ 32.0, 111.0, 364.0, 42.0 ],
					"fontname" : "Verdana",
					"id" : "obj-19",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 84.833336, 345.0, 276.5, 345.0 ]
				}
