...
#P hidden newex 16 676 329 196617 jcom.parameter angle @type msg_int @ramp linear.sched @repetitions 0 @range 0 90 @clipmode none @description "Rotate image - in degrees";
#P objectname angle[1];
#P window linecount 1;
#P hidden newex 16 409 72 196617 pvar offset-Y;
#P window linecount 2;
#P hidden newex 16 433 370 196617 jcom.parameter offset_y @type msg_int @ramp linear.sched @repetitions 0 @range -1000 1000 @clipmode none @description "Offset image in Y-direction";
...
#P window linecount 2;
#P hidden newex 16 365 370 196617 jcom.parameter offset_x @type msg_int @ramp linear.sched @repetitions 0 @range -1000 1000 @clipmode none @description "Offset image in X-direction";
...
#P window linecount 2;
#P hidden newex 16 299 318 196617 jcom.parameter zoom @type msg_float @ramp linear.sched @repetitions 0 @range 0. 10. @clipmode none @description "Zoom in the image";
#P objectname zoom[1];
#P window linecount 1;
