{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 24.0, 44.0, 1027.0, 687.0 ],
		"bglocked" : 0,
		"defrect" : [ 24.0, 44.0, 1027.0, 687.0 ],
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 36.0, 274.0, 572.0, 31.0 ],
									"text" : "jcom.parameter chorus/units @type msg_float @repetitions/allow 0 @range/bounds 0 1 @range/clipmode low @description \"number of units?? \" @ramp/drive scheduler",
									"varname" : "chorus[5]"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 38.0, 232.0, 569.0, 31.0 ],
									"text" : "jcom.parameter chorus/type @type msg_float @repetitions/allow 0 @range/bounds 0 1 @range/clipmode low @description \"type-parameter of the fluidsynth~: 1 - sine 2 - triangle.\" @ramp/drive scheduler",
									"varname" : "chorus[4]"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 38.0, 163.0, 577.0, 55.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 37.0, 89.0, 577.0, 55.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 37.0, 38.0, 587.0, 43.0 ],
...
,
					"patching_rect" : [ 457.0, 467.0, 111.0, 19.0 ],
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 54.0, 151.0, 574.0, 31.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 54.0, 105.0, 590.0, 31.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 53.0, 70.0, 592.0, 31.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 53.0, 21.0, 586.0, 43.0 ],
...
,
					"patching_rect" : [ 333.0, 467.0, 110.0, 19.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"default_fontsize" : 10.0,
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 739.862, 309.154083, 49.138031, 17.845917 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 739.862, 332.0, 138.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 55.0, 365.0, 107.0, 19.0 ],
					"text" : "---signal outputs---"
				}
