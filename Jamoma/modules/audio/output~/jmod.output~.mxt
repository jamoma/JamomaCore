...
#P window linecount 2;
#P hidden newex 750 57 347 196617 jcom.parameter saturation/depth @ramp.drive scheduler @repetitions 0 @type msg_float @range 0 99 @clipmode both @description "Saturation: Depth.";
...
#P hidden fasten 64 0 65 0 755 227 744 227 744 182 755 182;
