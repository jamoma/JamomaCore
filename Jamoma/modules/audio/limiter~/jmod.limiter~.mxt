...
#P hidden newex 67 401 459 196617 jcom.parameter threshold @type msg_float @range -48 6 @clipmode none @ramp/drive scheduler @description "The limiter threshold (in dB below full scale). When the input signal level exceeds this threshold\\\, it will be attenuated as necessary to keep the level below the threshold.";
#P objectname threshold;
#P window linecount 2;
#P hidden newex 67 339 408 196617 jcom.parameter postamp @type msg_float @range -6 48 @clipmode none @ramp/drive scheduler @description "The gain in dB applied to the signal after limiting. ";
#P objectname postamp;
#P hidden newex 67 274 407 196617 jcom.parameter preamp @type msg_float @range -6 48 @ramp/drive scheduler @description "The gain in dB applied to the signal before limiting.";
#P objectname preamp;
