...
#P hidden newex 583 253 47 196617 pcontrol;
#P hidden newex 450 229 143 196617 jcom.algorithm_control~.mxt;
...
#P hidden newex 363 8 301 196617 jcom.parameter sr_ratio @type msg_float @range 0. 1. @repetitions 1 @clipmode both @ramp linear.sched @description "A ratio of the emulated sample-rate to the global sample-rate.";
#P objectname sr_ratio;
#P hidden newex 287 59 333 196617 jcom.parameter bitdepth @type msg_int @range 1 24 @clipmode both @ramp linear.sched @repetitions 0 @description "The number of bits that will be retained in each sample - use this for bit crunching effects";
...
#P hidden fasten 27 0 5 0 455 282 318 282;
#P hidden fasten 28 0 5 0 588 282 318 282;
