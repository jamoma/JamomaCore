...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter threshold @type integer @ramp/drive scheduler @repetitions/allow 0 @range/bounds -90 24 @range/clipmode both @description \"The threshold sets the level at which the Noise Gate opens and closes..\" @dataspace gain @dataspace/unit/active dB @dataspace/unit/native dB @dataspace/unit/display dB",
					"varname" : "threshold"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter release @type integer @ramp/drive scheduler @repetitions/allow 0 @range/bounds 0 1000 @range/clipmode both @description \"When the gate closes, this parameter sets how many milliseconds it will take to fade out.\" @dataspace time @dataspace/unit/active ms @dataspace/unit/native ms @dataspace/unit/display ms",
					"varname" : "release"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter attack @type integer @ramp/drive scheduler @repetitions/allow 0 @range/bounds 0 1000 @range/clipmode low @description \"When the gate opens, this parameter sets how many milliseconds it will take to fade in.\" @dataspace time @dataspace/unit/active ms @dataspace/unit/native ms @dataspace/unit/display ms",
					"varname" : "attack"
				}
