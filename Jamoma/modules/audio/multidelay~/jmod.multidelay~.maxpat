...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 15.0, 425.0, 529.0, 31.0 ],
					"id" : "obj-13",
					"numoutlets" : 3,
					"fontname" : "Verdana",
					"outlettype" : [ "", "", "" ],
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"patching_rect" : [ 15.0, 300.0, 481.0, 43.0 ],
					"id" : "obj-20",
					"numoutlets" : 3,
					"fontname" : "Verdana",
					"outlettype" : [ "", "", "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "maxdelay",
					"text" : "jcom.parameter delay/max @type msg_int @ramp/drive scheduler @repetitions/allow 0 @range/bounds 0 10000 @range/clipmode low @description \"Max delay time in milliseconds.\"",
					"linecount" : 2,
