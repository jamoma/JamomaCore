...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 630.0, 45.0, 40.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 470.0, 70.0, 179.0, 19.0 ],
					"text" : "jcom.class.lfoParameters tremolo",
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"hidden" : 0,
					"midpoints" : [ 639.5, 96.0, 680.0, 96.0, 680.0, 39.0, 639.5, 39.0 ],
					"source" : [ "obj-6", 1 ]
				}
