{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 96.0, 67.0, 1143.0, 476.0 ],
		"bglocked" : 0,
		"defrect" : [ 96.0, 67.0, 1143.0, 476.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 662.0, 191.0, 38.0, 18.0 ],
					"text" : "abs 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 742.0, 213.0, 46.0, 20.0 ],
					"text" : "line 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 662.0, 222.0, 77.0, 20.0 ],
					"text" : "append 500."
				}
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 45.0, 167.0, 32.5, 20.0 ],
									"text" : "t b f"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 45.0, 239.0, 32.5, 20.0 ],
									"text" : "/ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 224.0, 169.5, 117.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 13.0, 142.0, 51.0, 20.0 ],
									"text" : "route 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 190.0, 65.0, 34.0, 20.0 ],
									"text" : "t 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 141.0, 66.0, 34.0, 20.0 ],
									"text" : "t b 1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 141.0, 43.0, 117.0, 20.0 ],
									"text" : "sel 1 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 224.0, 144.0, 54.0, 20.0 ],
									"text" : "gate 1 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 259.0, 121.0, 32.5, 20.0 ],
									"text" : "f"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 45.0, 266.0, 65.0, 20.0 ],
									"text" : "clip 0 100."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 45.0, 326.0, 46.0, 20.0 ],
									"text" : "line 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 45.0, 296.0, 71.0, 20.0 ],
									"text" : "append 50."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 279.0, 264.0, 74.0, 20.0 ],
									"text" : "expr $f2/$f1"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 569.0, 400.0, 151.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 513.0, 374.0, 151.0, 17.0 ],
					"text" : "pfft~ jcom.gizmo_transpose 4096 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 15.0, 324.0, 135.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 211.0, 232.0, 48.0, 18.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 594.0, 191.0, 50.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 742.0, 449.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						...
						"bglocked" : 0,
						"defrect" : [ 265.0, 233.0, 830.0, 424.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 51.0, 171.0, 22.0, 18.0 ],
									"text" : "t 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 51.0, 141.0, 32.5, 18.0 ],
									"text" : "sel 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "int" ],
									"patching_rect" : [ 51.0, 119.0, 46.0, 18.0 ],
									"text" : "change"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 51.0, 96.0, 33.0, 18.0 ],
									"text" : "== 1."
								}
...
,
					"patching_rect" : [ 681.0, 294.0, 80.0, 17.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 10.0,
						"fontname" : "Arial",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 652.0, 323.0, 81.0, 17.0 ],
					"text" : "s #1_xxx_done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 556.0, 189.0, 35.0, 17.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 569.0, 442.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 103.0, 230.0, 55.0, 15.0 ],
					"text" : "#0_sample"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 199.0, 262.0, 105.0, 17.0 ],
					"text" : "info~ #0_sample"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 463.0, 242.0, 306.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 513.0, 442.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 528.0, 267.0, 37.0, 17.0 ],
					"text" : "sig~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 515.0, 294.0, 126.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 12,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 242.0, 47.0, 841.0, 17.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 998.772705, 212.5, 962.5, 212.5 ],
					"source" : [ "obj-37", 10 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"hidden" : 0,
					"midpoints" : [ 849.318176, 291.0, 710.833313, 291.0 ],
					"source" : [ "obj-37", 8 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 222.0, 222.5, 112.5, 222.5 ],
					"source" : [ "obj-25", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 2 ],
					"hidden" : 0,
					"midpoints" : [ 472.5, 262.0, 731.166687, 262.0 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 3 ],
					"hidden" : 0,
					"midpoints" : [ 616.0, 280.0, 751.5, 280.0 ],
					"source" : [ "obj-28", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 886.5, 357.0, 654.5, 357.0 ],
					"source" : [ "obj-46", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 886.5, 393.0, 710.5, 393.0 ],
					"source" : [ "obj-46", 0 ]
				}
