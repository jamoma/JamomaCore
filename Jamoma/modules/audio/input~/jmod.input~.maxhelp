					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"hidden" : 1,
									"patching_rect" : [ 287.0, 28.0, 99.0, 17.0 ],
									"fontname" : "Verdana",
									"id" : "obj-1",
									"numinlets" : 1,
									"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "s jmod.input~.help",
					"hidden" : 1,
					"patching_rect" : [ 282.0, 418.0, 91.0, 17.0 ],
					"fontname" : "Verdana",
					"id" : "obj-2",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "s jmod.input~.help",
					"hidden" : 1,
					"patching_rect" : [ 270.0, 84.0, 99.0, 17.0 ],
					"fontname" : "Verdana",
					"id" : "obj-4",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 590.0, 280.0, 15.0, 15.0 ],
					"id" : "obj-6",
					"numinlets" : 1,
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 608.0, 279.0, 127.0, 17.0 ],
					"fontname" : "Verdana",
					"id" : "obj-7",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 18.0, 54.0, 242.0, 17.0 ],
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
					"fontname" : "Verdana",
					"id" : "obj-9",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "\/control",
					"outlettype" : [ "" ],
					"patching_rect" : [ 455.0, 13.0, 303.0, 74.0 ],
					"args" : [  ],
					"id" : "obj-11",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"hidden" : 1,
					"patching_rect" : [ 517.0, 262.0, 65.0, 17.0 ],
					"fontname" : "Verdana",
					"id" : "obj-12",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 411.0, 407.0, 132.0, 21.0 ],
					"fontname" : "Verdana",
					"id" : "obj-13",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 426.0, 450.0, 35.0, 17.0 ],
					"fontname" : "Verdana",
					"maximum" : 512,
					"id" : "obj-15",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"patching_rect" : [ 426.0, 430.0, 35.0, 17.0 ],
					"fontname" : "Verdana",
					"maximum" : 512,
					"id" : "obj-16",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "\/ch_2 $1",
					"outlettype" : [ "" ],
					"patching_rect" : [ 463.0, 450.0, 53.0, 15.0 ],
					"fontname" : "Verdana",
					"id" : "obj-17",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "\/ch_1 $1",
					"outlettype" : [ "" ],
					"patching_rect" : [ 463.0, 430.0, 53.0, 15.0 ],
					"fontname" : "Verdana",
					"id" : "obj-18",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"outlettype" : [ "" ],
					"patching_rect" : [ 455.0, 283.0, 125.0, 15.0 ],
					"fontname" : "Verdana",
					"id" : "obj-19",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "prepend set",
					"outlettype" : [ "" ],
					"patching_rect" : [ 456.0, 260.0, 61.0, 17.0 ],
					"fontname" : "Verdana",
					"id" : "obj-20",
					"numinlets" : 1,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "dac~",
					"patching_rect" : [ 635.0, 258.0, 122.0, 17.0 ],
					"fontname" : "Verdana",
					"id" : "obj-21",
					"numinlets" : 2,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "s jmod.input~.help",
					"hidden" : 1,
					"patching_rect" : [ 678.0, 311.0, 91.0, 17.0 ],
					"fontname" : "Verdana",
					"id" : "obj-22",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "\/sf_open",
					"outlettype" : [ "" ],
					"patching_rect" : [ 610.0, 451.0, 51.0, 15.0 ],
					"fontname" : "Verdana",
					"id" : "obj-23",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 610.0, 433.0, 93.0, 15.0 ],
					"fontname" : "Verdana",
					"id" : "obj-24",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "\/loop $1",
					"outlettype" : [ "" ],
					"patching_rect" : [ 627.0, 385.0, 49.0, 15.0 ],
					"fontname" : "Verdana",
					"id" : "obj-25",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "\/play $1",
					"outlettype" : [ "" ],
					"patching_rect" : [ 627.0, 365.0, 50.0, 15.0 ],
					"fontname" : "Verdana",
					"id" : "obj-27",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"types" : [  ],
					"patching_rect" : [ 426.0, 359.0, 123.0, 17.0 ],
					"fontname" : "Verdana",
					"id" : "obj-29",
					"numinlets" : 1,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 426.0, 379.0, 94.0, 15.0 ],
					"fontname" : "Verdana",
					"id" : "obj-30",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 456.0, 87.0, 91.0, 17.0 ],
					"fontname" : "Verdana",
					"id" : "obj-31",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "\/input~",
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 456.0, 109.0, 303.0, 142.0 ],
					"args" : [  ],
					"id" : "obj-32",
					"numinlets" : 1,
					"numoutlets" : 3,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 526.5, 281.0, 464.5, 281.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-19", 0 ],
					"hidden" : 0,
					"midpoints" : [ 465.5, 279.0, 464.5, 279.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 465.5, 255.0, 465.5, 255.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 465.5, 257.0, 617.5, 257.0 ]
				}
