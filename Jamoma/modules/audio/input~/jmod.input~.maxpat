{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 32.0, 91.0, 1225.0, 635.0 ],
		"bglocked" : 0,
		"defrect" : [ 32.0, 91.0, 1225.0, 635.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "jcom.message audio/panic @type msg_none @description \"Stop audio immediately.\"",
					"outlettype" : [ "", "", "" ],
					"fontname" : "Verdana",
					"id" : "obj-14",
					"numinlets" : 1,
					"fontsize" : 10.0,
					"patching_rect" : [ 828.0, 562.0, 439.0, 19.0 ],
					"numoutlets" : 3
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 10.0,
					"patching_rect" : [ 335.0, 200.0, 360.0, 31.0 ],
					"numoutlets" : 3
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.message soundfile/direct @type msg_none @description container for various messages sent directly to the sfplay~ object. Refer to the MSP documentation for further details.",
					"linecount" : 2,
					"outlettype" : [ "", "", "" ],
					"fontname" : "Verdana",
					"id" : "obj-65",
					"numinlets" : 1,
					"fontsize" : 10.0,
					"patching_rect" : [ 825.0, 360.0, 587.0, 31.0 ],
					"numoutlets" : 3
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "play",
					"text" : "jcom.parameter soundfile/play @type msg_toggle @description \"Play sound file.\" @type msg_toggle",
					"outlettype" : [ "", "", "" ],
					"fontname" : "Verdana",
					"id" : "obj-66",
					"numinlets" : 1,
					"fontsize" : 10.0,
					"patching_rect" : [ 828.0, 214.0, 518.0, 19.0 ],
					"numoutlets" : 3
				}
