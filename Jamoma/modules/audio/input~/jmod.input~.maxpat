{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 35.0, 44.0, 1306.0, 746.0 ],
		"bglocked" : 0,
		"defrect" : [ 35.0, 44.0, 1306.0, 746.0 ],
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"triangle" : 0,
					"presentation_rect" : [ 5.0, 44.0, 30.0, 19.0 ],
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"triangle" : 0,
					"presentation_rect" : [ 5.0, 27.0, 30.0, 19.0 ],
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"varname" : "Play_button",
					"fontname" : "Verdana",
					"presentation_rect" : [ 235.0, 46.0, 60.0, 15.0 ],
					"numinlets" : 1,
					"fontsize" : 9.873845,
					"mode" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "Open_button",
					"fontname" : "Verdana",
					"presentation_rect" : [ 235.0, 29.0, 60.0, 15.0 ],
					"numinlets" : 1,
					"fontsize" : 9.873845,
...
, 			{
				"box" : 				{
					...
					"varname" : "input_menu",
					"fontname" : "Verdana",
					"presentation_rect" : [ 120.0, 111.0, 100.0, 18.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"varname" : "DSP_Status",
					"fontname" : "Verdana",
					"presentation_rect" : [ 55.0, 113.0, 57.0, 15.0 ],
					"numinlets" : 1,
					"fontsize" : 9.873845,
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"presentation_rect" : [ 255.0, 70.0, 16.0, 16.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 830.0, 320.0, 15.0, 15.0 ],
					"presentation" : 1,
					"numoutlets" : 1,
					"id" : "obj-29",
					"outlettype" : [ "int" ]
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jcom.parameter balance @type msg_float @range/bounds -1 1 @range/clipmode both @description \"Balance of the stereo signal\"",
					"linecount" : 2,
					"fontname" : "Verdana",
					"numinlets" : 1,
					"fontsize" : 10.0,
					"patching_rect" : [ 335.0, 200.0, 366.0, 31.0 ],
					"numoutlets" : 3,
					"id" : "obj-42",
					"outlettype" : [ "", "", "" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "jcom.meter~",
					"presentation_rect" : [ 55.0, 46.0, 170.0, 14.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "jcom.meter~",
					"presentation_rect" : [ 55.0, 30.0, 170.0, 14.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 10.0,
					"patching_rect" : [ 335.0, 80.0, 448.0, 43.0 ],
					"numoutlets" : 3,
					"id" : "obj-7",
					"outlettype" : [ "", "", "" ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "loop",
					"fontname" : "Verdana",
					"presentation_rect" : [ 250.0, 85.0, 30.0, 19.0 ],
					"frgb" : [ 0.658824, 0.658824, 0.658824, 1.0 ],
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 839.0, 340.0, 815.0, 340.0, 815.0, 295.0, 839.5, 295.0 ]
				}
