{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ -166.0, 54.0, 1384.0, 669.0 ],
		"bglocked" : 0,
		"defrect" : [ -166.0, 54.0, 1384.0, 669.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 819.0, 73.0, 739.0, 31.0 ],
					"text" : "jcom.parameter clicktrain/rate @type msg_float @description \"How often a click is generated. in [Hz] by default.\" @range/bounds 0.01 100. @range/clipmode both @dataspace time @dataspace/unit/active hz @dataspace/unit/native hz @dataspace/unit/display hz",
					"varname" : "ch_1[1]"
				}
