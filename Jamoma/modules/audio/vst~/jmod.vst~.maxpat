{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 13.0, 44.0, 1230.0, 826.0 ],
		"bglocked" : 0,
		"defrect" : [ 13.0, 44.0, 1230.0, 826.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "textslider",
					"numoutlets" : 1,
					"patching_rect" : [ 6.0, 165.0, 160.0, 20.0 ],
					"presentation" : 1,
					"id" : "obj-107",
					"outlettype" : [ "" ],
					"presentation_rect" : [ 10.0, 175.0, 165.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "textslider",
					"numoutlets" : 1,
					"patching_rect" : [ 6.0, 145.0, 160.0, 20.0 ],
					"presentation" : 1,
					"id" : "obj-106",
					"outlettype" : [ "" ],
					"presentation_rect" : [ 10.0, 150.0, 165.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "textslider",
					"numoutlets" : 1,
					"patching_rect" : [ 6.0, 125.0, 160.0, 20.0 ],
					"presentation" : 1,
					"id" : "obj-105",
					"outlettype" : [ "" ],
					"presentation_rect" : [ 10.0, 125.0, 165.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "textslider",
					"numoutlets" : 1,
					"patching_rect" : [ 6.0, 105.0, 160.0, 20.0 ],
					"presentation" : 1,
					"id" : "obj-104",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "textslider",
					"numoutlets" : 1,
					"patching_rect" : [ 140.0, 325.0, 160.0, 20.0 ],
					"presentation" : 1,
					"id" : "obj-103",
					"outlettype" : [ "" ],
					"presentation_rect" : [ 10.0, 75.0, 165.0, 20.0 ],
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "print from_jcom_in",
					"numoutlets" : 0,
					"patching_rect" : [ 295.0, 435.0, 107.0, 19.0 ],
					"id" : "obj-10",
					"fontname" : "Verdana",
					"numinlets" : 1,
					"fontsize" : 10.0
...
, 			{
				"box" : 				{
					...
					"text" : "s #0_menu_rect",
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 715.0, 92.0, 19.0 ],
					"id" : "obj-11",
					"fontname" : "Verdana",
					"numinlets" : 1,
					"fontsize" : 10.0
...
, 			{
				"box" : 				{
					...
					"text" : "gate",
					"numoutlets" : 1,
					"patching_rect" : [ 360.0, 690.0, 31.0, 19.0 ],
					"id" : "obj-13",
					"outlettype" : [ "" ],
					"fontname" : "Verdana",
					"numinlets" : 2,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"patching_rect" : [ 410.0, 665.0, 118.0, 19.0 ],
					"id" : "obj-14",
					"outlettype" : [ "", "" ],
					"fontname" : "Verdana",
					"numinlets" : 2,
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 0.0, 47.0, 1535.0, 587.0 ],
										"bglocked" : 0,
										"defrect" : [ 0.0, 47.0, 1535.0, 587.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"patching_rect" : [ 1350.0, 385.0, 162.0, 17.0 ],
													"id" : "obj-31",
													"outlettype" : [ "" ],
													"fontname" : "Verdana",
													"numinlets" : 2,
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "" ],
													"fontname" : "Verdana",
													"color" : [ 0.882353, 0.035294, 0.035294, 0.8 ],
													"numinlets" : 1,
													"fontsize" : 10.0
												}
													...
													"patcher" : 													{
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"text" : "+ 20",
																	"numoutlets" : 1,
																	"patching_rect" : [ 135.0, 230.0, 35.0, 19.0 ],
																	"id" : "obj-1",
																	"outlettype" : [ "int" ],
																	"fontname" : "Verdana",
																	"numinlets" : 2,
...
, 															{
																"box" : 																{
																	...
																	"text" : "t 5 i",
																	"numoutlets" : 2,
																	"patching_rect" : [ 240.0, 215.0, 32.5, 19.0 ],
																	"id" : "obj-2",
																	"outlettype" : [ "int", "int" ],
																	"fontname" : "Verdana",
																	"numinlets" : 1,
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"patching_rect" : [ 80.0, 260.0, 88.0, 19.0 ],
																	"id" : "obj-13",
																	"outlettype" : [ "int" ],
																	"fontname" : "Verdana",
																	"numinlets" : 6,
...
, 															{
																"patchline" : 																{
																	...
																	"hidden" : 0,
																	"midpoints" : [ 144.5, 226.0, 130.899994, 226.0 ]
																}
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 580.0, 193.0, 31.0 ],
					"id" : "obj-54",
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"fontname" : "Verdana",
					"numinlets" : 1,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-13", 0 ],
					"hidden" : 0,
					"midpoints" : [ 419.5, 688.0, 369.5, 688.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-14", 0 ],
					"hidden" : 0,
					"midpoints" : [ 396.25, 655.0, 419.5, 655.0 ]
				}
