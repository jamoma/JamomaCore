...
#P message 394 189 50 196617;
#B color 7;
#P message 394 112 50 196617;
#B color 7;
#P message 394 260 50 196617;
#B color 7;
#P newex 394 145 49 196617 pvar ch2;
#B color 7;
#P newex 394 68 49 196617 pvar ch1;
#B color 7;
...
#P message 227 269 34 196617 write;
...
#B color 7;
#P newex 394 485 164 196617 jmod.parameter $0_ set_right_ch;
#B color 2;
#P objectname jmod.parameter.mxt[1];
#P newex 394 382 158 196617 jmod.parameter $0_ set_left_ch;
#B color 2;
...
#B color 7;
#P newex 697 423 138 196617 jmod.parameter $0_ modout;
#B color 2;
...
#P newex 697 519 132 196617 jmod.message $0_ sf_open;
#B color 2;
...
#P newex 227 289 81 196617 pattrstorage @autorestore 0 @savemode 0;
...
#P newex 694 86 225 196617 jmod.parameter $0_ source_select @type menu;
#B color 2;
#P objectname jmod.parameter.mxb[8];
#P newex 697 612 124 196617 jmod.message $0_ direct;
#B color 2;
#P objectname jmod.parameter.mxb[9];
#P newex 697 255 125 196617 jmod.parameter $0_ play;
#B color 2;
#P objectname jmod.parameter.mxb[5];
#P newex 697 333 124 196617 jmod.parameter $0_ loop;
#B color 2;
#P objectname jmod.parameter.mxb[4];
#P comment 143 233 101 196617 ---signal outputs---;
#P comment 61 283 79 196617 command input;
#P newex 47 301 168 196617 jmod.hub $0_ input~ @size 2U-half;
...
#P bpatcher 0 0 256 121 0 0 jmod.gui.2Uh.a.null.mxt 0;
...
#P connect 84 0 24 0;
#P connect 41 2 42 0;
#P fasten 86 0 89 0 399 109 389 109 389 63 399 63;
#P connect 89 0 86 0;
#P connect 86 0 92 0;
#P fasten 87 0 90 0 399 186 390 186 390 141 399 141;
#P connect 90 0 87 0;
#P connect 87 0 93 0;
