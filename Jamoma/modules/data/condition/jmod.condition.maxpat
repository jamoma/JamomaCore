{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 417.0, 44.0, 836.0, 749.0 ],
		"bglocked" : 0,
		"defrect" : [ 417.0, 44.0, 836.0, 749.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter scale @type msg_int @range/clipmode none @description \"Choose scaling mode: none - manual - auto.\"",
					"varname" : "scale[1]"
				}
