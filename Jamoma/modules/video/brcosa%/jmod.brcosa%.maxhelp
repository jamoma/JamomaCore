...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 15.0, 275.0, 252.0, 21.0 ],
					"numoutlets" : 0,
					"fontsize" : 10.533333,
					"fontname" : "Verdana",
					"id" : "obj-3"
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"numinlets" : 1,
					"patching_rect" : [ 158.0, 331.0, 15.0, 15.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"id" : "obj-4"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 19.0, 331.0, 35.0, 17.0 ],
					"numoutlets" : 2,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"text" : "\/saturation $1",
					"numinlets" : 2,
					"patching_rect" : [ 56.0, 331.0, 77.0, 15.0 ],
					"numoutlets" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 0.866667, 0.866667, 0.866667, 1.0 ],
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"patching_rect" : [ 19.0, 311.0, 35.0, 17.0 ],
					"numoutlets" : 2,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"text" : "\/brightness $1",
					"numinlets" : 2,
					"patching_rect" : [ 56.0, 311.0, 78.0, 15.0 ],
					"numoutlets" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "\/monochrome $1",
					"numinlets" : 2,
					"patching_rect" : [ 175.0, 331.0, 87.0, 15.0 ],
					"numoutlets" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 56.0, 374.0, 103.0, 17.0 ],
					"numoutlets" : 0,
					"hidden" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 0.866667, 0.866667, 0.866667, 1.0 ],
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"patching_rect" : [ 138.0, 311.0, 35.0, 17.0 ],
					"numoutlets" : 2,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"text" : "\/contrast $1",
					"numinlets" : 2,
					"patching_rect" : [ 175.0, 311.0, 69.0, 15.0 ],
					"numoutlets" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"patching_rect" : [ 318.0, 79.0, 103.0, 17.0 ],
					"numoutlets" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "s jmod.brcosa%.cmd",
					"numinlets" : 1,
					"patching_rect" : [ 12.0, 224.0, 103.0, 17.0 ],
					"numoutlets" : 0,
					"hidden" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 29.0, 41.0, 242.0, 17.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "loadmess set",
					"numinlets" : 1,
					"patching_rect" : [ 384.0, 170.0, 65.0, 17.0 ],
					"numoutlets" : 1,
					"hidden" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"numinlets" : 2,
					"patching_rect" : [ 318.0, 192.0, 236.0, 15.0 ],
					"numoutlets" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "prepend set",
					"numinlets" : 1,
					"patching_rect" : [ 318.0, 170.0, 61.0, 17.0 ],
					"numoutlets" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"linecount" : 4,
					"numinlets" : 1,
					"patching_rect" : [ 629.0, 106.0, 110.0, 49.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"id" : "obj-24"
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 184.5, 370.0, 65.5, 370.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-10", 0 ],
					"hidden" : 1,
					"midpoints" : [ 65.5, 370.0, 65.5, 370.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 393.5, 189.0, 327.5, 189.0 ]
				}
