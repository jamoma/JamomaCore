	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "jmod.input%",
					"numinlets" : 2,
					"patching_rect" : [ 92.0, 590.0, 66.0, 15.0 ],
					"numoutlets" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "prepend help",
					"numinlets" : 1,
					"patching_rect" : [ 92.0, 609.0, 64.0, 17.0 ],
					"numoutlets" : 1,
					"hidden" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"text" : "pcontrol",
					"numinlets" : 1,
					"patching_rect" : [ 92.0, 628.0, 45.0, 17.0 ],
					"numoutlets" : 1,
					"hidden" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 20.0, 55.0, 242.0, 17.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"numinlets" : 1,
					"patching_rect" : [ 288.0, 132.0, 15.0, 15.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"id" : "obj-7"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "qmetro 40",
					"numinlets" : 2,
					"patching_rect" : [ 288.0, 153.0, 57.0, 17.0 ],
					"numoutlets" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"outlettype" : [ "bang" ],
...
, 			{
				"box" : 				{
					...
					"linecount" : 4,
					"numinlets" : 1,
					"patching_rect" : [ 348.0, 184.0, 72.0, 49.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"id" : "obj-11"
...
, 			{
				"box" : 				{
					...
					"text" : "see also",
					"numinlets" : 1,
					"patching_rect" : [ 43.0, 591.0, 46.0, 17.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"id" : "obj-12"
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"numinlets" : 1,
					"patching_rect" : [ 20.0, 88.0, 338.0, 28.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"id" : "obj-13"
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 336.5, 321.0, 51.5, 321.0 ]
				}
