{
	"patcher" : 	{
		"rect" : [ 69.0, 69.0, 838.0, 442.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 69.0, 69.0, 838.0, 442.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 377.0, 74.0, 395.0, 17.0 ],
					"numoutlets" : 1,
					"hidden" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"text" : "algorithm",
					"numinlets" : 1,
					"patching_rect" : [ 75.0, 32.0, 53.0, 17.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					"maxclass" : "umenu",
					"numinlets" : 1,
					"patching_rect" : [ 131.0, 30.0, 60.0, 17.0 ],
					"types" : [  ],
					"numoutlets" : 3,
					"pattrmode" : 1,
					"fontsize" : 9.0,
...
, 			{
				"box" : 				{
					...
					"text" : "VIDEO INPUT",
					"numinlets" : 1,
					"patching_rect" : [ 474.0, 142.0, 67.0, 17.0 ],
					"numoutlets" : 0,
					"hidden" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					"maxclass" : "umenu",
					"numinlets" : 1,
					"patching_rect" : [ 38.0, 30.0, 25.0, 17.0 ],
					"types" : [  ],
					"numoutlets" : 3,
					"pattrmode" : 1,
					"fontsize" : 9.0,
...
, 			{
				"box" : 				{
					...
					"text" : "mode",
					"numinlets" : 1,
					"patching_rect" : [ 7.0, 32.0, 31.0, 17.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"frgb" : [ 0.584314, 0.584314, 0.584314, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"numinlets" : 1,
					"patching_rect" : [ 377.0, 34.0, 284.0, 28.0 ],
					"numoutlets" : 1,
					"hidden" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "jmod.hub",
					"text" : "jcom.hub jmod.similarity% @size 1U-half @module_type video @algorithm_type jitter @description \"Creates a similarity matrix from a running video input. This could be either a regular video or a motiongram.\"",
					"linecount" : 3,
					"numinlets" : 1,
					"patching_rect" : [ 0.0, 109.0, 345.0, 38.0 ],
					"numoutlets" : 2,
					"hidden" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 1,
					"midpoints" : [ 527.5, 182.0, 373.5, 182.0 ]
				}
