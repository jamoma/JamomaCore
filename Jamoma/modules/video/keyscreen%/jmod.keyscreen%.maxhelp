	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "On or Off",
					"numinlets" : 1,
					"patching_rect" : [ 99.0, 432.0, 100.0, 17.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"id" : "obj-1"
...
, 			{
				"box" : 				{
					...
					"text" : "1, 2 or 3",
					"numinlets" : 1,
					"patching_rect" : [ 98.0, 392.0, 100.0, 17.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"id" : "obj-2"
...
, 			{
				"box" : 				{
					...
					"text" : "1, 2 or 3",
					"numinlets" : 1,
					"patching_rect" : [ 101.0, 357.0, 100.0, 17.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"id" : "obj-3"
...
, 			{
				"box" : 				{
					...
					"text" : "1, 2 or 3",
					"numinlets" : 1,
					"patching_rect" : [ 105.0, 320.0, 100.0, 17.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"id" : "obj-4"
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "It'possible to change the order of your inlet by changing numbers of the Key, Target and Mask",
					"linecount" : 2,
					"numinlets" : 1,
					"patching_rect" : [ 202.0, 558.0, 303.0, 28.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"id" : "obj-17"
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Mode is the ON\/OFF Switch. Off position equal only the Target out",
					"numinlets" : 1,
					"patching_rect" : [ 202.0, 537.0, 303.0, 17.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"id" : "obj-18"
...
, 			{
				"box" : 				{
					...
					"linecount" : 6,
					"numinlets" : 1,
					"patching_rect" : [ 202.0, 457.0, 274.0, 70.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"id" : "obj-19"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 619.0, 167.0, 301.0, 71.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"id" : "obj-23",
					"args" : [  ],
...
, 			{
				"box" : 				{
					...
					"name" : "jmod.input%.maxpat",
					"numinlets" : 1,
					"patching_rect" : [ 613.0, 73.0, 301.0, 71.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"id" : "obj-24",
					"args" : [  ],
...
, 			{
				"box" : 				{
					...
					"name" : "jmod.input%.maxpat",
					"numinlets" : 1,
					"patching_rect" : [ 308.0, 73.0, 301.0, 71.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"id" : "obj-25",
					"args" : [  ],
...
, 			{
				"box" : 				{
					...
					"text" : "r jmod.op%.cmd",
					"numinlets" : 0,
					"patching_rect" : [ 308.0, 147.0, 83.0, 17.0 ],
					"numoutlets" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "loadmess set",
					"numinlets" : 1,
					"patching_rect" : [ 376.0, 306.0, 65.0, 17.0 ],
					"numoutlets" : 1,
					"hidden" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"numinlets" : 2,
					"patching_rect" : [ 308.0, 328.0, 231.0, 15.0 ],
					"numoutlets" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "prepend set",
					"numinlets" : 1,
					"patching_rect" : [ 308.0, 306.0, 61.0, 17.0 ],
					"numoutlets" : 1,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"depthbuffer" : 0,
					"patching_rect" : [ 550.0, 349.0, 320.0, 240.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"id" : "obj-33"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"patching_rect" : [ 308.0, 170.0, 301.0, 131.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"id" : "obj-34",
					"args" : [  ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 105.0, 282.0, 100.0, 17.0 ],
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"fontname" : "Verdana",
					"id" : "obj-37"
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 385.5, 325.0, 317.5, 325.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 599.5, 148.0, 411.5, 148.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 904.5, 154.0, 505.5, 154.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 599.5, 338.0, 559.5, 338.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 910.5, 241.0, 932.0, 241.0, 932.0, 162.0, 599.5, 162.0 ]
				}
