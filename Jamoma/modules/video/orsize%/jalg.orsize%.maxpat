...
, 			{
				"box" : 				{
					...
					"numoutlets" : 9,
					"outlettype" : [ "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 28.0, 45.0, 615.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 21.0, 86.0, 18.0 ],
					"text" : "INSTRUCTIONS"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 586.0, 21.0, 75.0, 18.0 ],
					"text" : "VIDEO INPUT"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 312.0, 264.0, 50.0, 16.0 ],
					"text" : "theta $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 312.0, 243.0, 140.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 321.0, 226.0, 50.0, 18.0 ],
					"text" : "degrees"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 249.0, 264.0, 63.0, 16.0 ],
					"text" : "zoom_y $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 602.0, 159.0, 50.0, 16.0 ],
					"text" : "map 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 188.0, 264.0, 63.0, 16.0 ],
					"text" : "zoom_x $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 156.0, 301.0, 42.0, 18.0 ],
					"text" : "jit.rota"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 553.0, 159.0, 50.0, 16.0 ],
					"text" : "map 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.0, 390.0, 122.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 151.0, 390.0, 85.0, 18.0 ],
					"text" : "VIDEO OUTPUT"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 553.0, 127.0, 42.0, 18.0 ],
					"text" : "sel 1 0",
					"varname" : "+[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 553.0, 190.0, 119.0, 18.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 574.0, 151.0, 611.5, 151.0 ],
					"source" : [ "obj-7", 1 ]
				}
