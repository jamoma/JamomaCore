...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "jmod.hub",
					"text" : "jcom.hub jmod.gl.alphamixer% @module_type video @algorithm_type jitter @description \"A four channel slab-based video mixer with alpha channels and Photoshop-style layers.\"",
					"linecount" : 3,
					"fontname" : "Arial",
					"id" : "obj-62",
					"numinlets" : 1,
					"numoutlets" : 2,
					"patching_rect" : [ 13.0, 214.0, 337.0, 38.0 ],
					"fontsize" : 9.0,
					"outlettype" : [ "", "" ]
				}
