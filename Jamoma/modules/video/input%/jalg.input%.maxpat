...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 55.0, 137.0, 535.0, 18.0 ],
					"text" : "jcom.oscroute /camera /file /synth /desktop"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 10,
									"outlettype" : [ "", "", "", "", "", "", "", "", "", "" ],
									"patching_rect" : [ 212.0, 88.0, 445.0, 18.0 ],
									"text" : "jcom.oscroute /open /active /loop /size /rate /counter /audio /loop_points /framedump"
								}
