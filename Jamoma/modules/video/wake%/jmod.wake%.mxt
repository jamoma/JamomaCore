...
#P hidden newex 396 140 233 196617 jcom.parameter normalize @type msg_toggle @description "Switches normalization on and off";
#P objectname normalize;
#P flonum 143 18 35 9 0 0 8224 3 181 181 181 221 221 221 255 255 255 0 0 0;
#P flonum 143 32 35 9 0 0 8224 3 181 181 181 221 221 221 255 255 255 0 0 0;
#P hidden newex 396 14 275 196617 jcom.parameter bleed @type msg_float @ramp/drive scheduler @description "Sets convolution kernel value for all colors";
#P objectname bleed;
#P hidden newex 396 44 244 196617 jcom.parameter gain @type msg_float @ramp/drive scheduler @description "The gain level for all colors";
#P objectname gain;
#P flonum 65 18 35 9 0 0 8224 3 181 181 181 221 221 221 255 255 255 0 0 0;
#P window linecount 1;
#P comment 5 20 65 196617 feedforward;
#B frgb 149 149 149;
#P flonum 65 32 35 9 0 0 8224 3 181 181 181 221 221 221 255 255 255 0 0 0;
#P comment 22 34 48 196617 feedback;
#B frgb 149 149 149;
#P window linecount 2;
#P hidden newex 395 109 265 196617 jcom.parameter feedback @type msg_float @ramp/drive scheduler @description "The feedback value for all colors";
...
#P window linecount 2;
#P hidden newex 0 109 351 196617 jcom.hub jmod.wake% @size 1U-half @module_type video @algorithm_type jitter @description "Video feedback with convolution for trippy effects";
#P objectname jcom.hub;
#P hidden outlet 0 171 13 0;
#P hidden inlet 0 84 13 0;
#P hidden newex 396 76 282 196617 jcom.parameter feedforward @type msg_float @ramp/drive scheduler @description "The feedforward value for all colors";
