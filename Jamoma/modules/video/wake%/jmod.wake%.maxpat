...
, 			{
				"box" : 				{
					"maxclass" : "radiogroup",
					"presentation_rect" : [ 1.905786, 50.17025, 79.0, 18.0 ],
					"id" : "obj-11",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "jcom.hub",
					"text" : "jcom.hub jmod.wake% @module_type video @algorithm_type jitter @description \"Video feedback with convolution for trippy effects\"",
					"linecount" : 3,
					"fontsize" : 9.873845,
					"id" : "obj-26",
					"numinlets" : 1,
