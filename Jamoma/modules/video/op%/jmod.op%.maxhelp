{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 234.0, 123.0, 942.0, 556.0 ],
		"bglocked" : 0,
		"defrect" : [ 234.0, 123.0, 942.0, 556.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 55.0, 262.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 26.0, 269.0, 28.0 ],
					"text" : "jmod.op%"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 16.0, 273.0, 63.0 ],
					"rounded" : 15
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 308.0, 161.0, 92.0, 18.0 ],
					"text" : "r jmod.op%.cmd"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 373.0, 249.0, 73.0, 18.0 ],
					"text" : "loadmess set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 308.0, 271.0, 112.0, 16.0 ]
				}
