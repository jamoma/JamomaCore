{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 200.0, 154.0, 1034.0, 552.0 ],
		"bglocked" : 0,
		"defrect" : [ 200.0, 154.0, 1034.0, 552.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 51.0, 405.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 69.0, 405.0, 69.0, 17.0 ],
					"text" : "/color $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 11.0, 335.0, 55.0, 17.0 ],
					"pattrmode" : 1,
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 69.0, 387.0, 72.0, 17.0 ],
					"text" : "/trails $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 31.0, 353.0, 37.0, 18.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 69.0, 353.0, 108.0, 17.0 ],
					"text" : "/edge_thresh $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 244.0, 142.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 272.0, 169.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 51.0, 370.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 31.0, 318.0, 37.0, 18.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 69.0, 318.0, 65.0, 17.0 ],
					"text" : "/slide $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 31.0, 301.0, 37.0, 18.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 69.0, 301.0, 92.0, 17.0 ],
					"text" : "/threshold $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 69.0, 370.0, 69.0, 17.0 ],
					"text" : "/noise $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 69.0, 424.0, 119.0, 17.0 ],
...
,
					"patching_rect" : [ 312.0, 218.0, 100.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "A simplified motion module"
				}
...
,
					"patching_rect" : [ 700.0, 75.0, 156.0, 18.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Verdana",
						"default_fontsize" : 12.0,
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 312.0, 521.0, 59.0, 19.0 ],
					"text" : "route 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 605.0, 238.0, 59.0, 19.0 ],
					"text" : "route 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 312.0, 113.0, 133.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 223.0, 103.0, 17.0 ],
					"text" : "s jmod.motion%.cmd"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 395.0, 216.0, 230.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 242.0, 195.0, 28.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 120.0, 120.0, 241.0, 27.0 ],
					"rounded" : 15
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 272.0, 196.0, 150.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 120.0, 150.0, 241.0, 113.0 ],
					"rounded" : 15
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"hidden" : 1,
					"midpoints" : [ 510.0, 243.0, 591.0, 243.0, 591.0, 234.0, 614.5, 234.0 ],
					"source" : [ "obj-36", 1 ]
				}
