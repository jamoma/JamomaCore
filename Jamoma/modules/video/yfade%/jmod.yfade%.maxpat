	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"orientation" : 0,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 276.0, 275.0, 75.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 261.0, 88.0, 195.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 53.0, 364.0, 125.0, 18.0 ],
					"text" : "jcom.out 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 85.0, 289.0, 78.0, 18.0 ],
					"text" : "jcom.in 1"
				}
...
,
					"patching_rect" : [ 276.0, 252.0, 66.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 112.0, 88.0, 137.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 68.0, 397.0, 94.0, 18.0 ],
					"text" : "VIDEO OUTPUTS"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 100.0, 255.0, 77.0, 18.0 ],
					"text" : "VIDEO INPUT"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 53.0, 338.0, 125.0, 18.0 ],
					"text" : "jalg.yfade%"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 86.0, 88.0, 18.0 ],
					"text" : "command input"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 4.0, 132.0, 226.0, 42.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"hidden" : 0,
					"midpoints" : [ 285.5, 331.0, 270.0, 331.0, 270.0, 245.0, 285.5, 245.0 ],
					"source" : [ "obj-10", 0 ]
				}
