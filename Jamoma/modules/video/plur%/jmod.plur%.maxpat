{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 136.0, 57.0, 866.0, 628.0 ],
		"bglocked" : 0,
		"defrect" : [ 136.0, 57.0, 866.0, 628.0 ],
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"presentation_rect" : [ 428.0, 164.0, 0.0, 0.0 ],
									"text" : "$6"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 428.0, 251.0, 0.0, 0.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 428.0, 191.0, 76.0, 18.0 ],
									"presentation_rect" : [ 428.0, 191.0, 0.0, 0.0 ],
									"text" : "clip -200 200"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 428.0, 221.0, 117.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 303.0, 222.0, 117.0, 18.0 ],
									"text" : "scale -200 200 0. 50."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 176.0, 222.0, 117.0, 18.0 ],
									"text" : "scale -200 200 0. 50."
								}
...
,
					"patching_rect" : [ 342.0, 29.0, 78.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 51.0, 391.0, 54.0, 18.0 ],
					"text" : "jcom.out"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 52.0, 281.0, 77.0, 18.0 ],
					"text" : "VIDEO INPUT"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 51.0, 330.0, 57.0, 18.0 ],
					"text" : "jcom.in 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 342.0, 466.0, 27.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 18.0, 172.0, 237.0, 42.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 132.0, 137.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 51.0, 449.0, 87.0, 18.0 ],
					"text" : "VIDEO OUTPUT"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 18.0, 109.0, 88.0, 18.0 ],
					"text" : "command input"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 51.0, 366.0, 62.0, 18.0 ],
					"text" : "jalg.plur%"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 129.5, 168.0, 27.5, 168.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-25", 0 ],
					"hidden" : 0,
					"midpoints" : [ 351.5, 591.0, 327.0, 591.0, 327.0, 537.0, 353.5, 537.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"hidden" : 0,
					"midpoints" : [ 351.5, 246.0, 327.0, 246.0, 327.0, 192.0, 352.5, 192.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"hidden" : 0,
					"midpoints" : [ 351.5, 534.0, 327.0, 534.0, 327.0, 462.0, 351.5, 462.0 ],
					"source" : [ "obj-5", 0 ]
				}
