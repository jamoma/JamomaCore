...
#P hidden inlet 206 147 13 0;
#P hidden comment 221 147 65 196617 VIDEO INPUT;
#P hidden newex 137 165 79 196617 jmod.edge%.alg;
#P hidden message 35 146 72 196617 \; jmod.init bang;
#B color 3;
#P hidden comment 14 84 79 196617 command input;
#P hidden newex 0 109 265 196617 jmod.hub $0_ edge% @size 1U-half @library_type jitter;
