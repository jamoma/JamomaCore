...
#P hidden message 193 160 74 196617 store 1 \, write;
#P hidden newex 199 178 65 196617 pattrstorage;
...
#P hidden newex 4 179 183 196617 jmod.hub $0_ degradeM @size 1U-half;
...
#B frgb 172 172 172;
#P hidden newex 100 246 95 196617 poly~ degradeM.alg;
...
#P bpatcher 0 0 256 60 0 0 jmod.gui.1Uh.a.mono.mxb 0 $0_;
...
#P hidden fasten 5 0 0 1 105 275 268 275 268 -15 251 -15;
