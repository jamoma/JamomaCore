...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 7.0, 40.0, 288.0, 27.0 ],
					"id" : "obj-34",
					"fontname" : "Geneva",
					"numinlets" : 1,
					"lines" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "offset[1]",
					"text" : "jcom.parameter dcblocker @type msg_toggle @repetitions/allow 1 @description \"Removes DC components from the signals. Changes only take effect when audio is off.\"",
					"linecount" : 2,
					"numoutlets" : 3,
					"fontsize" : 9.0,
					"outlettype" : [ "", "", "" ],
					...
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 518.0, 245.0, 589.0, 27.0 ]
				}
