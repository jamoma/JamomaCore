{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 32.0, 54.0, 969.0, 769.0 ],
		"bglocked" : 0,
		"defrect" : [ 32.0, 54.0, 969.0, 769.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 379.0, 77.0, 575.0, 674.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 191.0, 165.0, 98.0, 43.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@name", "jmod.sur.speaker.setup", "@description", "Module for describing loudspeaker setup as XYZ coordinates" ],
					"bgmode" : 1,
					"id" : "obj-1",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 220.0, 255.0, 101.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 220.0, 279.0, 35.0, 17.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 259.0, 165.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 524.0, 176.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 25.0, 314.0, 200.0, 200.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 65.0, 115.0, 132.0, 19.0 ],
...
,
					"patching_rect" : [ 25.0, 140.0, 82.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 589.0, 250.0, 17.0 ],
					"text" : "/speaker.8/position 3.535533 3.535535 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 175.0, 150.0, 70.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 229.5, 309.0, 34.5, 309.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"hidden" : 0,
					"midpoints" : [ 34.5, 581.0, 265.5, 581.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 34.5, 252.0, 229.5, 252.0 ],
					"source" : [ "obj-11", 0 ]
				}
