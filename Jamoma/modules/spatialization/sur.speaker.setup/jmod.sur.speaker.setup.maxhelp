{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 28.0, 55.0, 981.0, 716.0 ],
		"bglocked" : 0,
		"defrect" : [ 28.0, 55.0, 981.0, 716.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 65.0, 120.0, 110.0, 19.0 ],
...
,
					"patching_rect" : [ 25.0, 145.0, 82.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 564.0, 250.0, 17.0 ],
					"text" : "/speaker.8/position 0.035355 0.035355 0."
				}
...
,
					"patching_rect" : [ 210.0, 535.0, 70.0, 19.0 ],
					"saved_object_attributes" : 					{
						"fontsize" : 10.0,
						"default_fontface" : 0,
						"default_fontname" : "Verdana",
...
,
					"patching_rect" : [ 25.0, 260.0, 58.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontsize" : 10.0,
						"default_fontface" : 0,
						"default_fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 25.0, 120.0, 37.0, 19.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"hidden" : 0,
					"midpoints" : [ 219.5, 558.5, 265.5, 558.5 ],
					"source" : [ "obj-74", 0 ]
				}
