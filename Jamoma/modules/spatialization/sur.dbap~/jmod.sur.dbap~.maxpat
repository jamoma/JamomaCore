	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 470.0, 385.0, 589.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 470.0, 360.0, 538.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 530.0, 150.0, 578.0, 31.0 ],
					"text" : "jcom.parameter rolloff @type msg_float @range 1 6 @clipmode low @description \"Rolloff in dB with doubling of distance.\"",
					"varname" : "voices[3]"
				}
