...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 401.0, 131.0, 685.0, 457.0 ],
						"bglocked" : 0,
						"defrect" : [ 401.0, 131.0, 685.0, 457.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 451.0, 165.0, 46.0, 18.0 ],
									"text" : "uzi 2 1"
								}
									...
									"patcher" : 									{
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"patcher" : 													{
														"fileversion" : 1,
														"rect" : [ 426.0, 126.0, 640.0, 480.0 ],
														"bglocked" : 0,
														"defrect" : [ 426.0, 126.0, 640.0, 480.0 ],
														"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
														"openinpresentation" : 0,
														"default_fontsize" : 10.0,
														"default_fontface" : 0,
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 80.0, 160.0, 88.0, 19.0 ],
																	"text" : "append 0. 0. 0."
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 3,
																	"outlettype" : [ "bang", "bang", "int" ],
																	"patching_rect" : [ 50.0, 130.0, 51.0, 19.0 ],
																	"text" : "uzi 32 1"
																}
...
, 															{
																"box" : 																{
																	...
																	"numinlets" : 1,
																	"numoutlets" : 0,
																	"patching_rect" : [ 80.0, 239.0, 25.0, 25.0 ]
																}
...
,
													"patching_rect" : [ 75.0, 75.0, 36.0, 19.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 90.0, 135.0, 70.0, 19.0 ],
													"text" : "prepend set"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 45.0, 165.0, 121.0, 18.0 ],
													"text" : "pack 1 0. 0. 0."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 4,
													"outlettype" : [ "", "", "", "" ],
													"patching_rect" : [ 45.0, 105.0, 121.0, 17.0 ],
													"saved_object_attributes" : 													{
														"embed" : 0
													}
,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 45.0, 225.0, 64.0, 17.0 ],
													"text" : "prepend aed"
												}
...
, 											{
												"patchline" : 												{
													...
													"hidden" : 0,
													"midpoints" : [ 9.5, 219.0, 54.5, 219.0 ],
													"source" : [ "obj-36", 0 ]
												}
...
,
									"patching_rect" : [ 330.0, 165.0, 114.0, 18.0 ],
									"saved_object_attributes" : 									{
										"fontname" : "Verdana",
										"globalpatchername" : "",
										"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 133.0, 109.0, 640.0, 480.0 ],
										"bglocked" : 0,
										"defrect" : [ 133.0, 109.0, 640.0, 480.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 405.0, 0.0, 180.0, 48.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 435.0, 75.0, 32.5, 17.0 ],
									"text" : "t b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 435.0, 50.0, 54.0, 17.0 ],
									"text" : "r  #0_reset"
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 487.5, 273.5, 272.0, 273.5 ],
									"source" : [ "obj-7", 2 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-7", 1 ],
									"hidden" : 0,
									"midpoints" : [ 275.899994, 155.0, 487.5, 155.0 ],
									"source" : [ "obj-4", 3 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 0 ],
									"hidden" : 0,
									"midpoints" : [ 444.5, 106.0, 217.5, 106.0 ],
									"source" : [ "obj-3", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-22", 0 ],
									"hidden" : 0,
									"midpoints" : [ 339.5, 339.0, 35.0, 339.0 ],
									"source" : [ "obj-52", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 275.899994, 156.0, 339.5, 156.0 ],
									"source" : [ "obj-4", 3 ]
								}
