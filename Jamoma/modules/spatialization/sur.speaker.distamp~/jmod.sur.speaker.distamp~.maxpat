{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 33.0, 92.0, 993.0, 720.0 ],
		"bglocked" : 0,
		"defrect" : [ 33.0, 92.0, 993.0, 720.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"fontsize" : 10.0,
					"patching_rect" : [ 525.0, 240.0, 362.0, 31.0 ],
					"outlettype" : [ "", "", "" ],
					"id" : "obj-1",
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"fontsize" : 10.0,
					"patching_rect" : [ 525.0, 201.0, 385.0, 31.0 ],
					"outlettype" : [ "", "", "" ],
					"id" : "obj-2",
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"fontsize" : 10.0,
					"patching_rect" : [ 525.0, 154.0, 431.0, 43.0 ],
					"outlettype" : [ "", "", "" ],
					"id" : "obj-3",
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"patching_rect" : [ 245.0, 345.0, 67.0, 43.0 ],
					"id" : "obj-6",
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"fontsize" : 10.0,
					"patching_rect" : [ 235.0, 230.0, 150.0, 19.0 ],
					"outlettype" : [ "", "" ],
					"id" : "obj-13",
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"fontsize" : 10.0,
					"patching_rect" : [ 235.0, 265.0, 49.0, 19.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-14",
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"fontsize" : 10.0,
					"patching_rect" : [ 10.0, 150.0, 294.0, 31.0 ],
					"outlettype" : [ "", "" ],
					"id" : "obj-19",
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "NOTE: Jitter is required in this module!",
					"numinlets" : 1,
					"numoutlets" : 0,
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"fontsize" : 10.0,
					"patching_rect" : [ 26.0, 537.0, 441.0, 19.0 ],
					"id" : "obj-27",
					"fontname" : "Verdana"
				}
