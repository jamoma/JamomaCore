	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 751.0, 150.0, 50.0, 17.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						...
						"bglocked" : 0,
						"defrect" : [ 314.0, 80.0, 966.0, 550.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patcher" : 									{
										...
										"bglocked" : 0,
										"defrect" : [ 480.0, 316.0, 640.0, 480.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
...
,
									"patching_rect" : [ 525.0, 195.0, 158.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										...
										"bglocked" : 0,
										"defrect" : [ 464.0, 197.0, 640.0, 480.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
...
,
									"patching_rect" : [ 187.0, 195.0, 158.0, 19.0 ],
									"saved_object_attributes" : 									{
										"fontname" : "Verdana",
										"default_fontsize" : 10.0,
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 28.0, 251.0, 116.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 31.0, 329.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 30.0, 169.0, 24.0, 19.0 ],
									"text" : "t b"
								}
...
,
									"patching_rect" : [ 117.0, 196.0, 68.0, 19.0 ],
									"saved_object_attributes" : 									{
										"fontname" : "Verdana",
										"default_fontsize" : 10.0,
										"globalpatchername" : "",
...
,
									"patching_rect" : [ 350.0, 193.0, 132.0, 19.0 ],
									"saved_object_attributes" : 									{
										"fontname" : "Verdana",
										"default_fontsize" : 10.0,
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 775.0, 198.0, 123.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 147.0, 119.0, 73.0, 19.0 ],
									"text" : "t i i i i b"
								}
...
,
					"patching_rect" : [ 169.0, 324.0, 51.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Verdana",
						"default_fontsize" : 10.0,
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 169.0, 301.0, 80.0, 20.0 ],
					"text" : "r #0__setting"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 133.0, 35.0, 70.0, 16.0 ],
					"readonly" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 89.0, 35.0, 43.0, 16.0 ],
					"rounded" : 8.0,
					"text" : "Pause",
					"texton" : "Resume",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 35.0, 43.0, 16.0 ],
					"rounded" : 8.0,
					"text" : "Open",
					"texton" : "DSP",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 208.0, 61.0, 230.0, 28.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 216.0, 45.0, 41.0, 28.0 ],
					"text" : "ms"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 135.0, 61.0, 195.0, 28.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 156.0, 45.0, 25.0, 28.0 ],
					"text" : "s"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 76.0, 61.0, 219.0, 28.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 106.0, 45.0, 26.0, 28.0 ],
					"text" : "m"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 59.0, 45.0, 25.0, 28.0 ],
					"text" : "h"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 172.0, 46.0, 45.0, 28.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 130.0, 46.0, 34.0, 28.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 86.0, 46.0, 24.0, 28.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 36.0, 46.0, 24.0, 28.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 497.0, 109.0, 558.0, 31.0 ],
					"text" : "jcom.message sf_open @type msg_generic @repetitions/allow 1 @description \"Open sound file specified by filename. Without a filename a standard open file dialog allows you to choose a file.\""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 51.0, 295.0, 17.0 ],
					"rounded" : 0.0,
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.0, 308.0, 106.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 31.0, 52.0, 220.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 72.0, 387.0, 119.0, 19.0 ],
