{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 110.0, 49.0, 1361.0, 784.0 ],
		"bglocked" : 0,
		"defrect" : [ 110.0, 49.0, 1361.0, 784.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 315.0, 45.0, 125.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 20.0, 55.0, 19.0 ],
					"text" : "qlim 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 315.0, 70.0, 80.0, 60.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 220.0, 45.0, 80.0, 60.0 ]
				}
