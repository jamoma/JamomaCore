...
#P newex 0 109 344 9109513 jmod.hub $0_ jmod.video.template @size 1U-half @module_type video @library_type jitter @num_inputs 1 @num_outputs 1 @description "This module doesn't do much yet.";
