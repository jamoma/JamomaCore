...
#P window linecount 1;
#P newex 10 50 113 9109513 jmod.pass bypass mute;
#P objectname u776000027[3];
#P newex 501 84 265 9109513 jmod.pp degrade.gain_midi 6 "degrade gain (midi)" 0 158;
#B color 7;
...
#P window linecount 2;
#P newex 80 86 53 9109513 regexp (limiter.);
#P window linecount 1;
#P message 147 55 72 9109513 substitute %0;
#P newex 147 36 45 9109513 loadbang;
#P window linecount 2;
#P newex 136 86 55 9109513 regexp (degrade.);
#P window linecount 6;
#P comment 602 347 182 9109513 This example demonstrates how to augment the system in the Pluggo_Simple example to work with multiple modules in a single plugin. It includes shared bypass and mute parameters that always effect both modules in tandem.;
#P window linecount 1;
#P newex 215 421 105 9109513 zl join 1;
#P newex 215 400 91 9109513 sprintf limiter.%s;
#P newex 215 379 105 9109513 zl slice 1;
#P newex 113 358 113 9109513 jmod.pass bypass mute;
#P newex 382 358 113 9109513 jmod.pass bypass mute;
#P newex 10 29 99 9109513 r ---parameter_set;
...
#P newex 501 288 161 9109513 jmod.pp limiter.shape 9 shape 0 1;
#P flonum 461 289 35 9 0 0 0 139 0 0 0 221 221 221 222 222 222 0 0 0;
#P newex 501 133 121 9109513 jmod.pp mute 4 mute 0 1;
#P toggle 461 134 15 0;
#P newex 501 113 139 9109513 jmod.pp bypass 3 bypass 0 1;
#P toggle 461 114 15 0;
#P newex 501 267 203 9109513 jmod.pp limiter.gain_midi 6 midigain 0 158;
#B color 7;
...
#C initialpgm 1;
#P newobj 306 296 54 9109513 plugconfig;
