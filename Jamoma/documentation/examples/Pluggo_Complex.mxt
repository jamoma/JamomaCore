max v2;
#N vpatcher 262 135 1142 623;
#P window setfont "Sans Serif" 9.;
#P newex 494 371 141 196617 jcom.pluggo.configassist.mxt;
...
#P newex 50 50 226 196617 jcom.pass /audio/bypass /audio/mute @strip 0;
#P inlet 50 30 15 0;
...
#P newex 50 59 226 196617 jcom.pass /audio/bypass /audio/mute @strip 0;
#P inlet 50 30 15 0;
...
#B frgb 255 255 255;
#P window setfont "Sans Serif" 9.;
#P comment 26 54 239 196617 Multiple modules in a single plugin;
#B frgb 255 255 255;
...
#X shadow 0;
#X done;
#P newex 267 165 170 196617 jcom.oscroute /limiter~ /degrade~;
#P window linecount 2;
#P message 750 371 62 196617 \; max refresh;
#P window linecount 1;
#P newex 30 165 226 196617 jcom.pass /audio/bypass /audio/mute @strip 0;
#P objectname u776000027[3];
#P newex 530 113 311 196617 jcom.pp /degrade~/audio/gain/midi 3 "degrade gain (midi)" 0 158;
#B color 7;
#P flonum 490 114 35 9 0 0 0 3 0 0 0 221 221 221 222 222 222 0 0 0;
#P newex 530 93 219 196617 jcom.pp /degrade~/bitdepth 2 "bitdepth" 1 24;
#P number 490 94 35 9 0 0 0 3 0 0 0 221 221 221 222 222 222 0 0 0;
#P newex 530 73 263 196617 jcom.pp /degrade~/sr_ratio 1 "sample rate ratio" 0. 1.;
...
#P newex 530 317 308 196617 jcom.pp /limiter~/mode 10 shape 0 1 @choices exponential linear;
#P newex 530 162 163 196617 jcom.pp /audio/mute 12 mute 0 1;
#P toggle 490 163 15 0;
#P newex 530 142 181 196617 jcom.pp /audio/bypass 11 bypass 0 1;
#P toggle 490 143 15 0;
#P newex 530 296 248 196617 jcom.pp /limiter~/audio/gain/midi 9 midigain 0 158;
#B color 7;
#P flonum 490 297 35 9 0 0 0 3 0 0 0 221 221 221 222 222 222 0 0 0;
#P newex 530 275 233 196617 jcom.pp /limiter~/release 8 release 1. 2000. ms;
#P flonum 490 276 35 9 0 0 0 3 0 0 0 221 221 221 222 222 222 0 0 0;
#P newex 530 254 264 196617 jcom.pp /limiter~/lookahead 7 lookahead 0 100 samples;
#P flonum 490 255 35 9 0 0 0 3 0 0 0 221 221 221 222 222 222 0 0 0;
#P newex 530 233 231 196617 jcom.pp /limiter~/threshold 6 threshold -48. 18;
#P flonum 490 234 35 9 0 0 0 3 0 0 0 221 221 221 222 222 222 0 0 0;
#P newex 530 212 221 196617 jcom.pp /limiter~/postamp 5 postamp -48. 18;
#P flonum 490 213 35 9 0 0 0 3 0 0 0 221 221 221 222 222 222 0 0 0;
#P newex 530 191 216 196617 jcom.pp /limiter~/preamp 4 preamp -48. 18.;
