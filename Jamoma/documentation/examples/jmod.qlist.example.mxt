...
#N qlist;
#X append ------------------------ 1 \; 0 1 my_degrade /audio/mute 0 \; my_degrade /audio/gain 0 ramp 2000 \; ------------------------ 2 \;;
#X append 0 2 my_degrade2 /audio/gain 0 ramp 2000 \; 2000 limiter /audio/mute 0 \; limiter /audio/gain 0 ramp 3500;
#X append \; ------------------------ 3 \; 0 3 edge% /thresh 0.75 ramp 500 \; ------------------------ 4 \; 0 4 var2;
#X append 8600 \; ------------------------ 5 \; 0 5 var2 7100 \; 1000 var1 1 \; ------------------------ 6 \; 0;
#X append 6 var1 8400 \; ------------------------ 7 \; 0 7 var2 6800 \; ------------------------ 8 \; 0 8 var1;
#X append 9100 \; ------------------------ 9 \; 0 9 var1 7300 \; 2500 var2 100 \; ------------------------ 10 \; 0;
#X append 10 var1 7200 \; var2 3 \; ------------------------ 11 \; 0 11 \;;
