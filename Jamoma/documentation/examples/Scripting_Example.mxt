...
#P message 56 260 193 196617 \; max refresh;
#P window linecount 1;
...
#N coll script 1;
#T flags 1 0;
#T 0 load jmod.input~.mxt 300 100 255 120;
#T 1 load jmod.output~.mxt 300 220 510 120;
#T 2 load jmod.degrade~.mxt 300 340 255 60;
#T 3 load jmod.limiter~.mxt 300 400 255 60;
#T 4 max refresh;
