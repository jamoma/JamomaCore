...
#P message 325 154 40 196617 link \$1;
#P toggle 309 154 15 0;
#P message 6 120 68 196617 gain -6 3000;
#P comment 6 103 206 196617 Ramp to new value;
#P message 243 203 60 196617 gain_2_dec;
#P message 307 203 58 196617 gain_2_inc;
#P message 148 203 79 196617 gain_2_midi \$1;
#P number 111 203 35 9 0 0 0 3 0 0 0 221 221 221 222 222 222 0 0 0;
#P message 41 203 54 196617 gain_2 \$1;
#P number 4 203 35 9 0 0 0 3 0 0 0 221 221 221 222 222 222 0 0 0;
#P message 243 182 60 196617 gain_1_dec;
#P message 307 182 58 196617 gain_1_inc;
#P message 148 182 79 196617 gain_1_midi \$1;
#P number 111 182 35 9 0 0 0 3 0 0 0 221 221 221 222 222 222 0 0 0;
#P message 41 182 54 196617 gain_1 \$1;
