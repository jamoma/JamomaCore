{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 62.0, 80.0, 709.0, 442.0 ],
		"bglocked" : 0,
		"defrect" : [ 62.0, 80.0, 709.0, 442.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 35.0, 243.0, 0.0, 0.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.970939,
					"numinlets" : 1,
					"patching_rect" : [ 470.0, 315.0, 50.0, 20.0 ],
					"id" : "obj-42",
					"fontname" : "Verdana",
					"numoutlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.970939,
					"numinlets" : 1,
					"patching_rect" : [ 415.0, 315.0, 50.0, 20.0 ],
					"id" : "obj-40",
					"fontname" : "Verdana",
					"numoutlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 3,
					"patching_rect" : [ 385.0, 345.0, 81.0, 19.0 ],
					"id" : "obj-36",
					"fontname" : "Verdana",
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.970939,
					"numinlets" : 0,
					"patching_rect" : [ 270.0, 320.0, 54.0, 20.0 ],
					"id" : "obj-35",
					"fontname" : "Verdana",
					"numoutlets" : 1,
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 542.0, 81.0, 442.0, 189.0 ],
						"bglocked" : 0,
						"defrect" : [ 542.0, 81.0, 442.0, 189.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"floatoutput" : 1,
									"presentation_rect" : [ 277.0, 154.0, 0.0, 0.0 ],
									"numinlets" : 1,
...
, 							{
								"box" : 								{
									...
									"fontsize" : 11.595187,
									"hidden" : 1,
									"presentation_rect" : [ 297.0, 129.0, 0.0, 0.0 ],
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "swatch",
									"outlettype" : [ "", "float" ],
									"presentation_rect" : [ 277.0, 169.0, 0.0, 0.0 ],
									"numinlets" : 3,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"numinlets" : 1,
					"patching_rect" : [ 105.0, 410.0, 19.0, 19.0 ],
					"id" : "obj-2",
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 35.0, 380.0, 140.0, 14.0 ],
					"id" : "obj-1",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.970939,
					"numinlets" : 2,
					"patching_rect" : [ 535.0, 340.0, 85.0, 18.0 ],
					"id" : "obj-8",
					"fontname" : "Verdana",
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 35.0, 410.0, 67.0, 19.0 ],
					"id" : "obj-25",
					"fontname" : "Verdana",
					"numoutlets" : 2,
					"triscale" : 0.9
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 394.5, 375.0, 44.5, 375.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 279.5, 375.0, 44.5, 375.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 184.5, 375.0, 44.5, 375.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 228.5, 375.0, 44.5, 375.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 304.5, 375.0, 44.5, 375.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 544.5, 375.0, 44.5, 375.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 44.5, 402.0, 114.5, 402.0 ]
				}
