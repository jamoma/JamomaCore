...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"numinlets" : 1,
					"patching_rect" : [ 270.0, 440.0, 65.0, 19.0 ],
					"fontsize" : 10.0,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"numinlets" : 1,
					"patching_rect" : [ 270.0, 417.0, 17.0, 19.0 ],
					"fontsize" : 10.0,
					"numoutlets" : 1,
					"patcher" : 					{
						"fileversion" : 1,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"numinlets" : 0,
					"patching_rect" : [ 270.0, 365.0, 50.0, 19.0 ],
					"fontsize" : 10.0,
					"numoutlets" : 1,
					"patcher" : 					{
						"fileversion" : 1,
...
, 			{
				"box" : 				{
					...
					"frgb" : [ 0.337255, 0.356863, 0.690196, 1.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 40.0, 300.0, 337.0, 31.0 ],
					"fontsize" : 10.0,
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"numinlets" : 1,
					"patching_rect" : [ 335.0, 365.0, 35.0, 19.0 ],
					"fontsize" : 10.0,
					"numoutlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"numinlets" : 3,
					"patching_rect" : [ 300.0, 390.0, 88.0, 19.0 ],
					"fontsize" : 10.0,
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"numinlets" : 2,
					"patching_rect" : [ 224.0, 389.0, 40.0, 17.0 ],
					"fontsize" : 10.0,
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"numinlets" : 1,
					"patching_rect" : [ 45.0, 450.0, 35.0, 19.0 ],
					"fontsize" : 10.0,
					"numoutlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Verdana",
					"numinlets" : 1,
					"patching_rect" : [ 180.0, 365.0, 35.0, 19.0 ],
					"fontsize" : 10.0,
					"numoutlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"keymode" : 1,
					"numinlets" : 1,
					"patching_rect" : [ 45.0, 365.0, 126.0, 20.0 ],
					"fontsize" : 8.998901,
					"numoutlets" : 3
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-31", 0 ],
					"hidden" : 0,
					"midpoints" : [ 189.5, 411.0, 54.5, 411.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-31", 0 ],
					"hidden" : 0,
					"midpoints" : [ 233.5, 411.0, 54.5, 411.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-31", 0 ],
					"hidden" : 0,
					"midpoints" : [ 309.5, 411.0, 54.5, 411.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-31", 0 ],
					"hidden" : 0,
					"midpoints" : [ 279.5, 411.0, 54.5, 411.0 ]
				}
