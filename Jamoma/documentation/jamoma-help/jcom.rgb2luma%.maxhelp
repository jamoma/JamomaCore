	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "see also:",
					"fontsize" : 10,
					"patching_rect" : [ 335.0, 35.0, 53.0, 18.0 ],
					"id" : "obj-1",
					"numinlets" : 1,
					"fontname" : "Verdana",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10,
					"hidden" : 1,
					"patching_rect" : [ 335.0, 71.0, 74.0, 18.0 ],
					"id" : "obj-2",
					"numinlets" : 1,
					"fontname" : "Verdana",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 10,
					"patching_rect" : [ 335.0, 49.0, 94.0, 16.0 ],
					"id" : "obj-3",
					"numinlets" : 2,
					"fontname" : "Verdana",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10,
					"hidden" : 1,
					"patching_rect" : [ 335.0, 92.0, 49.0, 18.0 ],
					"id" : "obj-4",
					"numinlets" : 1,
					"fontname" : "Verdana",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10,
					"patching_rect" : [ 241.0, 212.0, 94.0, 18.0 ],
					"id" : "obj-8",
					"numinlets" : 1,
					"fontname" : "Verdana",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "jit_matrix", "" ],
					"fontsize" : 10,
					"patching_rect" : [ 241.0, 145.0, 115.0, 18.0 ],
					"id" : "obj-10",
					"numinlets" : 1,
					"fontname" : "Verdana",
					"numoutlets" : 2
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10,
					"hidden" : 1,
					"patching_rect" : [ 29.0, 75.0, 65.0, 18.0 ],
					"id" : "obj-11",
					"numinlets" : 1,
					"fontname" : "Verdana",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "jit_matrix" ],
					"fontsize" : 10,
					"patching_rect" : [ 29.0, 212.0, 94.0, 18.0 ],
					"id" : "obj-13",
					"numinlets" : 1,
					"fontname" : "Verdana",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"fontsize" : 10,
					"patching_rect" : [ 29.0, 119.0, 60.0, 18.0 ],
					"id" : "obj-16",
					"numinlets" : 2,
					"fontname" : "Verdana",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "jit_matrix", "" ],
					"fontsize" : 10,
					"patching_rect" : [ 29.0, 145.0, 115.0, 18.0 ],
					"id" : "obj-17",
					"numinlets" : 1,
					"fontname" : "Verdana",
					"numoutlets" : 2
...
, 			{
				"box" : 				{
					...
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
					"patching_rect" : [ 29.0, 42.0, 245.0, 18.0 ],
					"id" : "obj-19",
					"numinlets" : 1,
					"fontname" : "Verdana",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"fontsize" : 10,
					"patching_rect" : [ 54.0, 458.0, 352.0, 30.0 ],
					"id" : "obj-21",
					"numinlets" : 1,
					"fontname" : "Verdana",
					"numoutlets" : 0
