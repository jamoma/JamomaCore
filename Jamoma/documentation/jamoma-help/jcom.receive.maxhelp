{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 169.0, 162.0, 864.0, 459.0 ],
		"bglocked" : 0,
		"defrect" : [ 169.0, 162.0, 864.0, 459.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "@name", "jcom.receive", "@description", "Receive messages from any Jamoma module" ],
					"bgmode" : 1,
					"id" : "obj-32",
					"maxclass" : "bpatcher",
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 801.0, 70.0 ],
					"varname" : "maxhelpui"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 474.0, 106.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 232.0, 120.0, 39.0, 19.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 232.0, 297.0, 208.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 676.0, 295.0, 93.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 559.0, 296.0, 93.0, 19.0 ],
					"text" : "jcom.receive foo"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 192.0, 211.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 557.0, 287.0, 215.0, 34.0 ],
					"rounded" : 15
				}
