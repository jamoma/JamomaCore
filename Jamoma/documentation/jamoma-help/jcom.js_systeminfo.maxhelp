...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "0",
					"patching_rect" : [ 273.0, 220.0, 56.0, 17.0 ],
					"id" : "obj-2",
					"fontname" : "Verdana",
					"numinlets" : 2,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "0",
					"patching_rect" : [ 210.0, 220.0, 56.0, 17.0 ],
					"id" : "obj-3",
					"fontname" : "Verdana",
					"numinlets" : 2,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "\"504\"",
					"patching_rect" : [ 147.0, 220.0, 56.0, 17.0 ],
					"id" : "obj-4",
					"fontname" : "Verdana",
					"numinlets" : 2,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "\"54\"",
					"patching_rect" : [ 84.0, 220.0, 56.0, 17.0 ],
					"id" : "obj-5",
					"fontname" : "Verdana",
					"numinlets" : 2,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "macintosh",
					"patching_rect" : [ 15.0, 220.0, 62.0, 17.0 ],
					"id" : "obj-6",
					"fontname" : "Verdana",
					"numinlets" : 2,
					"fontsize" : 10.0,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"color" : [ 1.0, 0.890196, 0.090196, 1.0 ],
					"midpoints" : [ 414.5, 211.0, 24.5, 211.0 ]
				}
