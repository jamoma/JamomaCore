...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"fontsize" : 10.0,
					"patching_rect" : [ 403.0, 93.0, 180.0, 31.0 ],
					"id" : "obj-2",
					"numinlets" : 1,
					"fontname" : "Verdana",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"patching_rect" : [ 403.0, 125.0, 39.0, 19.0 ],
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 10.0,
					"patching_rect" : [ 403.0, 143.0, 64.0, 17.0 ],
					"id" : "obj-7",
					"numinlets" : 2,
					"fontname" : "Verdana",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 10.0,
					"patching_rect" : [ 266.0, 143.0, 63.0, 17.0 ],
					"id" : "obj-8",
					"numinlets" : 2,
					"fontname" : "Verdana",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 10.0,
					"patching_rect" : [ 252.0, 125.0, 110.0, 17.0 ],
					"id" : "obj-9",
					"numinlets" : 2,
					"fontname" : "Verdana",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"fontsize" : 10.0,
					"patching_rect" : [ 252.0, 93.0, 140.0, 31.0 ],
					"id" : "obj-31",
					"numinlets" : 1,
					"fontname" : "Verdana",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 16.0, 695.0, 200.0, 19.0 ],
					"id" : "obj-35",
					"numinlets" : 1,
					"fontname" : "Verdana",
					"numoutlets" : 3,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 412.5, 172.0, 55.5, 172.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-26", 0 ],
					"hidden" : 0,
					"midpoints" : [ 275.5, 172.0, 55.5, 172.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-26", 0 ],
					"hidden" : 0,
					"midpoints" : [ 261.5, 172.0, 55.5, 172.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 412.5, 616.0, 55.5, 616.0 ]
				}
