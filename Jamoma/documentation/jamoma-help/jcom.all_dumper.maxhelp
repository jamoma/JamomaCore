{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 307.0, 45.0, 895.0, 444.0 ],
		"bglocked" : 0,
		"defrect" : [ 307.0, 45.0, 895.0, 444.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "/description \"When active, this attribute turns off the module's processing algorithm to save CPU\";\r/value 1;\r/type msg_toggle;\r/ramp/drive none;\r/ramp/function linear;\r/range/bounds 0. 1.;\r/range/clipmode none;\r/repetitions/allow 1;\r/dataspace none;\r/dataspace/unit/native none;\r/dataspace/unit/active none;\r/ui/freeze 0;\r/priority 0;\r",
					"linecount" : 14,
					"presentation_linecount" : 14,
					"fontname" : "Verdana",
					"id" : "obj-16",
					"patching_rect" : [ 355.0, 475.0, 289.0, 175.0 ],
					"presentation" : 1,
					"numinlets" : 2,
					"fontsize" : 10.0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"presentation_rect" : [ 355.0, 225.0, 289.0, 175.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"items" : ".",
					"outlettype" : [ "int", "", "" ],
					"presentation_rect" : [ 447.0, 85.0, 13.0, 19.0 ],
					"arrow" : 0
				}
