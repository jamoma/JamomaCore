	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numoutlets" : 0,
					"presentation_rect" : [ 872.0, 299.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "jcom.ui",
					"patching_rect" : [ 900.0, 625.0, 53.0, 17.0 ],
					"id" : "obj-1",
					"fontname" : "Verdana",
					"numinlets" : 2,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "jcom.return",
					"patching_rect" : [ 900.0, 605.0, 69.0, 17.0 ],
					"id" : "obj-2",
					"fontname" : "Verdana",
					"numinlets" : 2,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "jcom.message",
					"patching_rect" : [ 900.0, 585.0, 82.0, 17.0 ],
					"id" : "obj-3",
					"fontname" : "Verdana",
					"numinlets" : 2,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "jcom.parameter",
					"patching_rect" : [ 900.0, 565.0, 90.0, 17.0 ],
					"id" : "obj-41",
					"fontname" : "Verdana",
					"numinlets" : 2,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"text" : "prepend help",
					"hidden" : 1,
					"patching_rect" : [ 995.0, 600.0, 76.0, 19.0 ],
					"id" : "obj-42",
					"fontname" : "Verdana",
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"text" : "pcontrol",
					"hidden" : 1,
					"patching_rect" : [ 995.0, 625.0, 51.0, 19.0 ],
					"id" : "obj-43",
					"fontname" : "Verdana",
					"numinlets" : 1,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 905.0, 445.0, 210.0, 17.0 ],
					"id" : "obj-47",
					"fontname" : "Verdana",
					"numinlets" : 2,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "See also",
					"patching_rect" : [ 895.0, 545.0, 52.0, 19.0 ],
					"frgb" : [ 0.933333, 0.937255, 0.968627, 1.0 ],
					"id" : "obj-72",
					"fontname" : "Verdana",
					"numinlets" : 1,
