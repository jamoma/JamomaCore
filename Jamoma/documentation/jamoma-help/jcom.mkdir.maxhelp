{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 159.0, 175.0, 530.0, 369.0 ],
		"bglocked" : 0,
		"defrect" : [ 159.0, 175.0, 530.0, 369.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "@name", "jcom.mkdir", "@description", "Create a directory on your drive" ],
					"bgmode" : 1,
					"id" : "obj-14",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.0, 94.0, 93.0, 20.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 212.0, 204.0, 240.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 202.0, 129.0, 303.0, 19.0 ],
...
,
					"patching_rect" : [ 87.0, 179.0, 134.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.0, 229.0, 178.0, 17.0 ],
					"text" : "O106SL:/Users/jln/Desktop/testf"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"outputmode" : 1,
					"patching_rect" : [ 202.0, 149.0, 198.0, 18.0 ],
					"text" : "testf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 87.0, 129.0, 94.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 87.0, 299.0, 76.0, 19.0 ],
					"text" : "jcom.mkdir"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 182.0, 129.0, 24.0, 19.0 ],
					"text" : "->"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 211.5, 283.0, 96.5, 283.0 ],
					"source" : [ "obj-9", 0 ]
				}
