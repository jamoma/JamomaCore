...
function create()
{
	...
	outlet(0, "script", "new", "mapping_object_src_"+entry, "newex",50, (entry+1)*70, 200, 196617, "receive", "/jmod_from"+mapping_sources[entry]);
	outlet(0, "script", "new", "mapping_object_dst_"+entry, "newex",50, (entry+1)*70+40, 200, 196617, "send", "/jmod_to"+mapping_destinations[entry]);
