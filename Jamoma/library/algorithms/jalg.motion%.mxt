...
#P newex 208 480 173 196617 jcom.return motion/y @range 0. 1. @description "The center of gravity for the y-axis of the motion in the frame in a range of 0. to 1. (zero is left - one is right).";
#P window linecount 1;
#P newex 140 423 64 196617 unpack 0. 0.;
#P window linecount 5;
#P newex 147 555 175 196617 jcom.return motion/x @range 0. 1. @description "The center of gravity for the x-axis of the motion in the frame in a range of 0. to 1. (zero is left - one is right).";
#P window linecount 2;
#P newex 90 635 269 196617 jcom.return motion/quantity @range 0. 1. @description "The amount of motion in the frame in a range of 0. to 1.";
#P window linecount 1;
...
#P newex 301 53 190 196617 jcom.oscroute /algorithm /edge_thresh;
