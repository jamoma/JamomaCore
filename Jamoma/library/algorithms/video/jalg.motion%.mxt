...
#P pop;
#P newobj 83 173 71 196617 p return-data;
...
#P pop;
#P newobj 188 203 77 196617 p create-trails;
...
#P connect 5 0 4 0;
#P pop;
#P newobj 188 173 88 196617 p noise-reduction;
#N vpatcher 319 44 969 495;
#P origin -6 34;
#P window setfont "Sans Serif" 9.;
#P window linecount 0;
...
#P comment 230 40 121 196617 Here I used to use the motion image;
#P connect 21 0 22 0;
#P connect 22 0 20 0;
#P connect 19 0 20 1;
#P connect 20 1 6 0;
...
#P fasten 20 0 9 0 26 378 63 378;
#P connect 8 0 9 0;
#P fasten 27 0 17 0 169 249 78 249;
#P connect 17 0 16 0;
#P connect 16 0 7 0;
#P connect 6 1 16 1;
#P fasten 24 0 27 0 460 76 502 76 502 219 169 219;
#P fasten 27 1 12 0 270 249 186 249;
#P connect 12 0 11 0;
#P connect 11 0 10 0;
#P fasten 19 0 18 0 63 65 214 65;
#P connect 18 0 1 0;
#P connect 6 1 11 1;
#P fasten 24 0 18 1 460 66 273 66;
#P fasten 27 2 15 0 371 249 319 249;
#P connect 15 0 14 0;
#P connect 14 0 13 0;
#P connect 6 1 14 1;
#P fasten 18 0 23 0 214 99 377 99;
#P connect 23 0 3 0;
#P connect 24 0 23 1;
#P fasten 24 0 5 0 460 76 542 76;
#P pop;
#P newobj 22 278 67 196617 p draw-lines;
#P comment 39 328 75 196617 VIDEO OUTPUT;
...
#P connect 7 1 9 0;
#P pop;
#P newobj 22 244 84 196617 p edge-detection;
#P newex 144 111 74 196617 jcom.motion%;
#P newex 144 138 105 196617 jit.op @op > @val 0.1;
#N comlet Zoom-rotation output;
#P outlet 22 328 15 0;
...
#P inlet 180 31 15 0;
#P connect 2 0 4 0;
#P fasten 12 0 8 0 193 228 27 228;
#P connect 8 0 10 0;
#P connect 10 0 5 0;
#P connect 13 0 8 1;
#P fasten 4 5 10 1 332 270 84 270;
#P connect 4 1 14 0;
#P fasten 4 5 8 2 332 237 101 237;
#P connect 4 2 13 0;
#P connect 13 0 7 0;
#P connect 4 0 7 0;
#P connect 7 0 6 0;
#P connect 6 0 14 1;
#P connect 0 0 13 1;
#P fasten 6 0 11 0 149 165 193 165;
#P connect 11 0 12 0;
#P connect 4 3 6 1;
#P fasten 4 5 12 1 332 198 260 198;
#P connect 4 4 11 1;
#P pop;
