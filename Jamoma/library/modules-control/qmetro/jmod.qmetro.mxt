...
#P hidden newex 400 244 336 196617 jcom.parameter randomness @type msg_int @ramp linear.sched @repetitions 0 @range 0 5000 @clipmode low @description "Defines a range of randomness in milliseconds to be applied to the metro interval";
...
#P window linecount 2;
#P hidden newex 401 171 316 196617 jcom.parameter time @type msg_int @ramp linear.sched @repetitions 0 @range 1 5000 @clipmode low @description "Metro interval (ms)";
#P objectname time;
