...
#P window linecount 2;
#P newex 458 126 240 9109513 jcom.message my_message @repetitions 1 @type msg_int @ramp linear.sched @range 0 40000 @clipmode both;
...
#P newex 458 47 240 9109513 jcom.parameter my_parameter @repetitions 1 @type msg_int @ramp linear.sched @range 0 40000 @clipmode both;
