...
#P message 21 320 53 196617 1;
#P newex 21 297 53 196617 jcom.init;
#P window linecount 1;
#P newex 260 362 29 196617 gate;
#P newex 21 497 29 196617 gate;
#P window linecount 0;
#P newex 490 79 106 196617 jcom.oscroute /panic;
#P newex 361 186 35 196617 del 15;
#P newex 260 425 83 196617 s $0_xxx_audio;
#P newex 260 401 50 196617 route set;
...
#P outlet 21 528 15 0;
#P window linecount 1;
#P newex 37 79 141 196617 jcom.oscroute /refresh /init;
#P inlet 37 39 15 0;
#P newex 40 426 53 196617 dspstate~;
#P newex 40 447 55 196617 metro 250;
#P newex 40 467 64 196617 adstatus cpu;
#P window linecount 3;
#P comment 81 299 159 196617 This prevents adstatus from staring to report before jcom.hub and friends are ready for it.;
#P window linecount 0;
...
#P connect 2 0 23 1;
#P connect 6 1 8 0;
#P fasten 26 0 24 0 26 348 265 348;
#P connect 24 0 19 0;
#P connect 19 0 20 0;
#P fasten 27 1 28 0 323 127 284 127;
#P connect 29 0 28 0;
#P connect 28 0 24 1;
#P connect 6 2 13 0;
#P connect 13 0 27 0;
...
#P connect 14 1 21 0;
#P connect 15 1 21 0;
#P fasten 30 1 18 0 515 225 366 225;
#P connect 21 0 18 0;
#P connect 30 0 17 0;
#P connect 14 1 17 0;
#P connect 13 1 22 0;
