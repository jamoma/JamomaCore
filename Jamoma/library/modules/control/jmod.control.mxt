...
#P window linecount 1;
#P newex 260 296 29 196617 gate;
#P newex 21 431 29 196617 gate;
#P window linecount 0;
#P newex 470 79 106 196617 jcom.oscroute /panic;
#P newex 341 166 35 196617 del 15;
#P newex 260 344 83 196617 s $0_xxx_audio;
#P newex 260 320 50 196617 route set;
#P newex 341 220 21 196617 t 0;
#P newex 383 166 81 196617 s jcom.audio.off;
#P newex 279 250 80 196617 adstatus switch;
#P newex 279 138 44 196617 t 1 stop;
#P newex 279 117 134 196617 sel 1 0;
#P newex 279 79 106 196617 jcom.oscroute /audio;
#P comment 519 260 131 196617 Panic kill audio instantly;
#P window linecount 2;
#P comment 519 213 131 196617 Audio off is delayed briefly for a quick fade out.;
#P window linecount 3;
#P comment 519 154 131 196617 Smootth fade in when audio is turned on (this is handled in the audio modules).;
#P window linecount 2;
...
#P window linecount 3;
#P comment 81 233 159 196617 This prevents adstatus from staring to report before jcom.hub and friends are ready for it.;
#P connect 24 0 25 0;
#P connect 25 0 22 0;
#P connect 22 0 6 0;
#P connect 4 0 5 0;
...
#P connect 1 0 22 1;
#P connect 5 1 7 0;
#P fasten 25 0 23 0 26 282 265 282;
#P connect 23 0 18 0;
#P connect 18 0 19 0;
#P connect 5 2 12 0;
#P connect 12 0 13 0;
...
#P connect 13 1 20 0;
#P connect 14 1 20 0;
#P fasten 21 0 17 0 475 209 346 209;
#P connect 20 0 17 0;
#P connect 21 0 16 0;
#P connect 13 1 16 0;
#P connect 12 1 21 0;
