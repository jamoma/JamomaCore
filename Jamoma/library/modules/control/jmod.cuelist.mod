...
#P window setfont "Sans Serif" 9.;
#P window linecount 2;
#P comment 283 372 59 196617 #: comment;
#P window linecount 0;
#P message 573 40 121 196617 /eple/tre 1;
#P window linecount 1;
#P newex 496 35 62 196617 prepend set;
#P window linecount 0;
#P message 177 32 121 196617 /disable_ui_updates 0;
#P newex 100 27 62 196617 prepend set;
#P newex 409 570 42 196617 t resume;
#P window linecount 1;
#P newex 292 164 27 196617 i;
#P newex 292 190 40 196617 uzi;
#P window linecount 0;
#P newex 292 214 58 196617 prepend line;
#P newex 409 547 30 196617 defer;
#P newex 409 525 33 196617 del 0;
#P newex 409 493 56 196617 t b i pause;
#P newex 409 471 98 196617 route WAIT;
#P newex 351 398 27 196617 + 1;
#P newex 351 377 52 196617 jmod.s==;
...
#P window linecount 1;
#P newex 497 586 86 196617 s jmod.to_bridge;
#P newex 292 120 294 196617 t b query s stop;
#P newex 351 345 50 196617 zl slice 1;
#P newex 351 442 68 196617 gate 2 1;
...
#P newex 292 317 127 196617 route bang # cue_event;
#P window linecount 0;
#P newex 70 62 383 196617 jmod.oscroute /load_script /get_state /view /cue_event /remote;
#P outlet 70 490 15 0;
#P inlet 70 22 15 0;
#P comment 420 376 152 196617 jmod.s== looks for cue_event messages. Only if the argument of the cue_event message equals the desired cue_event \, messages are let through the 2nd outlet for further processing.;
...
#P comment 509 472 72 196617 Wait before pulling next line;
#P connect 4 0 6 0;
#P connect 6 0 8 0;
#P connect 4 0 29 0;
#P connect 6 1 16 0;
...
#P connect 13 0 27 0;
#P connect 27 0 26 0;
#P fasten 22 2 26 0 460 614 251 614 251 184 297 184;
#P lcolor 14;
#P fasten 28 0 26 0 414 612 254 612 254 186 297 186;
#P lcolor 14;
...
#P connect 20 0 11 0;
#P connect 6 4 17 0;
#P fasten 13 2 19 1 485 370 398 370;
#P connect 7 3 11 1;
#P connect 11 1 21 0;
#P connect 21 0 22 0;
#P fasten 13 3 23 0 579 521 414 521;
#P connect 22 0 23 0;
#P connect 23 0 24 0;
#P connect 24 0 28 0;
#P connect 22 1 23 1;
