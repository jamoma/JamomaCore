...
#P newex 95 226 37 196617 t open;
#P message 47 107 50 196617 /autodoc;
#P newex 95 340 69 196617 prepend /cpu;
#P newex 95 318 48 196617 pvar cpu;
#P newex 95 245 45 196617 pcontrol;
#P newex 95 206 103 196617 jmod.oscroute /open;
...
#P window linecount 2;
#P newex 318 245 219 196617 jmod.message.mxt $0_ /refresh @description "Refresh all Max windows.";
#P objectname jmod.parameter.mxt[3];
#P newex 318 361 219 196617 jmod.message.mxt $0_ /init @description "Initialize all Jamoma modules.";
...
#P connect 11 1 20 0;
#P pop;
#P newobj 95 282 109 196617 p Control_Components;
#P window linecount 5;
#P newex 24 132 153 196617 jmod.hub $0_ jmod.control @size 1U-half @module_type control @description "Master control module for the Jamoma environment";
#P objectname jmod.hub;
#P window linecount 2;
#P newex 318 77 218 196617 jmod.parameter.mxt $0_ /audio @type toggle @description "Toggle audio on and off.";
#P objectname jmod.parameter.mxt[1];
#P newex 318 301 219 196617 jmod.message.mxt $0_ /panic @description "Stop audio immediately.";
#P objectname jmod.parameter.mxt;
#P window linecount 3;
#P newex 212 132 79 196617 pattrstorage @autorestore 0 @savemode 0;
...
#P connect 29 0 25 0;
#P connect 25 0 18 0;
#P fasten 24 1 18 0 193 267 100 267;
#P connect 18 0 26 0;
#P connect 26 0 27 0;
#P connect 14 0 17 1;
#P connect 17 2 14 0;
