...
#P user umenu 97 22 39 9109543 1 64 38 1;
#X add 1000;
#X add 500;
#X add 100;
#X add 50;
...
#P window linecount 2;
#P hidden newex 475 199 368 9109513 jcom.parameter sample_rate @type msg_int @ramp linear.sched @repetitions 0 @range -1 1000 @clipmode low @description "Turn polling on";
#P objectname sample_rate[1];
#P number 59 22 35 9 -1 0 8225 139 181 181 181 221 221 221 222 222 222 0 0 0;
...
#P window linecount 1;
#P hidden message 276 274 153 9109513 /sample_rate 17;
#P hidden newex 276 252 61 9109513 prepend set;
#P comment 29 21 33 9109513 speed;
#B frgb 149 149 149;
...
#P hidden fasten 23 0 24 0 175 374 163 374 163 314 175 314;
