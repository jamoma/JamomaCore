...
#P newex 9 172 167 196617 jmod.hub.mxt $0_ jmod.output~ @size 2U-half @module_type audio @num_inputs 2 @num_outputs 0 @options no_panel;
#P comment 9 570 244 196617 - left channel jmod-meter~ tends to die;
#P newex 321 676 90 196617 s $0_xxx_record;
#B color 14;
#P comment 479 70 25 196617 ms;
#B frgb 198 198 198;
#P comment 393 69 47 196617 Release;
#B frgb 198 198 198;
#P newex 616 328 65 196617 pvar Preamp;
#P comment 480 54 24 196617 dB;
#B frgb 198 198 198;
#P comment 393 53 50 196617 Preamp;
#B frgb 198 198 198;
#P newex 616 437 65 196617 pvar Release;
#P user umenu 543 500 66 196647 1 64 516 1;
#X add exponential;
#X add linear;
#P newex 616 270 95 196617 pvar LimiterToggle;
...
#P newex 616 289 158 196617 jmod.parameter.mxt $0_ limiter;
#P objectname jmod.parameter.mxt[11];
#P flonum 566 483 43 9 0 0 0 3 0 0 0 221 221 221 222 222 222 0 0 0;
#P flonum 443 69 37 9 0. 10000. 8227 3 198 198 198 221 221 221 222 222 222 0 0 0;
#P objectname Release;
#P number 566 405 43 9 0 0 0 3 0 0 0 221 221 221 222 222 222 0 0 0;
#P flonum 566 385 43 9 0 0 0 3 0 0 0 221 221 221 222 222 222 0 0 0;
#P flonum 443 52 36 9 0. 48. 8227 3 198 198 198 221 221 221 222 222 222 0 0 0;
#P objectname Preamp;
#P window setfont "Sans Serif" 12.;
#P comment 298 487 210 196620 Sound File Record;
#B color 7;
#P window setfont "Sans Serif" 9.;
#P newex 616 500 245 196617 jmod.parameter.mxt $0_ limiter_shape @type menu;
#P objectname jmod.parameter.mxt[10];
#P newex 616 480 283 196617 jmod.parameter.mxt $0_ limiter_threshold @ramp_enable 1;
#P objectname jmod.parameter.mxt[9];
#P newex 616 457 274 196617 jmod.parameter.mxt $0_ limiter_release @ramp_enable 1;
#P objectname jmod.parameter.mxt[8];
#P newex 616 404 284 196617 jmod.parameter.mxt $0_ limiter_lookahead @ramp_enable 1;
#P objectname jmod.parameter.mxt[7];
#P newex 616 383 278 196617 jmod.parameter.mxt $0_ limiter_postamp @ramp_enable 1;
#P objectname jmod.parameter.mxt[6];
#P newex 616 349 274 196617 jmod.parameter.mxt $0_ limiter_preamp @ramp_enable 1;
...
#B frgb 198 198 198;
#P window setfont "Sans Serif" 12.;
#P comment 594 244 353 196620 Limiter (not all parameters are exposed in the interface);
#B color 7;
#P comment 594 103 210 196620 Saturation;
#B color 7;
#P window setfont "Sans Serif" 9.;
#P newex 614 206 173 196617 jmod.parameter.mxt $0_ saturation;
#P objectname jmod.parameter.mxt[4];
#P newex 614 186 109 196617 pvar SaturationToggle;
#P newex 614 132 105 196617 pvar SaturationDepth;
#P newex 614 153 355 196617 jmod.parameter.mxt $0_ saturation_depth @ramp_enable 1 @filter_dupes 1;
...
#B frgb 198 198 198;
#P newex 321 597 109 196617 pvar SamptypeMenu 2;
#P newex 321 620 225 196617 jmod.parameter.mxt $0_ samptype @type menu;
#P objectname jmod.parameter.mxt[3];
#P newex 321 558 219 196617 jmod.parameter.mxt $0_ filetype @type menu;
#B color 2;
...
#P pop;
#P newobj 321 507 60 196617 p FileTypes;
...
#P newex 321 535 101 196617 pvar FiletypeMenu 2;
...
#P number 416 321 35 9 0 0 0 3 0 0 0 74 156 97 222 222 222 0 0 0;
#P number 419 380 35 9 0 0 0 3 0 0 0 74 156 97 222 222 222 0 0 0;
#P message 321 197 45 196617 set \$1 0;
#P number 412 217 35 9 0 0 0 3 0 0 0 74 156 97 222 222 222 0 0 0;
...
#P newex 321 216 89 196617 pvar gain_master;
#B color 7;
#P newex 321 237 165 196617 jmod.parameter.gain.mxt $0_ gain;
#B color 2;
...
#P window setfont "Sans Serif" 12.;
#P comment 298 271 210 196620 DSP and dac~ settings;
#B color 7;
#P window setfont "Sans Serif" 9.;
#P comment 8 555 100 196617 Bugs/required fixes:;
#P newex 321 436 35 196617 t open;
#P newex 321 416 85 196617 pvar DSP_Status;
#B color 7;
#P newex 321 457 75 196617 s $0_xxx_dac;
#B color 14;
#P newex 321 379 95 196617 pvar Channel_Right;
#B color 7;
#P newex 321 320 91 196617 pvar Channel_Left;
#B color 7;
#P newex 321 359 169 196617 jmod.parameter.mxt $0_ set_ch_2;
#B color 2;
#P objectname jmod.parameter.mxt[1];
#P newex 321 300 169 196617 jmod.parameter.mxt $0_ set_ch_1;
#B color 2;
...
#P window setfont "Sans Serif" 12.;
#P comment 298 130 210 196620 Volume;
#B color 7;
#P user led 416 654 17 17 1 150;
#P window setfont "Sans Serif" 9.;
...
#P newex 321 654 93 196617 pvar RecordButton;
#B color 7;
#P newex 187 175 81 196617 pattrstorage @autorestore 0 @savemode 0;
#X client_rect 54 290 488 814;
#X storage_rect 0 0 640 240;
#P objectname jmod.output~;
#P user fpic 26 18 160 52 jmod.bg.hgain.pct 0 0 0 0. 0 0 0;
#P comment 32 153 79 196617 command input;
#P outlet 9 232 15 0;
#P inlet 9 154 15 0;
#P window setfont "Sans Serif" 12.;
#P comment 627 41 210 196620 All communication with interface is done using pvar;
#B color 7;
#P window setfont "Sans Serif" 9.;
#P comment 298 151 202 196617 The set message is important to prevent feedback into jmod.parameter.gain from killing ongoing ramps;
...
#X shadow 0;
#X done;
#P fasten 21 0 18 0 13 444 13 444;
#P fasten 22 0 18 0 52 444 13 444;
#P fasten 23 0 18 0 90 444 13 444;
#P connect 9 0 91 0;
#P connect 91 0 10 0;
...
#P connect 45 0 15 2;
#P lcolor 6;
#P fasten 37 0 41 0 326 258 316 258 316 193 326 193;
#P connect 41 0 38 0;
#P connect 38 0 37 0;
#P fasten 29 0 27 0 326 341 316 341 316 297 326 297;
#P connect 27 0 29 0;
#P fasten 30 0 28 0 326 400 316 400 316 355 326 355;
#P connect 28 0 30 0;
#P connect 32 0 33 0;
#P connect 33 0 31 0;
#P connect 49 0 47 0;
#P fasten 50 0 47 0 326 580 314 580 314 528 326 528;
#P fasten 47 1 50 0 417 555 326 555;
#P fasten 51 0 52 0 326 640 314 640 314 593 326 593;
#P fasten 52 1 51 0 425 617 326 617;
#P connect 14 0 89 0;
...
#P fasten 56 0 57 0 619 174 609 174 609 126 619 126;
#P connect 57 0 56 0;
#P fasten 59 0 58 0 619 227 609 227 609 181 619 181;
#P connect 58 0 59 0;
#P fasten 76 0 81 0 621 308 610 308 610 268 621 268;
#P connect 81 0 76 0;
#P fasten 64 0 86 0 621 370 610 370 610 324 621 324;
#P connect 86 0 64 0;
#P hidden connect 72 0 65 0;
#P hidden connect 73 0 66 0;
#P fasten 67 0 83 0 621 477 611 477 611 433 621 433;
#P connect 83 0 67 0;
