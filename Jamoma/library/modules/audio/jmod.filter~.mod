...
#P newex 205 444 294 196617 jmod.parameter $0_ filtergain @ramp_enable 1 @repetitions 0;
#P objectname jmod.parameter.mxb[3];
#P newex 205 368 255 196617 jmod.parameter $0_ q @ramp_enable 1 @repetitions 0;
#P objectname jmod.parameter.mxb[2];
#P newex 205 532 261 196617 jmod.parameter $0_ cf @ramp_enable 1 @repetitions 0;
