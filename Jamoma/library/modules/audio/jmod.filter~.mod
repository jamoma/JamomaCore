...
#P newex 81 128 81 196617 pattrstorage @autorestore 0 @savemode 0;
...
#B frgb 172 172 172;
#P newex 211 178 108 196617 poly~ jmod.filter~.alg;
...
#P newex 0 128 77 196617 jmod.hub $0_ jmod.filter~ @size 1U-half;
...
#P connect 20 0 32 1;
#P connect 18 0 32 2;
#P hidden fasten 13 0 1 2 216 205 438 205 438 -12 169 -12;
...
#P connect 28 0 18 0;
#P connect 26 1 18 0;
#P fasten 9 1 13 0 38 173 216 173;
#P hidden fasten 1 0 13 0 5 105 216 105;
#P lcolor 6;
#P hidden connect 34 0 12 5;
#P hidden connect 1 3 8 0;
#P fasten 13 1 1 3 314 202 429 202 429 -5 251 -5;
#P hidden fasten 1 1 13 1 87 102 314 102;
#P lcolor 6;
#P pop;
