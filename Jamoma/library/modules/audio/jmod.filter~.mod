...
#P newex 123 397 33 196617 atodb;
#P message 103 108 43 196617 autodoc;
#P window linecount 2;
#P message 47 668 65 196617 \; max refresh;
...
#P newex 46 613 124 196617 s $0_xxx_to_filtergraph;
...
#P connect 5 0 6 0;
#P pop;
#P newobj 46 589 124 196617 p PrepareForFiltergraph~;
#P flonum 113 19 40 9 30. 11025. 8227 3 198 198 198 221 221 221 222 222 222 0 0 0;
#P objectname CenterFreq;
#P newex 205 444 75 196617 pvar FilterGain;
#P newex 205 368 39 196617 pvar Q;
#P newex 205 527 83 196617 pvar CenterFreq;
#P newex 205 257 89 196617 pvar FilterType 2;
#P newex 51 343 93 196617 pvar FilterGraph 7;
#P window linecount 2;
#P message 47 638 72 196617 \; jmod.init bang;
...
#P window linecount 2;
#P newex 262 45 270 196617 jmod.message $0_ filtergraph @description "Messages to filtergraph. See the MSP reference for further details";
#P flonum 113 32 40 9 0. 100. 8227 3 198 198 198 221 221 221 222 222 222 0 0 0;
#P objectname Q;
#P window linecount 3;
#P newex 205 282 290 196617 jmod.parameter $0_ filtertype @type menu @description "What kind of filter to use. Possible values: lowpass | highpass | bandpass | bandstop | peaknotch | lowshelf | highshelf";
#P objectname jmod.parameter.mxb;
#P window linecount 2;
#P newex 205 468 373 196617 jmod.parameter $0_ filtergain @type msg_float @range -24 24 @clipmode both @ramp 1 @repetitions 0 @description "Gain (dB)";
#P objectname jmod.parameter.mxb[3];
#P newex 205 392 305 196617 jmod.parameter $0_ q @type msg_float @ramp 1 @range 0. 100. @clipmode both @repetitions 0 @description "Resonance (Q)";
#P objectname jmod.parameter.mxb[2];
#P newex 205 548 334 196617 jmod.parameter $0_ cf @type msg_float @range 30. 11025. @clipmode both @ramp 1 @repetitions 0 @description "Center frequency (Hz)";
...
#P newex 0 128 157 196617 jmod.hub $0_ jmod.filter~ @size 1U-half @module_type audio @num_inputs 2 @num_outputs 2 @description "Stereo 2nd order IIR filter based on biquad~";
...
#P window linecount 3;
#P comment 201 596 257 196617 Convertion from freq \, gain and q to biquad coeffisients has to take place inside the poly~ (.alg) in case the poly is up- or downsampled.;
#P hidden connect 7 0 1 0;
#P fasten 37 0 9 0 108 125 5 125;
#P connect 2 0 9 0;
#P connect 9 0 5 0;
#P connect 19 0 32 0;
#P connect 32 0 33 0;
...
#P connect 18 0 32 2;
#P connect 9 2 24 0;
#P hidden fasten 13 0 1 2 267 232 553 232 553 -12 169 -12;
...
#P hidden fasten 13 1 1 3 365 228 548 228 548 -5 251 -5;
#P fasten 9 1 13 0 78 199 267 199;
