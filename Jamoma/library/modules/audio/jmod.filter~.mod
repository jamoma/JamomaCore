...
#P newex 485 332 40 196617 t 1 s 0;
...
#P window linecount 2;
#P newex 205 505 373 196617 jmod.parameter $0_ filtergain @type msg_float @range -24 24 @clipmode both @ramp 1 @repetitions 0 @description "Gain (dB)";
#P objectname jmod.parameter.mxb[3];
#P newex 205 429 305 196617 jmod.parameter $0_ q @type msg_float @ramp 1 @range 0. 100. @clipmode both @repetitions 0 @description "Resonance (Q)";
#P objectname jmod.parameter.mxb[2];
#P newex 205 585 334 196617 jmod.parameter $0_ cf @type msg_float @range 30. 11025. @clipmode both @ramp 1 @repetitions 0 @description "Center frequency (Hz)";
...
#P connect 19 0 32 0;
#P connect 32 0 33 0;
#P fasten 39 1 26 0 505 364 56 364;
#P connect 26 1 38 0;
...
#P connect 26 3 38 2;
#P connect 24 0 0 1;
#P fasten 39 2 38 3 520 378 159 378;
#P lcolor 1;
#P fasten 39 0 38 3 490 378 159 378;
#P lcolor 1;
#P connect 18 0 32 2;
#P connect 0 2 24 0;
