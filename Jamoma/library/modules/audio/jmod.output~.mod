...
#P window linecount 2;
#P comment 10 693 258 196617 - record (filename): starts recording to the sound file specified;
...
#P hidden newex 101 291 45 196617 pcontrol;
#P hidden newex 101 268 84 196617 jmod.pass /open;
...
#P hidden newex 9 172 195 196617 jmod.hub.mxt $0_ jmod.output~ @size 2U @module_type audio @num_inputs 2 @num_outputs 0 @options no_panel @description "A generic module for stereo audio output. Includes saturation \\\, limiter and recording device";
...
#P hidden fasten 90 0 14 0 106 312 160 312;
