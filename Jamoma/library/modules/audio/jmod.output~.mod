...
#P hidden newex 9 172 175 196617 jmod.hub.mxt $0_ jmod.output~ $1 @size 2U @module_type audio @num_inputs 2 @num_outputs 0 @options no_panel @description "A generic module for stereo audio output. Includes saturation \\\, limiter and recording device";
