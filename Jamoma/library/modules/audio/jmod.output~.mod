max v2;
#N vpatcher 18 46 1230 844;
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#P comment 10 722 265 196617 - record 0: stops recording.;
#P window linecount 2;
#P comment 10 693 265 196617 - record (filename): starts recording to the sound file specified;
#P comment 10 663 265 196617 - record 1: starts recording to a previously specified sound file. If no sound file is psecified \, it's to bad...;
#P comment 10 633 265 196617 - open with no argument: bring up the open dialog??? (Or should we forget about this one?);
#P comment 10 604 265 196617 - open filename: open the soundfile specified \, but do not start recording;
#P window linecount 3;
#P comment 10 562 265 196617 - samptype and filetype can be set beforehand using messages "samptype $1" and "filetype $1" \, and is remembered.;
#P window linecount 2;
#P hidden newex 321 442 197 196617 jmod.message.mxt $0_ dsp_status @description " Open DSP Status window.";
#P window linecount 1;
#P hidden message 28 148 43 196617 autodoc;
#P hidden newex 90 291 45 196617 pcontrol;
#P hidden newex 90 268 75 196617 jmod.pass open;
...
#P hidden newex 443 685 155 196617 jmod.parameter.mxt $0_ record;
#P objectname jmod.parameter.mxt[12];
#P window linecount 7;
#P hidden newex 9 172 173 196617 jmod.hub.mxt $0_ jmod.output~ @size 2U @module_type audio @num_inputs 2 @num_outputs 0 @options no_panel @description "A generic module for stereo audio output. Includes saturation \\\, limiter and recording device.";
#P window linecount 1;
...
#P window linecount 2;
#P hidden newex 616 320 219 196617 jmod.parameter.mxt $0_ limiter @type toggle @description "Limiter: Active or bypassed.";
...
#P window setfont "Sans Serif" 9.;
#P window linecount 2;
#P hidden newex 616 596 305 196617 jmod.parameter.mxt $0_ limiter_shape @type menu @description "Limiter: Set the function to be used for calculating the scaling.";
#P objectname jmod.parameter.mxt[10];
#P hidden newex 616 554 362 196617 jmod.parameter.mxt $0_ limiter_threshold @ramp 1 @range -24 48 @clipmode none @type msg_float @description "Limiter: Set threshold as dB.";
#P objectname jmod.parameter.mxt[9];
#P hidden newex 616 513 355 196617 jmod.parameter.mxt $0_ limiter_release @ramp 1 @type msg_float @range 0 3000 @clipmode low @description "Limiter: Set release time as ms.";
#P objectname jmod.parameter.mxt[8];
#P hidden newex 616 456 386 196617 jmod.parameter.mxt $0_ limiter_lookahead @ramp 1 @range 0 256 @clipmode both @type msg_int @description "Limiter: The number of samples to look ahead.";
#P objectname jmod.parameter.mxt[7];
#P hidden newex 616 420 340 196617 jmod.parameter.mxt $0_ limiter_postamp @ramp 1 @range -24 48 @clipmode none @type msg_float @description "Limiter: Postamp as dB.";
#P objectname jmod.parameter.mxt[6];
#P hidden newex 616 380 375 196617 jmod.parameter.mxt $0_ limiter_preamp @ramp 1 @range 0 48 @clipmode none @type msg_float @ramp 1 @description "Limiter: Preamp as dB.";
...
#P window setfont "Sans Serif" 9.;
#P window linecount 2;
#P hidden newex 614 228 234 196617 jmod.parameter.mxt $0_ saturation @type toggle @description "Saturation: Active or bypassed.";
...
#P window linecount 2;
#P hidden newex 614 153 345 196617 jmod.parameter.mxt $0_ saturation_depth @ramp 1 @repetitions 0 @type msg_float @range 0 99 @clipmode both @description "Saturation: Depth.";
...
#P window linecount 2;
#P hidden newex 321 627 274 196617 jmod.parameter.mxt $0_ samptype @type menu @description "Recording: Set sample type for sound files.";
#P objectname jmod.parameter.mxt[3];
#P hidden newex 321 563 258 196617 jmod.parameter.mxt $0_ filetype @type menu @description "Recording: Set file type for sound files.";
#B color 2;
...
#P window linecount 2;
#P hidden newex 321 237 181 196617 jmod.parameter.gain.mxt $0_ gain @description "master gain";
#B color 2;
...
#B color 7;
#P window linecount 2;
#P hidden newex 321 364 242 196617 jmod.parameter.mxt $0_ ch_2 @type msg_int @description " Set logical output for right channel.";
#B color 2;
#P objectname jmod.parameter.mxt[1];
#P hidden newex 321 305 235 196617 jmod.parameter.mxt $0_ ch_1 @type msg_int @description " Set logical output for left channel.";
#B color 2;
...
#P inlet 230 55 15 0;
#P newex 230 135 214 196617 route dsp_status ch_1 ch_2;
...
#N vpatcher 122 300 1098 832;
#P origin 0 80;
#P window setfont "Sans Serif" 9.;
#P window linecount 3;
#P comment 549 282 265 196617 FROM REMOTE:;
#P window linecount 1;
...
#P window linecount 1;
#P newex 432 161 90 196617 prepend samptype;
#P window linecount 0;
#P newex 432 137 31 196617 sel 0;
#P newex 432 115 79 196617 route samptype;
...
#P comment 467 139 271 196617 <- required to avoid an error message during initialisation;
#P connect 6 0 1 0;
#P connect 11 0 1 0;
#P connect 3 0 1 0;
#P connect 8 0 1 0;
