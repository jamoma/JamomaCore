...
#P hidden newex 601 137 47 196617 pcontrol;
#P hidden newex 468 113 143 196617 jcom.algorithm_control~.mxt;
#P hidden inlet 514 66 15 0;
#P hidden inlet 380 66 15 0;
#P hidden newex 380 197 64 196617 jcom.out~ 2;
...
#P window linecount 1;
#P hidden newex 336 169 98 196617 jalg.limiter~.mxt;
#P hidden comment 409 68 113 196617 ----signal inputs----;
#P hidden outlet 9 168 15 0;
#P hidden outlet 407 223 15 0;
#P hidden comment 361 239 101 196617 ---signal outputs---;
...
#P hidden fasten 26 0 32 0 72 307 62 307 62 247 72 247;
#P hidden connect 32 0 26 0;
#P hidden fasten 27 0 33 0 72 371 63 371 63 314 72 314;
#P hidden connect 33 0 27 0;
#P hidden fasten 28 0 34 0 72 458 63 458 63 378 72 378;
#P hidden connect 34 0 28 0;
#P hidden fasten 29 0 35 0 72 531 63 531 63 463 72 463;
#P hidden connect 35 0 29 0;
#P hidden fasten 30 0 36 0 72 594 63 594 63 536 72 536;
#P hidden connect 36 0 30 0;
#P hidden fasten 31 0 37 0 72 666 63 666 63 601 72 601;
#P hidden connect 37 1 31 0;
#P lcolor 6;
#P hidden fasten 47 0 5 0 606 164 341 164;
#P hidden fasten 46 0 5 0 473 164 341 164;
#P hidden connect 44 0 42 0;
#P hidden connect 42 0 5 1;
#P hidden connect 5 1 43 0;
#P hidden connect 43 0 7 0;
#P hidden connect 43 1 2 0;
#P hidden connect 42 1 5 2;
#P hidden connect 5 2 43 1;
