...
#P message 105 115 125 196617 /documentation/generate;
...
#P connect 25 2 21 0;
#P fasten 1 0 33 0 182 358 171 358 171 281 182 281;
#P fasten 33 1 1 0 261 307 182 307;
...
#P hidden fasten 24 0 0 1 264 258 567 258 567 -8 250 -8;
#P hidden connect 0 1 3 0;
#P hidden fasten 0 0 24 0 5 95 264 95;
#P lcolor 6;
