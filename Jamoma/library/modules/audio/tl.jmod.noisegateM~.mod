...
#P connect 9 0 10 0;
#P pop;
#P newobj 400 283 58 196617 p visualize;
#P newex 400 305 67 196617 pvar ACTIVE;
...
#P newex 0 140 170 196617 jmod.hub $0_ jmod.noisgateM~ @size 1U-half @module_type audio @num_inputs 1 @num_outputs 1 @description "Mono noise gate.";
...
#B frgb 172 172 172;
#P newex 265 221 145 196617 poly~ tl.jmod.noisegateM~.alg;
