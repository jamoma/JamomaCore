...
#P hidden newex 750 434 352 196617 jcom.parameter limiter/threshold @ramp linear.sched @range -24 48 @clipmode none @type msg_float @description "Limiter: Set threshold as dB.";
#P objectname limiter/threshold;
#P hidden newex 750 393 337 196617 jcom.parameter limiter/release @ramp linear.sched @type msg_float @range 0 3000 @clipmode low @description "Limiter: Set release time as ms.";
#P objectname limiter/release;
#P hidden newex 750 330 374 196617 jcom.parameter limiter/lookahead @ramp linear.sched @range 0 256 @clipmode both @type msg_int @description "Limiter: The number of samples to look ahead.";
