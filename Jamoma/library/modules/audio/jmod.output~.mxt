...
#P hidden newex 161 195 57 196617 jcom.out~ 0;
#P window linecount 1;
#P hidden newex 134 165 53 196617 jcom.in~ 2;
#P window linecount 2;
...
#P window setfont "Sans Serif" 9.;
#P window linecount 2;
#P hidden newex 750 476 309 196617 jcom.parameter limiter/mode @type msg_menu @description "Limiter: Set the function to be used for calculating the scaling.";
...
#P window linecount 2;
#P hidden newex 346 317 279 196617 jcom.parameter record/samptype @type msg_menu @description "Recording: Set sample type for sound files.";
#P objectname record/samptype;
#P hidden newex 346 253 267 196617 jcom.parameter record/filetype @type msg_menu @description "Recording: Set file type for sound files.";
#B color 2;
...
#P hidden inlet 177 146 15 0;
#P hidden inlet 134 146 15 0;
...
#P connect 11 3 0 2;
#P pop;
#P hidden newobj 91 263 95 196617 p Sound_processing;
...
#P window linecount 1;
#P hidden comment 137 129 77 196617 -- audio in --;
...
#P hidden fasten 10 0 66 0 96 291 266 291 266 22 40 22;
#P hidden fasten 10 1 65 0 181 286 261 286 261 35 40 35;
...
#P hidden fasten 80 0 10 0 32 259 96 259;
#P hidden connect 90 0 10 1;
#P hidden connect 34 0 90 0;
#P hidden fasten 90 1 10 2 153 223 180 223;
