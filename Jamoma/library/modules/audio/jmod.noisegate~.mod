...
#P connect 9 0 10 0;
#P pop;
#P newobj 391 283 58 196617 p visualize;
#P newex 391 305 67 196617 pvar ACTIVE;
...
#P newex 0 140 170 196617 jmod.hub $0_ jmod.noisgate~ @size 1U-half @module_type audio @num_inputs 2 @num_outputs 2 @description "Mono noise gate.";
...
#B frgb 172 172 172;
#P newex 265 221 137 196617 poly~ tl.jmod.noisegate~.alg;
...
#P fasten 4 2 2 0 396 261 5 261;
#P connect 15 0 2 0;
#P connect 38 0 1 1;
#P connect 11 0 15 1;
...
#P connect 15 2 11 0;
#P hidden fasten 4 1 1 3 333 245 418 245 418 -4 248 -4;
...
#P connect 4 2 21 0;
#P connect 21 0 20 0;
#P hidden fasten 1 1 4 1 86 98 397 98;
