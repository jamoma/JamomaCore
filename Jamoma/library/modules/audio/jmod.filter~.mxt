...
#P hidden newex 396 671 107 196617 jcom.out~ 2;
#P hidden newex 396 595 87 196617 jcom.in~ 2;
...
#P objectname filtertype;
#P hidden newex 182 363 330 196617 jcom.parameter filtergain @type msg_float @range -24 24 @clipmode both @ramp linear @repetitions 0 @description "Gain (dB)";
#P objectname filtergain;
#P hidden newex 182 287 311 196617 jcom.parameter q @type msg_float @ramp linear @range 0. 100. @clipmode both @repetitions 0 @description "Resonance (Q)";
#P objectname q;
#P hidden newex 182 443 341 196617 jcom.parameter cf @type msg_float @range 30. 11025. @clipmode both @ramp linear @repetitions 0 @description "Center frequency (Hz)";
#P objectname cf;
#P window linecount 1;
...
#B frgb 172 172 172;
#P hidden newex 396 645 108 196617 poly~ jalg.filter~.mxt;
...
#P hidden connect 39 2 13 0;
#P hidden connect 39 0 13 0;
#P hidden connect 13 0 40 0;
#P hidden connect 40 0 4 0;
#P hidden connect 40 1 9 0;
#P hidden connect 5 0 39 1;
#P hidden connect 13 1 40 1;
#P hidden fasten 39 1 13 1 426 640 499 640;
#P pop;
