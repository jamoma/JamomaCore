...
#P objectname filtertype;
#P hidden newex 182 363 330 196617 jcom.parameter filtergain @type msg_float @range -24 24 @clipmode both @ramp linear.sched @repetitions 0 @description "Gain (dB)";
#P objectname filtergain;
#P hidden newex 182 287 311 196617 jcom.parameter q @type msg_float @ramp linear.sched @range 0. 100. @clipmode both @repetitions 0 @description "Resonance (Q)";
#P objectname q;
#P hidden newex 182 443 341 196617 jcom.parameter cf @type msg_float @range 30. 11025. @clipmode both @ramp linear.sched @repetitions 0 @description "Center frequency (Hz)";
#P objectname cf;
#P window linecount 1;
