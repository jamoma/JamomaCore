...
#P hidden newex 143 227 84 9109513 jmod.pass open;
#P hidden newex 143 252 47 9109513 pcontrol;
...
#P hidden message 73 414 65 9109513 \; max refresh;
#P window linecount 1;
#P hidden newex 268 38 62 9109513 pvar Offset;
#P window linecount 3;
#P hidden newex 0 140 297 9109513 jmod.hub $0_ jmod.sur.multi.out~ @size 1U-half @module_type audio.no_panel @num_inputs 1 @num_outputs 16 @description "Pack up to 16 mono signals onto a multi cable.";
#P objectname jmod.hub;
#P window linecount 1;
#P hidden comment 14 121 79 9109513 command input;
#P hidden inlet 0 121 13 0;
#P window linecount 2;
#P hidden message 73 382 72 9109513 \; jmod.init bang;
#P window linecount 3;
#P hidden newex 304 140 79 9109513 pattrstorage @autorestore 0 @savemode 0;
#X client_rect 0 0 640 240;
#X storage_rect 0 0 640 240;
#P objectname u393000003;
#P hidden inlet 484 153 13 0;
#P hidden outlet 255 360 13 0;
#P hidden newex 268 63 330 9109513 jmod.parameter.mxt $0_ /channel_offset @type msg_int @repetitions 1 @range -31 31 @clipmode both @ramp 0 @description "Set channel offset for signals. Only take effect the next time audio is started.";
#P objectname jmod.parameter;
#P number 93 26 35 9 -31 31 8227 139 198 198 198 221 221 221 222 222 222 0 0 0;
#P objectname Offset;
#P window linecount 1;
#P comment 16 27 74 9109513 Channel offset;
#B frgb 172 172 172;
#P hidden comment 421 135 169 9109513 --- multi channel signal input ---;
#P hidden outlet 0 229 13 0;
#P hidden comment 252 388 167 9109513 --- signal outputs ---;
#P hidden newex 255 306 239 9109513 jmod.sur.multi.out~.alg;
