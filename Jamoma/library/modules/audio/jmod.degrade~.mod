...
#P window linecount 1;
#P hidden newex 261 18 285 196617 jmod.parameter.mxt $0_ sr_ratio @type msg_float @ramp 1;
#P objectname jmod.parameter;
#P hidden newex 261 39 345 196617 jmod.parameter.mxt $0_ bitdepth @type msg_int @ramp 1 @repetitions 0;
...
#P hidden fasten 5 0 1 2 270 242 668 242 668 -17 169 -17;
#P hidden connect 1 2 13 0;
#P hidden fasten 5 1 1 3 380 231 660 231 660 -9 251 -9;
