...
#P hidden message 140 121 43 196617 autodoc;
...
#P window linecount 2;
#P hidden newex 278 4 394 196617 jmod.parameter.mxt $0_ sr_ratio @type msg_float @range 0. 1. @clipmode both @ramp 1 @description A ratio of the emulated sample-rate to the global sample-rate.;
#P objectname jmod.parameter;
#P window linecount 3;
#P hidden newex 278 37 338 196617 jmod.parameter.mxt $0_ bitdepth @type msg_int @range 1 24 @clipmode both @ramp 1 @repetitions 0 @description The number of bits that will be retained in each sample - use this for bit crunching effects.;
