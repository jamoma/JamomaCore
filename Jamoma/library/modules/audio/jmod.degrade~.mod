...
#P hidden message 140 121 125 196617 /documentation/generate;
...
#P hidden fasten 5 0 0 2 270 242 684 242 684 -17 169 -17;
#P hidden connect 0 2 13 0;
#P hidden connect 15 0 19 1;
#P hidden fasten 5 1 0 3 380 231 674 231 674 -9 251 -9;
