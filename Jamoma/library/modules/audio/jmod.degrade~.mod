...
#P hidden newex 0 138 143 196617 jmod.hub $0_ jmod.degrade~ @size 1U-half @module_type audio @num_inputs 2 @num_outputs 2;
...
#P hidden newex 150 144 79 196617 pattrstorage @autorestore 0 @savemode 0;
...
#B frgb 172 172 172;
#P hidden newex 265 205 120 196617 poly~ jmod.degrade~.alg;
#P hidden comment 15 -32 105 196617 ----signal inputs----;
#P hidden outlet 0 202 13 0;
...
#P hidden fasten 5 1 1 3 380 229 561 229 561 -11 251 -11;
#P hidden connect 1 3 2 0;
#P hidden connect 12 0 11 0;
#P hidden connect 7 0 10 0;
#P hidden fasten 19 1 5 0 71 197 270 197;
#P hidden fasten 1 0 5 0 5 99 270 99;
#P lcolor 6;
#P hidden fasten 1 1 5 1 87 96 380 96;
#P lcolor 6;
#P pop;
