...
#P hidden newex 0 140 249 196617 jmod.hub $0_ jmod.degrade~ @size 1U-half @module_type audio @num_inputs 2 @num_outputs 2 @description Emulate the use of lower sample-rates and bit-resolution;
