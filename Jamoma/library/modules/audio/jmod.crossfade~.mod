...
#P hidden newex 0 152 399 196617 jmod.hub $0_ jmod.crossfade~ @size 1U-half @module_type audio @num_inputs 4 @num_outputs 2 @description "Allows crossfades between 2 stereo sources. The first two inputs are the first source while the second 2 inputs are the second source";
