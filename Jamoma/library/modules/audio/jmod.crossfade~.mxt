...
#P hidden newex 74 112 355 9109513 jcom.parameter mode @type msg_menu @description "choose the calculation mode for the crossfade: fast uses a lookup table while precisision performs trig calculations";
#P objectname jcom.parameter.mxb[2];
#P hidden newex 74 78 253 9109513 jcom.parameter shape @type msg_menu @description "Choose the shape of the crossfade: linear or equal-power";
