...
#P hidden message 107 158 125 196617 /documentation/generate;
...
#P hidden newex 4 180 272 196617 jmod.hub $0_ jmod.degradeM~ @size 1U-half @module_type audio @num_inputs 1 @num_outputs 1 @description "Emulate the use of lower sample-rates and bit-resolution";
...
#P lcolor 6;
#P hidden fasten 21 0 11 0 112 176 9 176;
#P hidden connect 2 0 11 0;
#P hidden connect 11 0 4 0;
#P hidden fasten 13 0 18 0 24 353 11 353 11 293 24 293;
#P hidden connect 18 0 13 0;
#P hidden fasten 12 0 19 0 24 446 11 446 11 373 24 373;
#P hidden connect 19 0 12 0;
#P hidden fasten 6 0 0 1 354 287 453 287 453 -7 251 -7;
#P hidden connect 0 1 3 0;
#P hidden connect 1 0 11 1;
#P hidden connect 11 2 1 0;
#P hidden fasten 0 0 6 0 5 134 354 134;
#P lcolor 6;
#P hidden fasten 11 1 6 0 145 246 354 246;
#P pop;
