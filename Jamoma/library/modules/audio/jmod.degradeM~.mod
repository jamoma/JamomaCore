...
#P hidden newex 264 182 79 196617 pattrstorage @autorestore 0 @savemode 0;
...
#P window linecount 2;
#P hidden newex 19 320 394 196617 jmod.parameter.mxt $0_ sr_ratio @type msg_float @range 0. 1. @clipmode both @ramp 1 @description A ratio of the emulated sample-rate to the global sample-rate.;
#P objectname jmod.parameter.mxb[1];
#P window linecount 3;
#P hidden newex 19 401 338 196617 jmod.parameter.mxt $0_ bitdepth @type msg_int @range 1 24 @clipmode both @ramp 1 @repetitions 0 @description The number of bits that will be retained in each sample - use this for bit crunching effects.;
#P objectname jmod.parameter.mxb;
#P window linecount 4;
#P hidden newex 4 180 255 196617 jmod.hub $0_ jmod.degradeM~ @size 1U-half @module_type audio @num_inputs 1 @num_outputs 1 @description Emulate the use of lower sample-rates and bit-resolution;
...
#P hidden fasten 10 1 5 0 131 246 354 246;
