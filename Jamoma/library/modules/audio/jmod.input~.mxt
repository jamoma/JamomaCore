...
#P hidden flonum 576 277 35 9 0 0 0 3 0 0 0 221 221 221 222 222 222 0 0 0;
#P hidden flonum 371 276 35 9 0 0 0 3 0 0 0 221 221 221 222 222 222 0 0 0;
...
#P window linecount 1;
#P hidden newex 66 390 71 196617 jcom.out~ 2;
#P hidden newex 65 281 57 196617 jcom.in~;
#P hidden message 30 148 125 196617 /documentation/generate;
#P hidden newex 65 333 45 196617 pcontrol;
#P hidden newex 65 307 78 196617 jcom.pass open;
#P hidden newex 286 568 317 196617 jcom.message dsp_status @description "Open DSP Status window.";
#P window linecount 3;
#P hidden newex 9 175 212 196617 jcom.hub jmod.input~ @size 2U-half @module_type audio.no_panel @description "A generic modul for audio input";
...
#B color 7;
#P hidden newex 286 84 458 196617 jcom.parameter link @type msg_toggle @description "Link gain levels for left and right channels.";
#B color 2;
#P objectname link;
...
#P user jsui 195 47 45 19 1 0 0 jcom.jsui_texttoggle.js Play Play 204 204 204 0 0 0 121 255 15;
...
#P hidden toggle 203 501 15 0;
#P hidden message 165 501 35 196617 1 100;
#P hidden message 126 501 35 196617 0 100;
#P window linecount 2;
#P hidden message 36 508 69 196617 \; max refresh;
#P window linecount 1;
#P hidden message 158 148 37 196617 /init;
#P hidden newex 126 525 84 196617 s jcom.dsptoggle;
#P window setfont "Sans Serif" 12.;
...
#P hidden newex 154 399 94 196617 pvar Time_Display;
#N vpatcher 313 99 1253 837;
#P origin -88 15;
#P window setfont "Sans Serif" 9.;
...
#P window linecount 0;
#P newex 95 92 146 196617 jcom.oscroute /source_select;
...
#P window linecount 1;
#N vpatcher 105 363 836 748;
#P window setfont "Sans Serif" 9.;
#P newex 429 299 29 196617 gate;
#P newex 429 124 31 196617 == 2;
#P inlet 429 30 15 0;
#P newex 429 322 242 196617 jcom.return /sf_report @description "Report when sound file reach end point and loop to start point.";
...
#P newex 140 119 55 196617 r jcom.init;
#N vpatcher 191 93 619 557;
#P window setfont "Sans Serif" 9.;
#P newex 237 275 55 196617 r jcom.init;
...
#P connect 22 0 1 0;
#P pop;
#P hidden newobj 65 362 104 196617 p Sound_sources;
...
#B color 7;
#P window linecount 2;
#P hidden newex 727 156 401 196617 jcom.message sf_open @type msg_symbol @description "Open sound file specified by filename. Without a filename a standard open file dialog allows you to choose a file.";
#B color 2;
...
#P window linecount 1;
#P hidden newex 727 65 456 196617 jcom.parameter source_select @type msg_menu @description "Select what audio source to use.";
#B color 2;
#P objectname source_select;
#P window linecount 2;
#P hidden newex 727 377 377 196617 jcom.message direct @description container for various messages sent directly to the sfplay~ object. Refer to the MSP documentation for further details.;
#B color 2;
#P objectname jcom.parameter.mxb[9];
#P window linecount 1;
#P hidden newex 727 232 255 196617 jcom.parameter play @description "Play sound file.";
#B color 2;
#P objectname play;
#P hidden newex 727 318 335 196617 jcom.parameter loop @type msg_toggle @description "Loop soundfile.";
#B color 2;
#P objectname loop;
#P hidden comment 52 437 101 196617 ---signal outputs---;
#N comlet (signal) Right Channel;
#P hidden outlet 90 420 15 0;
#P hidden outlet 9 227 15 0;
#N comlet (signal) Left Channel;
#P hidden outlet 67 420 15 0;
...
#P hidden fasten 70 0 66 0 35 168 14 168;
#P hidden connect 6 0 66 0;
#P hidden connect 66 0 8 0;
#P hidden connect 75 0 78 0;
#P hidden connect 77 0 78 0;
#P hidden connect 80 0 78 0;
#P hidden connect 88 0 51 0;
#P hidden connect 22 0 65 0;
#P hidden connect 22 1 64 0;
#P hidden connect 71 0 68 0;
#P hidden connect 68 0 69 0;
#P hidden connect 69 0 22 0;
#P hidden fasten 68 1 22 0 138 356 70 356;
#P hidden connect 22 0 72 0;
#P hidden connect 72 0 7 0;
#P hidden connect 72 1 9 0;
#P hidden fasten 36 0 33 0 131 520 131 520;
#P hidden fasten 37 0 33 0 170 520 131 520;
#P hidden fasten 38 0 33 0 208 520 131 520;
#P hidden connect 22 1 72 1;
#P hidden fasten 22 2 23 0 164 389 159 389;
#P hidden fasten 54 0 55 0 291 115 280 115 280 57 291 57;
#P hidden connect 55 0 54 0;
#P hidden fasten 54 1 56 0 483 110 291 110;
#P hidden connect 51 0 86 0;
#P hidden connect 86 0 87 0;
#P hidden connect 87 0 88 0;
#P hidden fasten 44 0 42 0 291 472 281 472 281 417 291 417;
#P hidden connect 42 0 44 0;
#P hidden fasten 45 0 43 0 291 534 281 534 281 479 291 479;
#P hidden connect 43 0 45 0;
#P hidden connect 46 0 67 0;
#P hidden connect 59 0 61 0;
#P hidden connect 78 0 83 0;
#P hidden connect 83 0 52 0;
#P hidden connect 52 0 73 0;
#P hidden connect 73 0 79 0;
#P hidden connect 79 0 81 0;
#P hidden connect 81 0 77 0;
#P hidden connect 55 0 58 0;
#P hidden connect 81 0 84 0;
#P hidden connect 44 0 63 0;
#P hidden connect 45 0 62 0;
#P hidden connect 83 1 50 0;
#P hidden connect 50 0 74 0;
#P hidden connect 74 0 76 0;
#P hidden connect 76 0 82 0;
#P hidden connect 82 0 80 0;
#P hidden connect 82 0 85 0;
#P hidden fasten 18 0 14 0 732 116 721 116 721 62 732 62;
#P hidden connect 14 0 18 0;
#P hidden connect 21 0 17 0;
#P hidden fasten 19 0 12 0 732 276 723 276 723 228 732 228;
#P hidden connect 53 0 12 0;
#P hidden connect 12 0 19 0;
#P hidden fasten 20 0 11 0 732 360 724 360 724 314 732 314;
