...
#P hidden newex 9 175 204 196617 jcom.hub jmod.input~ @size 2U-half @module_type audio.no_panel @description "A generic module for audio input";
...
#B color 14;
#P hidden user led 338 59 17 17 1 150;
...
#P hidden newex 727 65 291 196617 jcom.parameter source_select @type msg_menu @description "Select what audio source to use.";
#B color 2;
...
#P hidden fasten 54 0 55 0 291 113 280 113 280 55 291 55;
#P hidden connect 55 0 54 0;
#P hidden fasten 54 1 56 0 410 120 291 120;
