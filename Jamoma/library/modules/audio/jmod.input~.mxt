max v2;
#N vpatcher 33 99 1192 796;
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#P hidden newex 727 155 75 196617 t no_argument;
#B color 14;
...
#P hidden user led 816 363 17 17 1 150;
#P hidden user led 816 279 17 17 1 150;
...
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#P hidden comment 152 184 213 196617 temporary fix to get the open button working;
#B color 14;
#P window linecount 0;
#P newex 65 182 84 196617 sel no_argument;
#B color 14;
#P newex 237 310 55 196617 r jcom.init;
#P newex 237 359 39 196617 t clear;
#P newex 159 384 98 196617 s $0_xxx_filename;
#P newex 159 358 75 196617 prepend append;
#P newex 159 312 50 196617 strippath;
#P outlet 65 347 15 0;
#P inlet 65 144 15 0;
#P newex 65 320 65 196617 prepend open;
#P newex 65 277 83 196617 opendialog sound;
#P newex 65 240 104 196617 sel bang;
...
#B color 7;
#P window linecount 2;
#P hidden newex 727 176 394 196617 jcom.message sf_open @type msg_symbol @description "Open sound file specified by filename. Without a filename a standard open file dialog allows you to choose a file.";
#B color 2;
...
#P window linecount 1;
#P hidden comment 806 157 213 196617 temporary fix to get the open button working;
#B color 14;
#P hidden connect 58 0 76 0;
#P hidden connect 7 0 67 0;
#P hidden fasten 71 0 67 0 35 168 14 168;
#P hidden fasten 35 0 67 0 163 171 14 171;
#P hidden connect 67 0 9 0;
#P hidden connect 76 0 79 0;
#P hidden connect 78 0 79 0;
#P hidden connect 81 0 79 0;
#P hidden connect 89 0 52 0;
#P hidden connect 23 0 66 0;
#P hidden connect 23 1 65 0;
#P hidden connect 72 0 69 0;
#P hidden connect 69 0 70 0;
#P hidden connect 70 0 23 0;
#P hidden fasten 69 1 23 0 138 356 70 356;
#P hidden connect 23 0 73 0;
#P hidden connect 73 0 8 0;
#P hidden connect 73 1 10 0;
#P hidden fasten 37 0 34 0 131 520 131 520;
#P hidden fasten 38 0 34 0 170 520 131 520;
#P hidden fasten 39 0 34 0 208 520 131 520;
#P hidden connect 23 1 73 1;
#P hidden fasten 23 2 24 0 164 389 159 389;
#P hidden fasten 55 0 56 0 291 113 280 113 280 55 291 55;
#P hidden connect 56 0 55 0;
#P hidden fasten 55 1 57 0 410 120 291 120;
#P hidden connect 52 0 87 0;
#P hidden connect 87 0 88 0;
#P hidden connect 88 0 89 0;
#P hidden fasten 45 0 43 0 291 472 281 472 281 417 291 417;
#P hidden connect 43 0 45 0;
#P hidden fasten 46 0 44 0 291 534 281 534 281 479 291 479;
#P hidden connect 44 0 46 0;
#P hidden connect 47 0 68 0;
#P hidden connect 60 0 62 0;
#P hidden connect 79 0 84 0;
#P hidden connect 84 0 53 0;
#P hidden connect 53 0 74 0;
#P hidden connect 74 0 80 0;
#P hidden connect 80 0 82 0;
#P hidden connect 82 0 78 0;
#P hidden connect 56 0 59 0;
#P hidden connect 82 0 85 0;
#P hidden connect 45 0 64 0;
#P hidden connect 46 0 63 0;
#P hidden connect 84 1 51 0;
...
#P hidden fasten 19 0 15 0 732 116 721 116 721 62 732 62;
#P hidden connect 15 0 19 0;
#P hidden connect 22 0 90 0;
#P hidden connect 90 0 18 0;
#P hidden fasten 20 0 13 0 732 300 723 300 723 252 732 252;
#P hidden connect 54 0 13 0;
#P hidden connect 13 0 20 0;
#P hidden fasten 21 0 12 0 732 384 724 384 724 338 732 338;
