...
#P hidden newex 1 109 194 196617 jmod.hub $0_ jmod.edge% $1 @size 1U-half @module_type video @library_type jitter @num_inputs 1 @num_outputs 1 @description "Glowing Edges Effect";
