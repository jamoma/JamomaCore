...
#P hidden newex 204 99 79 196617 pattrstorage @autorestore 0 @savemode 0;
...
#P hidden newex 0 109 194 196617 jmod.hub $0_ jmod.edge% @size 1U-half @library_type jitter;
