max v2;
#N vpatcher 31 97 636 825;
#P origin 0 -1024;
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#P hidden newex 19 669 355 196617 jmod.parameter $0_ /color @type toggle @description "Color or greyscale";
#P objectname jmod.parameter.mxt[6];
#P hidden newex 19 649 57 196617 pvar color;
...
#P hidden fasten 42 0 41 0 24 694 14 694 14 644 24 644;
