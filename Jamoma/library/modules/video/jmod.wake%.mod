...
#P hidden newex 351 59 251 196617 jmod.parameter $0_ bleed @type msg_float @ramp 1;
#P objectname jmod.parameter.mxb[4];
#P hidden newex 351 81 245 196617 jmod.parameter $0_ gain @type msg_float @ramp 1;
...
#P hidden newex 351 113 284 196617 jmod.parameter $0_ feedforward @type msg_float @ramp 1;
#P objectname jmod.parameter.mxb[2];
#P hidden newex 351 135 265 196617 jmod.parameter $0_ feedback @type msg_float @ramp 1;
...
#P window linecount 3;
#P hidden newex 0 109 206 196617 jmod.hub $0_ jmod.wake% @size 1U-half @module_type video @library_type jitter @num_inputs 1 @num_outputs 1;
