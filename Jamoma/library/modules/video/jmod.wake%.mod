...
#P hidden newex 0 109 250 196617 jmod.hub $0_ jmod.wake% @size 1U-half @module_type video @algorithm_type jitter @num_inputs 1 @num_outputs 1 @description "Video feedback with convolution for trippy effects";
...
#P hidden fasten 2 0 0 0 125 231 330 231 330 -18 5 -18;
