...
#P hidden newex 0 109 250 196617 jmod.hub $0_ jmod.wake% $1 @size 1U-half @module_type video @library_type jitter @num_inputs 1 @num_outputs 1 @description "Video feedback with convolution for trippy effects";
