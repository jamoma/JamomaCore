...
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#P newex 50 50 82 196617 jmod.wake%.alg;
#P inlet 122 30 15 0;
#P inlet 50 30 15 0;
#P outlet 50 72 15 0;
#P connect 1 0 3 0;
...
#P connect 2 0 3 1;
#P pop;
#P newobj 120 190 60 196617 p;
#P hidden message 103 87 50 196617 /autodoc;
#B color 3;
#P window linecount 2;
#P hidden newex 9 250 277 196617 jmod.message $0_ /jit.wake @description "Send messages directly to the internal jit.wake object from Jitter";
...
#P window linecount 1;
#P hidden comment 135 217 75 196617 VIDEO OUTPUT;
#P hidden outlet 120 217 13 0;
#P hidden inlet 192 169 13 0;
#P hidden comment 207 169 65 196617 VIDEO INPUT;
#P window linecount 2;
...
#P hidden fasten 27 0 4 0 108 105 5 105;
