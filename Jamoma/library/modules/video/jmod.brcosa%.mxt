...
#P window linecount 2;
#P hidden newex 25 475 364 196617 jcom.parameter saturation @type msg_float @ramp 1 @repetitions 0 @range 0. 4. @clipmode none @description "Saturation of image - 1 is default";
#P objectname saturation[1];
#P flonum 56 41 35 9 0 0 8224 3 255 255 255 221 221 221 222 222 222 0 0 0;
#P objectname saturation;
#P flonum 143 22 35 9 0 0 8224 3 255 255 255 221 221 221 222 222 222 0 0 0;
#P objectname contrast;
#P flonum 56 22 35 9 0. 0 8225 3 255 255 255 221 221 221 222 222 222 0 0 0;
...
#B color 3;
#P window linecount 2;
#P hidden newex 24 393 356 196617 jcom.parameter contrast @type msg_float @ramp 1 @repetitions 0 @range 0. 4. @clipmode none @description "Contrast of image - 1 is default";
#P objectname contrast[1];
#P hidden newex 24 313 365 196617 jcom.parameter brightness @type msg_float @ramp 1 @repetitions 0 @range 0. 4. @clipmode none @description "Brightness of image - 1 is default";
