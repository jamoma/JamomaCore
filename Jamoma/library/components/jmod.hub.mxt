...
#P connect 2 0 0 0;
#P pop;
#P newobj 550 357 95 196617 p provide_feedback;
#P newex 230 401 134 196617 r $1_message;
#P window linecount 2;
...
#P newex 511 167 45 196617 sel bang;
#P newex 332 167 45 196617 sel bang;
...
#P connect 22 1 23 0;
#P pop;
#P newobj 311 238 53 196617 p settings;
#P newex 367 190 105 196617 prepend load_settings;
#P newex 332 83 302 196617 jmod.message.mxt $1 load_settings @type msg_symbol @range n/a @description "open an xml-preset file and recall the first preset in that file.  An optional argument defines the file to open";
#P newex 546 190 110 196617 prepend save_settings;
#P newex 511 133 381 196617 jmod.message.mxt $1 save_settings @type msg_symbol @range n/a @description "write an xml-preset file to disk.  An optional argument defines the file to open";
...
#P connect 14 1 9 0;
#P pop;
#P newobj 480 335 165 196617 p preset_handling_to_pattrstorage;
