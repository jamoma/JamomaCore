max v2;
#N vpatcher 116 94 1141 739;
#P origin 116 0;
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#P newex 764 180 20 196617 t b;
#P window linecount 2;
#P newex 648 142 294 196617 jmod.parameter $1 /ui/refresh @type msg_bang @description "Update displayed values for module to reflect current state.";
#P objectname jmod.parameter[2];
#P window linecount 1;
#P newex 764 201 119 196617 send $1_display_update;
...
#P newex 774 300 126 196617 send $1_freeze_display;
#P toggle 774 282 15 0;
#P window linecount 3;
#P newex 648 231 314 196617 jmod.parameter $1 /disable_ui_updates @type toggle @description "Turn off the updating of user interface elements when parameters change.  This may be done to conserve CPU resources.";
...
#P window linecount 2;
#P message 764 83 130 196617 \; max htmlref $2;
#P window linecount 1;
#P newex 35 33 90 196617 r $1_FROM_MGUI;
#P window linecount 2;
#P newex 648 44 253 196617 jmod.message.mxt $1 /help @range n/a @description "Open the online html reference for this module.";
#P window linecount 1;
...
#P fasten 34 0 11 0 138 54 16 54;
#P connect 7 0 11 0;
...
#P connect 4 0 36 0;
#P connect 11 0 36 0;
#P fasten 22 0 36 0 181 150 16 150;
#P connect 36 0 8 0;
#P connect 36 0 35 0;
#P fasten 21 1 39 0 317 256 49 256;
#P connect 39 0 40 0;
#P connect 38 0 41 0;
#P connect 40 0 41 0;
#P connect 39 1 38 0;
...
#P connect 11 2 19 0;
#P connect 11 3 22 0;
#P fasten 21 1 5 0 317 258 219 258;
#P connect 20 0 12 0;
#P connect 5 0 12 0;
#P connect 11 4 2 0;
#P connect 2 0 10 0;
...
#P connect 6 0 14 0;
#P connect 3 0 14 0;
#P fasten 16 1 18 0 896 79 769 79;
#P fasten 45 1 46 0 937 177 769 177;
#P connect 46 0 44 0;
#P fasten 23 1 24 0 957 277 779 277;
#P fasten 24 0 25 0 779 296 779 296;
#P connect 33 0 32 0;
#P fasten 27 1 30 0 965 393 834 393;
#P connect 30 0 31 0;
#P fasten 29 0 28 0 883 438 834 438;
#P connect 31 0 28 0;
#P connect 30 1 29 0;
#P pop;
