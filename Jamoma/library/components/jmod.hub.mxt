max v2;
#N vpatcher 26 173 1023 701;
#P origin 116 0;
#P window setfont "Sans Serif" 9.;
#P newex 26 336 76 196617 r $1_feedback;
...
#N vpatcher 139 91 818 349;
#P window setfont "Sans Serif" 9.;
#P newex 452 29 118 196617 r jmod.remote.state.get;
#P window linecount 1;
#P newex 452 85 133 196617 s jmod.remote.state.return;
#P window linecount 0;
#P newex 34 57 223 196617 jmod.route @searchstring "0" @partialmatch 1;
#P window linecount 1;
#P newex 140 100 90 196617 jmod.oscroute $3;
...
#P connect 2 1 3 0;
#P pop;
#P newobj 452 57 64 196617 p dumpState;
#N comlet connect to left inlet of module;
#P outlet 140 167 15 0;
#P window linecount 0;
#P newex 34 29 118 196617 r jmod.remote.toModule;
#P comment 238 94 150 196617 If no argument providing a OSC name has been provided to the module \, it will not be listening.;
#P connect 1 0 5 0;
#P connect 5 1 4 0;
#P connect 4 0 2 0;
#P connect 7 0 3 0;
...
#P window linecount 2;
#P newex 125 219 267 196617 patcherargs @size 1U @library_type poly @module_type audio @skin default @description "No info provided.";
#P window linecount 1;
...
#N vpatcher 212 377 961 707;
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#P newex 68 121 29 196617 t l 0;
#P window linecount 0;
#P newex 87 193 47 196617 gate 1 1;
#N vpatcher 44 74 644 474;
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#P newex 65 218 107 196617 sprintf %s (unnamed);
#P newex 148 118 115 196617 loadmess substitute " ";
#P newex 65 190 65 196617 regexp .mod;
#P newex 65 153 69 196617 regexp jmod.;
#P inlet 65 81 15 0;
#P outlet 65 240 15 0;
#P window linecount 0;
#P comment 63 31 378 196617 If no third argument is given \, module name is used \, but jmod. and .mod is stripped;
#P fasten 5 0 3 0 153 145 70 145;
#P connect 2 0 3 0;
#P fasten 5 0 4 0 153 180 70 180;
#P fasten 3 3 4 0 127 180 70 180;
#P connect 3 0 4 0;
#P connect 4 0 6 0;
#P fasten 4 3 6 0 124 213 70 213;
#P connect 6 0 1 0;
#P pop;
#P newobj 347 153 76 196617 p no_argument;
#P window linecount 1;
#P newex 347 67 58 196617 r jmod.init;
#P window linecount 0;
#P message 347 136 21 196617 $2;
#P newex 347 113 297 196617 sel 0;
#P newex 347 90 137 196617 loadmess $3;
#P inlet 68 92 15 0;
#P window linecount 1;
#P newex 68 247 114 196617 prepend MODULE_TITLE;
#P newex 68 269 93 196617 s $1_FROM_MHUB;
#P window linecount 0;
#P comment 67 47 210 196617 set title of module in top bar of gui;
#P comment 98 115 153 196617 if a name is defined in another way \, it overrides this old argument way of doing things;
#P connect 4 0 11 0;
#P connect 11 0 3 0;
#P connect 10 0 3 0;
#P connect 3 0 2 0;
#P connect 11 1 10 0;
#P fasten 6 1 10 1 639 182 129 182;
#P fasten 9 0 10 1 352 180 129 180;
#P connect 8 0 5 0;
#P connect 5 0 6 0;
#P connect 6 0 7 0;
#P connect 7 0 9 0;
...
#P connect 4 0 0 0;
#P pop;
#P newobj 40 362 98 196617 p parameter_names;
...
#P window linecount 2;
#P message 63 139 149 196617 \; _MODULE_INSTALL_SIZE 1 half;
#P window linecount 1;
...
#P fasten 37 0 13 0 138 54 16 54;
#P connect 9 0 13 0;
#P fasten 19 0 13 0 40 54 16 54;
#P connect 8 1 39 0;
#P connect 40 0 39 0;
#P connect 6 0 39 0;
#P connect 13 0 39 0;
...
#P connect 13 1 3 0;
#P connect 13 2 22 0;
#P fasten 24 1 4 0 387 261 130 261;
#P connect 4 0 3 1;
#P connect 13 3 25 0;
#P connect 4 1 7 0;
#P connect 23 0 14 0;
...
#P connect 5 0 16 0;
#P connect 21 0 16 0;
#P fasten 18 1 20 0 896 149 769 149;
#P fasten 26 1 27 0 957 267 779 267;
#P fasten 27 0 28 0 779 290 779 290;
#P connect 36 0 35 0;
#P fasten 30 1 33 0 965 393 834 393;
#P connect 33 0 34 0;
#P fasten 32 0 31 0 883 438 834 438;
#P connect 34 0 31 0;
#P connect 33 1 32 0;
#P pop;
