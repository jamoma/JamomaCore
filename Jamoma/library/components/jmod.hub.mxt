...
#P window setfont "Sans Serif" 9.;
#P newex 347 146 20 196617 t b;
#P newex 347 172 52 196617 s $1_init;
#P newex 140 110 217 196617 jmod.message $1 /module/init @range n/a @description "Reinitialization of this module.";
#P connect 0 1 2 0;
#P connect 2 0 1 0;
#P pop;
#P newobj 522 238 74 196617 p initialization;
...
#P newex 117 399 84 196617 r $1_parameter;
#P newex 363 374 84 196617 r $1_parameter;
#N vpatcher 10 59 610 459;
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
...
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#P newex 639 94 104 196617 s $1_pattr_retrieve;
#P window linecount 0;
...
#P newex 354 354 75 196617 r $1_message;
...
#P newex 460 185 58 196617 jmod.init;
...
#P newex 85 42 90 196617 r $1_FROM_MGUI;
...
#P newex 337 146 100 196617 send $1_instruction;
...
#P newex 142 41 375 196617 jmod.message.mxt $1 /preset/default @type generic @range n/a @description "Open the default preset file and recall the first preset in that file.";
...
#P newex 76 48 55 196617 jmod.init;
