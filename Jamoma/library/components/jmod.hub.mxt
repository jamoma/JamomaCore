max v2;
#N vpatcher 195 112 1192 640;
#P origin 116 0;
#P button 440 202 15 0;
#P window setfont "Sans Serif" 9.;
#P window linecount 0;
#P message 490 200 50 196617;
#P window linecount 1;
#P newex 468 200 14 196617 _;
#P button 462 133 15 0;
#P window linecount 0;
#P message 512 131 50 196617;
#P window linecount 1;
#P newex 490 131 14 196617 _;
#P newex 785 465 74 196617 r $1_setclock;
#P newex 785 492 56 196617 print ***;
#P window setfont "Sans Serif" 14.;
#P newex 424 93 97 196622 jmod.change;
#B color 14;
#P window setfont "Sans Serif" 9.;
...
#P newex 648 347 303 196617 jmod.parameter.mxt $1 /set_clock @type msg_symbol @description "Sync module to external clock. s/set_clock" "max set module to use the Max scheduler (default behaviour).";
...
#P window linecount 3;
#P newex 56 61 412 196617 jmod.message.mxt $1 /view_internals @type n/a @range n/a @description "Attempts to open the internal algorithm for viewing.  This works for most modules.  Some modules may choose to cloak the algorithms - preventing this message from functioning";
#P outlet 56 152 15 0;
#P fasten 1 1 2 0 463 118 61 118;
#P connect 2 0 0 0;
#P pop;
...
#P window linecount 2;
#P newex 11 59 255 196617 route _MGUI_FEEDBACK _GET_MODULE_INSTALL_SIZE MODULE_TITLE /autodoc;
#P window linecount 1;
...
#P newex 58 87 183 196617 sel poly blue none control jitter video;
...
#P window linecount 3;
#P newex 332 103 305 196617 jmod.message.mxt $1 /load_settings @type msg_symbol @range n/a @description "open an xml-preset file and recall the first preset in that file.  An optional argument defines the file to open";
#P window linecount 1;
...
#P fasten 11 1 14 0 632 155 337 155;
#P connect 14 0 13 1;
...
#P window linecount 2;
#P comment 433 65 319 196617 Temporary fix due to a problem with pattrstorage @outputmode 1. Reported at jamoma-devel-list January 22 2006;
#B color 14;
#P connect 10 0 14 0;
#P connect 20 0 14 0;
#P connect 14 0 11 0;
...
#P connect 14 1 4 0;
#P connect 14 2 23 0;
#P fasten 25 1 5 0 369 268 130 268;
#P connect 5 0 4 1;
#P connect 14 3 26 0;
#P connect 5 1 8 0;
#P connect 24 0 15 0;
...
#P connect 42 0 43 0;
#P connect 39 0 40 0;
#P fasten 19 1 21 0 896 149 769 149;
#P fasten 27 1 28 0 957 267 779 267;
#P fasten 28 0 29 0 779 290 779 290;
#P connect 38 0 37 0;
#P fasten 31 1 34 0 946 393 834 393;
#P connect 34 0 35 0;
#P fasten 33 0 32 0 883 438 834 438;
#P connect 35 0 32 0;
#P connect 34 1 33 0;
#P pop;
