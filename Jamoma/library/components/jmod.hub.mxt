...
#P connect 9 1 10 0;
#P pop;
#P newobj 389 84 51 9109513 p autodoc;
#P window linecount 3;
#P newex 322 189 187 9109513 patcherargs @size 1U @library_type poly @module_type audio @skin default @description no info provided;
#P window linecount 1;
...
#P newex 56 61 309 9109513 jmod.message.mxt $1 view_internals @type n/a @range n/a @description "Attempts to open the internal algorithm for viewing.  This works for most modules.  Some modules may choose to cloak the algorithms - preventing this message from functioning";
#P outlet 56 152 15 0;
#P connect 1 0 2 0;
#P connect 2 0 0 0;
#P pop;
#P newobj 452 396 85 9109513 p view_internals;
...
#P connect 2 0 1 0;
#P pop;
#P newobj 326 84 35 9109513 p title;
...
#P connect 2 0 0 0;
#P pop;
#P newobj 692 357 95 9109513 p provide_feedback;
#P newex 427 371 134 9109513 r $1_message;
#P window linecount 2;
#P message 717 117 130 9109513 \; max htmlref $2;
#P window linecount 1;
#P newex 35 33 90 9109513 r $1_FROM_MGUI;
#P window linecount 2;
#P newex 601 78 245 9109513 jmod.message.mxt $1 help @range n/a @description "open the online html reference for this module";
#P window linecount 1;
#P comment 585 430 100 9109513 to pattrstorage;
...
#P newex 11 59 400 9109513 route x _MGUI_FEEDBACK xx xxx _GET_MODULE_INSTALL_SIZE MODULE_TITLE autodoc;
#P newex 452 106 27 9109513 t l l;
#P newex 469 129 100 9109513 send $1_instruction;
...
#P connect 10 0 9 1;
#P pop;
#P newobj 566 162 179 9109513 p preset_handling_from_pattrstorage;
...
#P newex 97 252 59 9109513 jmod.usurp;
...
#P connect 2 0 7 1;
#P pop;
#P newobj 411 345 88 9109513 p library_handler;
#N vpatcher 14 59 614 459;
#P window setfont "Sans Serif" 9.;
#P newex 100 130 68 9109513 route symbol;
#P newex 100 177 123 9109513 prepend parameter_name;
#P newex 50 73 39 9109513 t dump;
#N coll $1_registered_parameters 1;
#P newobj 50 100 161 9109513 coll $1_registered_parameters 1;
...
#P connect 4 0 0 0;
#P pop;
#P newobj 96 272 98 9109513 p parameter_names;
#N vpatcher 22 63 922 387;
#P window setfont "Sans Serif" 9.;
#P window linecount 0;
#P newex 121 166 100 9109513 sprintf read %s.xml;
#P newex 511 156 45 9109513 sel bang;
#P newex 332 156 45 9109513 sel bang;
...
#P connect 22 1 23 0;
#P pop;
#P newobj 311 227 53 9109513 p settings;
#P newex 367 175 105 9109513 prepend load_settings;
#P newex 332 78 302 9109513 jmod.message.mxt $1 load_settings @type msg_symbol @range n/a @description "open an xml-preset file and recall the first preset in that file.  An optional argument defines the file to open";
#P newex 546 175 110 9109513 prepend save_settings;
#P newex 511 122 381 9109513 jmod.message.mxt $1 save_settings @type msg_symbol @range n/a @description "write an xml-preset file to disk.  An optional argument defines the file to open";
...
#P comment 10 149 62 9109513 load the first preset;
#P message 76 149 44 9109513 recall 1;
#P message 121 149 110 9109513 $2;
#P window linecount 2;
#P comment 141 189 100 9109513 read the default preset(s);
#P window linecount 1;
#P newex 76 81 29 9109513 t b b;
...
#P connect 14 1 9 0;
#P pop;
#P newobj 622 335 165 9109513 p preset_handling_to_pattrstorage;
...
#P connect 13 1 12 0;
#P pop;
#P newobj 322 245 99 9109513 p attribute_handling;
...
#P connect 2 0 3 0;
#P pop;
#P newobj 263 267 69 9109513 p install_size;
#N vpatcher 14 59 614 459;
#P window setfont "Sans Serif" 9.;
#P newex 107 78 51 9109513 route list;
#P message 197 171 52 9109513 target \$1;
#P newex 180 150 27 9109513 t b i;
#P newex 180 221 117 9109513 zl reg;
#P newex 180 130 117 9109513 zl slice 1;
#P window setfont "Sans Serif" 12.;
#P comment 115 28 131 9109516 Poly Handling;
#P inlet 107 58 15 0;
...
#P connect 3 1 4 1;
#P pop;
#P newobj 452 84 78 9109513 p poly_handling;
...
#P connect 10 1 9 1;
#P pop;
#P newobj 452 150 85 9109513 p syntax_handler;
#P comment 585 39 100 9109513 from pattrstorage;
#P connect 9 0 13 0;
#P connect 19 0 13 0;
#P connect 8 1 10 0;
#P connect 13 1 10 0;
...
#P connect 5 0 16 0;
#P connect 22 0 16 0;
#P fasten 18 1 20 0 841 113 722 113;
#P pop;
