...
#P window linecount 1;
#N vpatcher 236 60 1209 468;
#P outlet 359 374 15 0;
#P window setfont "Sans Serif" 9.;
#P window linecount 0;
#P message 359 353 110 9109513 /autodoc_complete bang;
#P window linecount 1;
#P newex 359 279 63 9109513 t l l;
#P newex 359 330 27 9109513 qlim;
#P newex 359 308 51 9109513 route write;
#P window linecount 0;
#P newex 120 128 70 9109513 prepend setfile;
#P newex 103 105 27 9109513 t b l;
#P newex 648 279 301 9109513 jmod.return.mxt $1 /modulesize @description "Size of module.";
...
#N coll $1_registered_parameters 1;
#P newobj 70 279 229 9109513 coll $1_registered_parameters 1;
#P connect 7 0 6 0;
#P connect 17 0 4 0;
#P connect 18 0 4 0;
#P connect 6 0 4 0;
