...
#P newex 545 185 320 196617 jmod.message $1 /module/size? @description "Get size of module.";
...
#P newex 101 185 130 196617 prepend /parameter_name;
#P newex 51 84 39 196617 t dump;
#N coll $1_registered_parameters 1;
#P newobj 51 108 161 196617 coll $1_registered_parameters 1;
#P newex 50 21 306 196617 jmod.message.mxt $1 /module/parameter_names? @type n/a @range n/a @description "Returns a dump of symbols out the feedback outlet with the names of parameters accessible in this module.";
...
#P newex 523 280 388 196617 jmod.message.mxt $1 /preset/access @type generic @range n/a @description "Access directly to the pattrstorage object. See Max Reference.";
#P window linecount 1;
