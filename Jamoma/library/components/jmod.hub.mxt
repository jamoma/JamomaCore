...
#P newex 85 40 97 196617 r $1_name;
#P inlet 104 86 15 0;
#P connect 7 0 5 0;
#P connect 5 0 3 0;
#P connect 3 0 2 0;
...
#P pop;
#P newobj 165 275 63 196617 p attributes;
#N vpatcher 136 253 736 653;
#P window setfont "Sans Serif" 9.;
#P newex 308 141 90 196617 s $1_init;
#P newex 117 86 201 196617 jmod.message $1 /module/init @range n/a @description "Initialize this module.";
#P connect 0 1 1 0;
#P pop;
#P newobj 532 242 74 196617 p initialization;
#P newex 127 404 114 196617 r $1_parameter;
#P newex 373 379 114 196617 r $1_parameter;
...
#P connect 3 1 2 0;
#P pop;
#P newobj 532 213 69 196617 p clock_stuff;
...
#P connect 5 0 6 0;
#P pop;
#P newobj 532 155 110 196617 p view_documentation;
#N vpatcher 10 59 610 459;
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
...
#P connect 8 0 7 0;
#P pop;
#P newobj 532 184 128 196617 p /ui/freeze_and_refresh;
...
#P connect 2 1 1 1;
#P pop;
#P newobj 308 170 93 196617 p send_instruction;
...
#P connect 8 1 13 1;
#P pop;
#P newobj 93 474 72 196617 p unique_send;
#P newex 104 317 93 196617 s $1_FROM_MHUB;
#P newex 104 296 42 196617 t BUILD;
#P newex 104 275 57 196617 sel done;
#P newex 151 296 104 196617 prepend ATTRIBUTES;
#P newex 83 359 110 196617 r $1_feedback;
#N vpatcher 34 59 634 459;
#P outlet 98 62 15 0;
#P inlet 98 33 15 0;
#P connect 0 0 1 0;
#P pop;
#P newobj 71 436 37 196617 p thru;
...
#P connect 3 0 6 0;
#P pop;
#P newobj 244 46 122 196617 p remote_communication;
#P newex 364 359 119 196617 r $1_message;
...
#P newex 460 185 140 196617 jmod.init.mxt $1;
...
#P newex 283 121 145 196617 r $1_FROM_MHUB;
#P inlet 70 46 15 0;
...
#P connect 14 1 15 0;
#P pop;
#P newobj 236 124 51 196617 p autodoc;
#P window linecount 2;
#P newex 104 237 278 196617 patcherargs @size 1U @algorithm_type poly @module_type audio @skin default @description "No info provided.";
#P window linecount 1;
...
#P connect 2 0 0 0;
#P pop;
#P newobj 315 440 85 196617 p view_internals;
...
#P connect 20 0 19 0;
#P pop;
#P newobj 181 124 35 196617 p title;
#P newex 95 47 121 196617 r $1_FROM_MGUI;
#P comment 503 473 100 196617 to pattrstorage;
#N comlet to pattrstorage;
#P outlet 484 473 15 0;
#N comlet connect to pattrstorage;
#P inlet 484 53 15 0;
#N comlet connect to a poly~ object;
#P outlet 274 473 15 0;
#P window linecount 3;
#P newex 71 73 232 196617 route _MGUI_FEEDBACK _GET_MODULE_INSTALL_SIZE MODULE_TITLE /documentation/generate;
#P window linecount 1;
#P newex 291 147 27 196617 t l l;
#P newex 347 151 135 196617 send $1_instruction;
#N comlet module feedback - connect to 1st outlet;
#P outlet 71 473 15 0;
#N comlet connect to mgui (1st outlet);
#P inlet 71 48 15 0;
#N vpatcher 212 44 779 431;
#P window setfont "Sans Serif" 9.;
#P window linecount 0;
#P newex 71 75 452 196617 jmod.return $1 /preset/out @description "returns the ouptput of pattrstorage object";
#P window linecount 2;
#P newex 317 247 78 196617 t MENU_REBUILD;
#P window linecount 1;
#P newex 344 158 112 196617 prepend NEW_PRESETS;
#P newex 344 311 137 196617 s $1_FROM_MHUB;
...
#P connect 8 0 7 0;
#P pop;
#P newobj 484 324 179 196617 p preset_handling_from_pattrstorage;
...
#P connect 7 4 14 0;
#P pop;
#P newobj 274 402 100 196617 p algorithm_handler;
...
#P connect 4 0 0 0;
#P pop;
#P newobj 94 382 98 196617 p parameter_names;
...
#P window linecount 2;
#P newex 105 329 359 196617 jmod.message.mxt $1 /preset/recall @type msg_float @description "Recall a preset by number - you can also choose presets from the module menu.";
...
#P newex 247 37 361 196617 jmod.message.mxt $1 /preset/default @type n/a @range n/a @description "Open the default preset file and recall the first preset in that file.";
...
#P newex 76 48 129 196617 jmod.init.mxt $1;
...
#P fasten 21 1 22 0 459 362 110 362;
...
#P connect 15 1 10 0;
#P pop;
#P newobj 503 387 165 196617 p preset_handling_to_pattrstorage;
...
#P connect 3 1 4 1;
#P pop;
#P newobj 291 124 78 196617 p poly_handling;
...
#P connect 10 1 9 1;
#P pop;
#P newobj 291 191 85 196617 p syntax_handler;
#P comment 503 53 100 196617 from pattrstorage;
#P fasten 16 0 11 0 100 68 76 68;
#P connect 7 0 11 0;
#P fasten 22 0 11 0 249 68 76 68;
#P connect 24 0 23 0;
#P connect 4 0 23 0;
#P fasten 20 0 23 0 241 164 76 164;
#P connect 35 0 23 0;
#P connect 11 0 23 0;
#P connect 23 0 8 0;
#P connect 23 0 29 0;
#P fasten 19 1 26 0 377 270 109 270;
#P connect 26 0 27 0;
#P connect 25 0 28 0;
#P connect 27 0 28 0;
#P connect 26 1 25 0;
...
#P connect 11 2 17 0;
#P connect 11 3 20 0;
#P fasten 19 1 5 0 377 272 279 272;
#P connect 18 0 12 0;
#P connect 5 0 12 0;
#P connect 11 4 2 0;
#P connect 2 0 10 0;
