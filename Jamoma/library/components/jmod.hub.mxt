...
#P window setfont "Sans Serif" 9.;
#P window linecount 2;
#P comment 121 337 202 196617 First all allowed messages are sorted alphabeitcally \, and then dumped so that the menu can be built;
#P window linecount 1;
...
#P newex 123 80 55 196617 r jmod.init;
