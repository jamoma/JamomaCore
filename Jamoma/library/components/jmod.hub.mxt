...
#P window setfont "Sans Serif" 9.;
#P message 130 149 126 196617 "Name argument missing";
#P newex 130 124 138 196617 sel 0;
#P newex 130 101 67 196617 loadmess $3;
#P inlet 68 92 15 0;
#P window linecount 1;
#P newex 68 190 114 196617 prepend MODULE_TITLE;
#P newex 68 241 93 196617 s $1_FROM_MHUB;
#P window linecount 0;
#P comment 67 47 210 196617 set title of module in top bar of gui;
#P fasten 6 0 2 0 135 177 73 177;
#P fasten 5 1 2 0 263 179 73 179;
#P connect 3 0 2 0;
#P connect 2 0 1 0;
#P connect 4 0 5 0;
#P connect 5 0 6 0;
