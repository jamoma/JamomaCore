max v2;
#N vpatcher 116 94 1113 622;
#P origin 116 0;
#P window setfont "Sans Serif" 9.;
#N vpatcher 10 59 550 466;
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#P newex 129 205 98 196617 if $i1==1 then bang;
#P newex 129 178 34 196617 zl len;
#P inlet 254 47 15 0;
#P newex 254 337 47 196617 forward;
#P newex 254 90 49 196617 zl rot -1;
#P newex 321 244 104 196617 route MODULE_TITLE;
#P newex 295 270 36 196617 zl reg;
#P newex 321 223 94 196617 r $1_FROM_MHUB;
#P newex 295 156 175 196617 t b s;
#P newex 254 127 51 196617 zl ecils 1;
#P newex 295 296 175 196617 sprintf send /jmod/toModule/%s%s;
...
#P inlet 49 36 15 0;
#P window setfont "Sans Serif" 9.;
#P newex 49 341 47 196617 forward;
#P newex 49 94 49 196617 zl rot -1;
#P window linecount 1;
#P newex 116 248 104 196617 route MODULE_TITLE;
#P newex 90 274 36 196617 zl reg;
#P newex 116 227 94 196617 r $1_FROM_MHUB;
#P newex 90 160 188 196617 t b s;
#P newex 49 131 51 196617 zl ecils 1;
#P newex 90 300 188 196617 sprintf send /jmod/fromModule/%s%s;
#P connect 8 0 6 0;
#P connect 6 0 1 0;
#P connect 1 0 7 0;
#P connect 0 0 7 0;
...
#P fasten 23 1 24 0 957 267 779 267;
#P fasten 24 0 25 0 779 290 779 290;
#P connect 33 0 32 0;
