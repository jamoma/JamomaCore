{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 29.0, 54.0, 816.0, 646.0 ],
		"bglocked" : 0,
		"defrect" : [ 29.0, 54.0, 816.0, 646.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 55.0, 415.0, 132.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "find names of all messages in an existing Jamoma module"
				}
