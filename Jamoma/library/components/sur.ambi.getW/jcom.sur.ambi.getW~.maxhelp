{
	"patcher" : 	{
		...
		"bglocked" : 0,
		"defrect" : [ 381.0, 64.0, 632.0, 487.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 158.0, 177.0, 34.0, 19.0 ],
					"text" : "dist"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 133.0, 152.0, 32.0, 19.0 ],
					"text" : "ele"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 118.0, 177.0, 39.0, 19.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 93.0, 152.0, 39.0, 19.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 68.0, 122.0, 39.0, 19.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 206.0, 120.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 113.0, 122.0, 33.0, 19.0 ],
					"text" : "azi"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 26.5, 260.0, 217.5, 260.0 ],
					"source" : [ "obj-12", 0 ]
				}
