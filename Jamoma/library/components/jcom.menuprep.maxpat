...
, 			{
				"box" : 				{
					...
					"id" : "obj-2",
					"fontsize" : 9.0,
					"patching_rect" : [ 126.0, 164.0, 79.0, 17.0 ],
					"numinlets" : 1,
					"numoutlets" : 1,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-3",
					"fontsize" : 9.0,
					"patching_rect" : [ 151.0, 116.0, 217.0, 38.0 ],
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"fontsize" : 9.0,
					"patching_rect" : [ 151.0, 89.0, 209.0, 28.0 ],
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-5",
					"fontsize" : 9.0,
					"patching_rect" : [ 80.0, 69.0, 49.0, 17.0 ],
					"numinlets" : 1,
					"numoutlets" : 1,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-6",
					"fontsize" : 9.0,
					"patching_rect" : [ 49.0, 116.0, 59.0, 17.0 ],
					"numinlets" : 1,
					"numoutlets" : 1,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-7",
					"fontsize" : 9.0,
					"patching_rect" : [ 18.0, 47.0, 72.0, 17.0 ],
					"numinlets" : 1,
					"numoutlets" : 3,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-10",
					"fontsize" : 9.0,
					"patching_rect" : [ 150.0, 71.0, 108.0, 17.0 ],
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontname" : "Verdana"
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 0 ],
					"hidden" : 0,
					"midpoints" : [ 58.5, 182.0, 27.0, 182.0 ]
				}
