...
#P newex 64 403 315 196617 jcom.parameter $1/midi @type msg_float @range 0. 158. @clipmode low @ramp linear.sched @description "Set gain as MIDI value.";
#P objectname $1/midi;
#P newex 88 320 310 196617 jcom.message $1 @type msg_float @slave 1 @range -144. 18. @clipmode none @ramp linear.sched @description "Set gain as dB value.";
