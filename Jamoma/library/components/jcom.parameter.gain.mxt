max v2;
#N vpatcher 41 130 682 702;
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#P newex 429 257 64 196617 patcherargs;
#P newex 483 281 57 196617 route done;
#N vpatcher 10 59 529 396;
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#P newex 128 73 91 196617 route int float list;
#P newex 50 50 89 196617 jcom.pass inc dec;
#P newex 128 126 54 196617 jcom.thru;
#P newex 128 238 157 196617 pack 0. 0.;
#P newex 287 169 21 196617 t 0;
#P newex 128 169 157 196617 unpack 0. 0;
#P inlet 50 30 15 0;
#P outlet 50 288 15 0;
#P window linecount 0;
#P newex 128 194 139 196617 expr ($f1 * (10./6.)) + 127;
#P comment 307 196 172 196617 <- decibels to midi conversion;
#P connect 3 0 8 0;
#P connect 6 0 2 0;
#P connect 8 1 2 0;
#P connect 8 0 2 0;
...
#P connect 5 0 6 1;
#P connect 4 1 6 1;
#P fasten 7 0 5 0 133 152 292 152;
#P pop;
