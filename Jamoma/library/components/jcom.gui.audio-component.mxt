...
#P window linecount 2;
#P hidden newex 300 272 377 196617 jcom.parameter audio/mute @type msg_toggle @range 0 1 @description "When active\\\, this attribute turns off the module's processing.mxtorithm to save CPU";
#P objectname audio/mute;
#P hidden newex 300 317 439 196617 jcom.parameter audio/bypass @type msg_toggle @range 0 1 @description "When active\\\, this attribute bypasses the module's processing.mxtorithm\\\, letting audio pass through unaffected.";
