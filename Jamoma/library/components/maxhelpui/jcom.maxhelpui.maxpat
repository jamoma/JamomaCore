					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 777.0, 224.0, 360.0, 498.0 ],
										"bglocked" : 0,
										"defrect" : [ 777.0, 224.0, 360.0, 498.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 175.0, 395.0, 100.0, 19.0 ],
													"text" : "tosymbol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 175.0, 420.0, 62.0, 17.0 ],
													"text" : "sprintf file%s"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 141.0, 374.0, 51.0, 17.0 ],
													"text" : "zl ecils 1"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 45.0, 445.0, 25.0, 25.0 ]
												}
...
,
									"patching_rect" : [ 131.0, 147.5, 54.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 51.0, 235.5, 49.0, 19.0 ],
									"text" : "pcontrol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 51.0, 214.5, 167.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 123.5, 180.0, 19.0 ],
									"text" : "sel 0 3 1 2"
								}
...
,
									"patching_rect" : [ 90.0, 190.5, 56.0, 19.0 ],
									"saved_object_attributes" : 									{
										"globalpatchername" : "",
										"fontname" : "Verdana",
										"fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "open" ],
									"patching_rect" : [ 90.0, 146.5, 45.0, 19.0 ],
									"text" : "t open"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 90.0, 168.5, 55.0, 19.0 ],
									"text" : "pcontrol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 253.0, 187.5, 125.0, 29.0 ],
									"text" : ";\rmax launchbrowser $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 253.0, 126.5, 480.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 253.0, 105.5, 91.0, 17.0 ],
									"text" : "jmod.sur.setup"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 325.0, 50.0, 25.0, 25.0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-39", 0 ],
									"hidden" : 1,
									"midpoints" : [ 140.5, 169.5, 262.5, 169.5 ],
									"source" : [ "obj-49", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 1,
									"midpoints" : [ 180.25, 146.5, 243.375, 146.5, 243.375, 101.5, 262.5, 101.5 ],
									"source" : [ "obj-27", 3 ]
								}
...
,
					"patching_rect" : [ 207.0, 356.5, 88.0, 19.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"fontname" : "Verdana",
						"fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 879.0, 50.0, 166.0, 21.0 ],
					"rounded" : 0.0,
					"spacing_x" : 1.0,
					"spacing_y" : 0.0,
