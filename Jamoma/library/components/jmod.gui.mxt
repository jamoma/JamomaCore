...
#P hidden newex 537 69 69 9109513 s $1_message;
#P hidden newex 537 46 110 9109513 prepend preview_window;
...
#P hidden newex 412 280 50 9109513 tosymbol;
#P hidden newex 548 309 65 9109513 t menu_build;
#P hidden newex 408 300 131 9109513 prepend menu_presets_add;
#P hidden newex 460 287 108 9109513 t menu_presets_clear;
#P hidden message 341 194 32 9109513 clear;
#P hidden newex 341 172 55 9109513 r jmod.init;
#P hidden newex 338 287 75 9109513 prepend append;
#P hidden newex 412 348 90 9109513 s $1_FROM_MGUI;
...
#P hidden newex 256 287 22 9109513 b 1;
#N thispatcher;
#Q end;
#P hidden newobj 256 345 60 9109513 thispatcher;
#P hidden newex 256 324 166 9109513 js jmod.gui.constructor.js $1;
#P window linecount 2;
#P hidden newex 155 243 487 9109513 route MODULE_TITLE ATTRIBUTES BUILD PARAMETERS NEW_PRESETS NEW_PRESETS_START MENU_REBUILD;
#P window linecount 1;
#P hidden newex 155 223 93 9109513 r $1_FROM_MHUB;
#P hidden newex 155 345 90 9109513 prepend setitem 0;
...
#P user umenu 11 2 226 9109540 3 64 18 0;
...
#P hidden fasten 80 0 24 0 465 321 261 321;
#P hidden connect 81 0 24 0;
#P hidden fasten 23 1 24 0 228 317 261 317;
#P hidden connect 82 0 24 0;
#P hidden connect 24 0 25 0;
#P hidden connect 28 0 84 1;
