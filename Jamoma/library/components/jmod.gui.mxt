...
#P hidden newex 522 7 344 9109513 jmod.message $1 /open_inspector @description "Open this module's inspector window to gain access to additional information or parameters.";
#P objectname inspector_message;
#P user pictctrl 496 4 11 11 jmod.button.info.pct 0 0 1 0 27 0 0 0 11 11 128 0 1 10 2 1 1 270;
#P objectname inspector_button;
#P window linecount 1;
#P hidden message 383 194 53 9109513 jmod_init;
#P hidden newex 635 309 176 9109513 r $1_FROM_GUI_VIDEO_COMPONENT;
#P window linecount 2;
#P hidden newex 359 280 43 9109513 prepend append;
#P window linecount 1;
#P hidden newex 537 69 83 9109513 s $1_message;
#P hidden newex 537 46 136 9109513 prepend /pwindow_dumpout;
#P bpatcher 450 2 60 59 0 0 jmod.gui.video-component.mxt 0 $1;
#P objectname pwindow;
#P hidden newex 259 67 29 9109513 gate;
#P objectname pwindow_gate;
#P hidden newex 427 282 50 9109513 tosymbol;
#P hidden newex 563 309 65 9109513 t menu_build;
#P window linecount 2;
#P hidden newex 427 302 99 9109513 prepend menu_presets_add;
#P hidden newex 495 267 89 9109513 t menu_presets_clear;
#P window linecount 1;
#P hidden message 341 194 32 9109513 clear;
#P hidden newex 341 172 55 9109513 r jmod.init;
#P hidden newex 447 382 90 9109513 s $1_FROM_MGUI;
...
#P hidden newex 291 289 22 9109513 b 1;
#N thispatcher;
#Q end;
#P hidden newobj 291 372 60 9109513 thispatcher;
#P hidden newex 291 351 166 9109513 js jmod.gui.constructor.js $1;
#P window linecount 2;
#P hidden newex 155 232 487 9109513 route MODULE_TITLE ATTRIBUTES BUILD PARAMETERS NEW_PRESETS NEW_PRESETS_START MENU_REBUILD;
#P window linecount 1;
#P hidden newex 155 212 93 9109513 r $1_FROM_MHUB;
#P hidden newex 155 366 90 9109513 prepend setitem 0;
#P window linecount 3;
#P hidden comment 216 119 404 9109513 this first half of the inlets/outlets are the raw unprocessed signal(s) \, the second half are the processed signal(s). The connections are scripted into existence when the number of channels is received from the module hub.;
...
#P user umenu 11 2 226 11403300 3 64 17 0;
#X setrgb 165 165 165 221 221 221 255 255 255 221 221 221 170 170 170 119 119 119 187 187 187;
#X add jamoma;
#P user pictctrl 0 0 510 61 jmod.bg.metal.black.1U.pct 0 0 1 2 24 0 0 0 510 61 2 0 0 1 1 1 1 270;
#P noclick;
#P objectname background;
#P window setfont "Sans Serif" 9.;
#P user umenu 17 1 72 9109543 1 64 17 1;
#P objectname param_reference;
#P user umenu 0 1 15 9109543 1 64 17 1;
...
#P hidden fasten 88 0 24 0 640 344 296 344;
...
#P hidden connect 89 0 24 0;
#P hidden connect 24 0 25 0;
#P hidden connect 77 0 78 0;
#P hidden connect 28 0 27 0;
#P hidden fasten 24 2 27 0 374 406 818 406 818 -18 350 -18;
