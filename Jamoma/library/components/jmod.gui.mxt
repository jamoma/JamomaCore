...
#P hidden newex 667 275 178 196617 r $1_FROM_GUI_AUDIO_COMPONENT;
#P window linecount 2;
#P hidden newex 522 7 344 196617 jmod.message $1 /open_inspector @description "Open this module's inspector window to gain access to additional information or parameters.";
...
#P window linecount 1;
#P hidden message 383 194 53 196617 jmod_init;
#P hidden newex 678 296 176 196617 r $1_FROM_GUI_VIDEO_COMPONENT;
#P window linecount 2;
#P hidden newex 359 280 43 196617 prepend append;
#P window linecount 1;
#P hidden newex 537 69 83 196617 s $1_message;
#P hidden newex 537 46 136 196617 prepend /pwindow_dumpout;
...
#P hidden newex 155 232 556 196617 route MODULE_TITLE ATTRIBUTES BUILD PARAMETERS NEW_PRESETS NEW_PRESETS_START MENU_REBUILD UI_FREEZE;
...
#P user umenu 11 2 226 431423524 3 64 17 0;
...
#P hidden fasten 92 0 24 0 672 344 296 344;
#P hidden fasten 88 0 24 0 683 344 296 344;
...
#P hidden fasten 23 7 24 0 636 344 296 344;
