	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"id" : "obj-1",
					"fontsize" : 9.0,
					"patching_rect" : [ 80.0, 110.0, 29.0, 17.0 ],
					"numinlets" : 1,
					"numoutlets" : 2,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-2",
					"fontsize" : 9.0,
					"patching_rect" : [ 111.0, 35.0, 64.0, 17.0 ],
					"numinlets" : 1,
					"numoutlets" : 2,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-3",
					"fontsize" : 9.0,
					"patching_rect" : [ 40.0, 110.0, 29.0, 17.0 ],
					"numinlets" : 1,
					"numoutlets" : 2,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"fontsize" : 9.0,
					"patching_rect" : [ 80.0, 87.0, 34.0, 17.0 ],
					"numinlets" : 2,
					"numoutlets" : 1,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"patching_rect" : [ 80.0, 59.0, 35.0, 17.0 ],
					"numinlets" : 1,
					"numoutlets" : 2,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-7",
					"fontsize" : 9.0,
					"patching_rect" : [ 40.0, 150.0, 129.0, 17.0 ],
					"numinlets" : 3,
					"numoutlets" : 1,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-10",
					"fontsize" : 9.0,
					"patching_rect" : [ 40.0, 178.0, 29.0, 17.0 ],
					"numinlets" : 2,
					"numoutlets" : 1,
					"fontname" : "Verdana"
				}
