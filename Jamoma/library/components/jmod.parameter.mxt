...
#P newex 116 118 145 196617 pv jmod.parameter.repetitions;
...
#P connect 7 0 10 0;
#P pop;
#P newobj 19 362 65 196617 p repetitions;
#P newex 77 330 71 196617 jmod.line.mxt;
#P newex 19 306 68 196617 gate 2;
#P newex 19 280 27 196617 + 1;
#P window linecount 2;
#P comment 365 256 175 196617 Register this parameter with the module hub;
#P window linecount 1;
...
#P connect 1 1 4 0;
#P pop;
#P newobj 388 203 50 196617 p restart;
...
#P inlet 80 46 15 0;
#P newex 80 119 145 196617 pv jmod.parameter.repetitions;
...
#P comment 369 491 175 196617 flag indicating dupes attribute;
#P newex 369 507 123 196617 pv jmod.parameter.dupes;
...
#P comment 369 452 175 196617 flag indicating type attribute;
#P newex 369 468 118 196617 pv jmod.parameter.type;
#N vpatcher -8 164 403 606;
#P window setfont "Sans Serif" 9.;
...
#P newex 369 551 145 196617 pv jmod.parameter.conversion;
#P comment 369 535 175 196617 flag indicating conversion attribute;
...
#P newex 369 426 112 196617 pv jmod.parameter.set;
...
#P window linecount 2;
#P newex 321 100 255 196617 patcherargs $0_ mod_name @ramp_enable 0 @type generic @special n/a @repetitions 1 @conversion none;
#P window linecount 1;
#P newex 369 322 137 196617 send $1_register;
#P message 369 304 132 196617 $2;
#P newex 369 284 140 196617 receive $1_query;
#P newex 112 157 141 196617 route $2;
#P newex 112 134 139 196617 receive $1_instruction;
#P inlet 77 41 15 0;
#P comment 369 410 175 196617 flag indicating if it's a "set" message;
#P connect 8 0 26 0;
#P connect 26 0 27 0;
