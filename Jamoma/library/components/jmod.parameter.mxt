...
#P window setfont "Sans Serif" 9.;
#P comment 29 35 127 196617 Filter repeating values?;
#P inlet 295 67 15 0;
...
#P newex 116 118 145 196617 pv jmod.parameter.repititions;
...
#P connect 7 0 10 0;
#P pop;
#P newobj 5 348 156 196617 p repetitions_filter;
#P newex 63 316 71 196617 jmod.line.mxt;
#P newex 5 292 68 196617 gate 2;
#P newex 5 266 27 196617 + 1;
#P window linecount 2;
#P comment 454 235 175 196617 Register this parameter with the module hub;
#P window linecount 1;
#P newex 307 66 55 196617 r jmod.init;
#N vpatcher 24 57 251 306;
#P origin 0 34;
#P window setfont "Sans Serif" 9.;
#P newex 34 70 20 196617 t b;
#P inlet 103 40 15 0;
...
#P connect 1 1 4 0;
#P pop;
#P newobj 355 502 50 196617 p restart;
#N vpatcher 34 89 302 255;
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#P newex 80 69 27 196617 != 0;
#P window linecount 0;
#P comment 79 25 100 196617 set flag;
#P inlet 80 46 15 0;
#P newex 80 119 145 196617 pv jmod.parameter.repititions;
...
#P comment 458 470 175 196617 flag indicating repetions attribute;
#P newex 458 486 145 196617 pv jmod.parameter.repititions;
...
#P connect 0 8 8 0;
#P pop;
#P newobj 351 190 35 196617 p type;
#P comment 458 431 175 196617 flag indicating type attribute;
#P newex 458 447 118 196617 pv jmod.parameter.type;
...
#P newex 458 530 145 196617 pv jmod.parameter.conversion;
#P comment 458 514 175 196617 flag indicating conversion attribute;
...
#P newex 458 405 112 196617 pv jmod.parameter.set;
...
#P window linecount 1;
#P newex 458 301 137 196617 send $1_register;
#P message 458 283 132 196617 $2;
#P newex 458 263 140 196617 receive $1_query;
#P newex 98 143 141 196617 route $2;
#P newex 98 120 139 196617 receive $1_instruction;
#P inlet 63 27 15 0;
#P comment 458 389 175 196617 flag indicating if it's a "set" message;
#P connect 8 0 26 0;
#P connect 26 0 27 0;
#P fasten 28 0 29 0 68 338 10 338;
#P connect 27 0 29 0;
#P connect 29 0 10 0;
#P connect 10 0 16 0;
#P connect 16 0 30 0;
...
#P connect 32 0 9 0;
#P connect 1 0 15 0;
#P fasten 3 0 27 1 103 170 68 170;
#P connect 15 0 27 1;
#P connect 27 1 28 0;
#P connect 2 0 3 0;
#P fasten 16 0 31 0 10 451 103 451;
#P connect 33 1 28 1;
#P lcolor 15;
#P connect 33 0 28 1;
#P lcolor 15;
#P fasten 10 0 33 0 10 406 228 406 228 274 156 274;
#P lcolor 15;
#P connect 33 0 29 1;
#P lcolor 15;
#P connect 33 1 29 1;
...
#P connect 8 1 19 0;
#P fasten 16 0 23 0 10 445 360 445;
#P connect 8 2 23 1;
#P connect 8 3 22 0;
#P connect 4 0 5 0;
#P connect 5 0 6 0;
