max v2;
#N vpatcher 120 89 981 745;
#P origin 0 -5;
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#P newex 641 239 335 196617 jmod.post "WARNING BAD ATTRIBUTE SPECIFIED TO JMOD.PARAMETER";
...
#P connect 1 1 4 0;
#P pop;
#P newobj 444 239 50 196617 p restart;
...
#P connect 0 0 4 0;
#P pop;
#P newobj 511 239 42 196617 p dupes;
...
#P connect 0 1 2 0;
#P pop;
#P newobj 391 239 35 196617 p type;
...
#P connect 1 1 3 0;
#P pop;
#P newobj 561 239 65 196617 p conversion;
#P newex 537 449 112 196617 pv jmod.parameter.set;
#P newex 59 425 121 196617 pattr $2 @autorestore 0;
#X prestore 1 0 0;
#P objectname $2;
#P outlet 59 563 15 0;
#P newex 361 213 275 196617 route ramp_enable type special repetitions conversion done;
#P window linecount 2;
#P newex 361 136 255 196617 patcherargs $0_ mod_name @ramp_enable 0 @type generic @special n/a @repetitions 1 @conversion none;
#P window linecount 1;
...
#P connect 8 0 28 0;
#P connect 28 0 29 0;
#P fasten 30 0 31 0 122 388 64 388;
#P connect 29 0 31 0;
#P connect 31 0 10 0;
#P connect 10 0 16 0;
#P connect 16 0 32 0;
...
#P connect 34 0 9 0;
#P connect 1 0 15 0;
#P fasten 3 0 29 1 157 220 122 220;
#P connect 15 0 29 1;
#P connect 29 1 30 0;
#P connect 2 0 3 0;
#P fasten 16 0 33 0 64 501 157 501;
#P connect 35 0 30 1;
#P lcolor 15;
#P connect 35 1 30 1;
#P lcolor 15;
...
#P connect 35 1 31 1;
#P lcolor 15;
#P fasten 10 0 35 0 64 456 282 456 282 324 210 324;
#P lcolor 15;
#P fasten 25 0 26 0 413 105 366 105;
#P connect 24 0 26 0;
#P connect 26 0 7 0;
#P fasten 7 1 8 0 611 205 366 205;
#P connect 8 1 19 0;
#P connect 8 2 23 1;
#P connect 8 3 22 0;
#P connect 4 0 5 0;
