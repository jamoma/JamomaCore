max v2;
#N vpatcher 230 115 1035 709;
#P origin 0 -5;
#P window setfont "Sans Serif" 9.;
#P window linecount 1;
#N vpatcher 399 96 1077 489;
#P origin 0 5;
#P window setfont "Sans Serif" 9.;
...
#P newex 283 112 273 196617 t documentation petetitions ramp clipmode range type bang;
#P newex 106 270 152 196617 prepend $2;
#P window linecount 1;
...
#P connect 9 0 1 0;
#P connect 1 0 2 0;
#P fasten 10 0 2 0 288 225 111 225;
#P fasten 11 0 6 0 546 263 111 263;
#P connect 2 0 6 0;
#P connect 6 0 5 0;
#P fasten 3 1 9 1 111 138 166 138;
#P connect 4 0 12 0;
#P connect 12 0 7 0;
#P fasten 7 5 10 0 503 142 288 142;
#P fasten 7 4 10 0 460 142 288 142;
#P fasten 7 3 10 0 417 142 288 142;
#P fasten 7 2 10 0 374 142 288 142;
#P fasten 7 1 10 0 331 142 288 142;
#P fasten 7 0 10 0 288 142 288 142;
#P connect 7 6 11 0;
#P pop;
...
#P window linecount 2;
#P newex 331 159 255 196617 route ramp type repetitions range clipmode documentation done;
#P newex 331 82 308 196617 patcherargs $1 mod_name @ramp 0 @type generic @repetitions 1 @range 0. 127. @clipmode none @documentation no info provided;
#P window linecount 1;
...
#P window linecount 2;
#P newex 594 159 198 196617 jmod.post "WARNING BAD ATTRIBUTE SPECIFIED TO JMOD.PARAMETER";
#P connect 4 0 1 0;
#P connect 2 0 1 0;
#P connect 1 0 24 0;
#P connect 24 0 25 0;
...
#P lcolor 15;
#P connect 12 0 8 0;
#P fasten 8 1 9 0 634 151 336 151;
#P connect 9 0 19 0;
#P connect 5 0 6 0;
#P connect 6 0 7 0;
#P connect 9 1 21 0;
