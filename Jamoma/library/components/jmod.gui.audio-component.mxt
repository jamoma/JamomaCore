...
#P hidden newex 400 167 193 196617 send $1_FROM_GUI_AUDIO_COMPONENT;
#P hidden newex 400 140 144 196617 prepend audio_meters_freeze;
...
#P hidden newex 209 51 209 196617 jmod.message.mxt $1 /audio/meters/clear;
#B color 1;
