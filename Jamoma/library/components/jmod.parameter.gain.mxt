...
#N vpatcher 558 192 1158 592;
#P outlet 485 274 15 0;
#P window setfont "Sans Serif" 9.;
#P newex 485 245 44 196617 receive;
#P outlet 358 274 15 0;
#P newex 358 245 44 196617 receive;
#P outlet 231 274 15 0;
#P newex 231 245 44 196617 receive;
#P outlet 104 274 15 0;
#P newex 104 245 44 196617 receive;
#P newex 208 151 115 196617 t $2;
#P newex 104 118 158 196617 r $1_name;
#P newex 485 221 89 196617 sprintf set %s%s;
#P newex 358 221 110 196617 sprintf set %s%s/dec;
#P newex 231 221 108 196617 sprintf set %s%s/inc;
#P newex 104 221 114 196617 sprintf set %s%s/midi;
#P fasten 4 0 0 0 109 207 109 207;
#P connect 0 0 6 0;
#P connect 6 0 7 0;
#P fasten 4 0 5 0 109 142 213 142;
#P fasten 5 0 0 1 213 177 213 177;
#P fasten 4 0 1 0 109 207 236 207;
#P connect 1 0 8 0;
#P connect 8 0 9 0;
#P fasten 5 0 1 1 213 177 334 177;
#P fasten 4 0 2 0 109 207 363 207;
#P connect 2 0 10 0;
#P connect 10 0 11 0;
#P fasten 5 0 2 1 213 177 463 177;
#P fasten 4 0 3 0 109 207 490 207;
#P connect 3 0 12 0;
#P connect 12 0 13 0;
#P fasten 5 0 3 1 213 177 569 177;
#P pop;
...
#P connect 0 0 2 1;
#P pop;
#P newobj 66 600 84 196617 p freeze_display;
