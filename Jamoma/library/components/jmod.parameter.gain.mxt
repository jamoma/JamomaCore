...
#P pop;
#P newobj 150 275 78 196617 p remote_stuff;
#P newex 90 460 86 196617 r $1_pattr_bang;
#P window linecount 2;
#P comment 89 433 175 196617 Force output from pattr if jmod.cuelist queries current state.;
#P window linecount 1;
#P newex 141 556 86 196617 prepend $2/midi;
#P newex 141 578 150 196617 s $1_parameter;
#P newex 73 534 180 196617 jmod.freeze_display.mxt $1 $2/midi;
...
#P lcolor 2;
#P pop;
#P newobj 583 562 81 196617 p documentation;
#P newex 448 531 145 196617 patcherargs @description gain;
...
#P newex 448 463 137 196617 send $1_register;
#P message 448 422 224 196617 $2 \, $2/midi \, $2/inc \, $2/dec;
#P newex 448 400 140 196617 receive $1_query;
#P newex 73 563 59 196617 jmod.round;
#P comment 90 246 100 196617 Connect to GUI outlet;
#P comment 89 605 208 196617 Prepend "set" and connect to GUI inlet;
...
#P outlet 73 604 15 0;
#N comlet Connect to GUI outlet;
#P inlet 73 245 15 0;
#P newex 140 389 103 196617 loadmess -2000000.;
#P newex 73 389 64 196617 jmod.change;
#P newex 73 482 147 196617 pattr $2/midi @autorestore 0;
#X prestore 1 0 0;
#P objectname $2/midi;
#P newex 73 364 71 196617 jmod.line.mxt;
#P newex 218 321 27 196617 +;
...
#P window linecount 2;
#P comment 448 488 146 196617 Required for registering the messages as valid syntax.;
#P fasten 29 0 5 0 155 306 78 306;
#P connect 9 0 5 0;
#P fasten 4 0 5 0 223 345 78 345;
#P connect 5 0 7 0;
#P fasten 28 0 6 0 95 479 78 479;
#P connect 7 0 6 0;
#P connect 6 0 24 0;
#P connect 24 0 16 0;
#P connect 16 0 10 0;
#P connect 8 0 7 1;
#P fasten 6 0 5 1 78 519 297 519 297 359 139 359;
#P fasten 24 0 26 0 78 553 146 553;
#P connect 26 0 25 0;
#P connect 29 1 4 0;
#P fasten 6 0 4 1 78 522 403 522 403 316 240 316;
#P connect 17 0 18 0;
#P connect 18 0 19 0;
#P connect 22 1 23 0;
#P pop;
