{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 102.0, 229.0, 430.0, 388.0 ],
		"bglocked" : 0,
		"defrect" : [ 102.0, 229.0, 430.0, 388.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 204.0, 297.0, 104.0, 17.0 ],
					"text" : "regexp (.*\\\\/).*$"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 185.0, 257.0, 98.0, 17.0 ],
					"text" : "regexp (.*)(\\\\/.*)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 205.0, 277.0, 47.0, 17.0 ],
					"text" : "zl ecils 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 151.0, 326.0, 71.0, 17.0 ],
					"text" : "jamoma path"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 144.0, 183.0, 98.0, 17.0 ],
					"text" : "regexp (.*)(\\\\/.*)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 164.0, 203.0, 47.0, 17.0 ],
					"text" : "zl ecils 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 164.0, 224.0, 104.0, 17.0 ],
					"text" : "regexp (.*\\\\/).*$"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 44.0, 219.0, 63.0, 17.0 ],
					"text" : "library path"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 320.0, 25.0, 25.0 ]
				}
