{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 273.0, 44.0, 656.0, 603.0 ],
		"bglocked" : 0,
		"defrect" : [ 273.0, 44.0, 656.0, 603.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 58.0, 255.0, 222.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 38.0, 253.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 278.0, 61.0, 17.0 ],
					"presentation_rect" : [ 87.0, 265.0, 0.0, 0.0 ],
					"text" : "/active $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.0, 278.0, 40.0, 17.0 ],
					"text" : "/reset"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 21.0, 323.0, 91.0, 19.0 ],
					"text" : "jcom.autocrop%"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 119.0, 323.0, 60.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 21.0, 389.0, 207.0, 164.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 346.0, 262.0, 183.0, 128.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 47.5, 308.5, 30.5, 308.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 1 ],
					"hidden" : 0,
					"midpoints" : [ 317.5, 162.0, 335.0, 162.0, 335.0, 316.0, 102.5, 316.0 ],
					"source" : [ "obj-8", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 115.5, 308.5, 30.5, 308.5 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 30.5, 348.0, 30.5, 348.0 ],
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-14", 0 ],
					"hidden" : 0,
					"midpoints" : [ 102.5, 358.0, 30.5, 358.0 ],
					"source" : [ "obj-9", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 30.5, 369.0, 114.0, 369.0, 114.0, 320.0, 128.5, 320.0 ],
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 317.5, 249.0, 30.0, 249.0, 30.0, 276.0, 30.5, 276.0 ],
					"source" : [ "obj-7", 1 ]
				}
