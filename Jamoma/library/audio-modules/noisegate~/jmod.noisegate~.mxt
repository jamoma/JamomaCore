...
#P hidden newex 14 181 318 196617 jcom.parameter threshold @type msg_int @ramp linear.sched @repetitions 0 @range -90 24 @clipmode both @description "The threshold sets the level at which the Noise Gate opens and closes..";
#P objectname threshold;
#P window linecount 1;
#P comment 1 41 58 196617 Threshold;
#B frgb 172 172 172;
#P window linecount 3;
#P hidden newex 14 345 330 196617 jcom.parameter release @type msg_int @ramp linear.sched @repetitions 0 @range 0 1000 @clipmode both @description "When the gate closes\\\, this parameter sets how many milliseconds it will take to fade out.";
...
#B frgb 172 172 172;
#P window linecount 3;
#P hidden newex 14 265 323 196617 jcom.parameter attack @type msg_int @ramp linear.sched @repetitions 0 @range 0 1000 @clipmode low @description "When the gate opens\\\, this parameter sets how many milliseconds it will take to fade in.";
#P objectname attack;
#P window linecount 1;
...
#P window linecount 3;
#P hidden newex 14 98 304 196617 jcom.parameter lookahead @type msg_int @ramp linear.sched @repetitions 0 @range 0 100 @clipmode low @description "How many samples to look ahead while monitoring incoming signal.";
