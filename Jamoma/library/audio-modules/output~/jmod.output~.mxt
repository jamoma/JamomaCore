...
#P hidden newex 750 434 371 196617 jcom.parameter limiter/threshold @ramp linear.sched @range -24 48 @clipmode none @type msg_float @description "Limiter: Set threshold as dB.";
#P objectname limiter/threshold;
#P hidden newex 750 393 366 196617 jcom.parameter limiter/release @ramp linear.sched @type msg_float @range 0 3000 @clipmode low @description "Limiter: Set release time as ms.";
#P objectname limiter/release;
#P hidden newex 750 330 388 196617 jcom.parameter limiter/lookahead @ramp linear.sched @range 0 256 @clipmode both @type msg_int @description "Limiter: The number of samples to look ahead.";
#P objectname limiter/lookahead;
#P hidden newex 750 293 345 196617 jcom.parameter limiter/postamp @ramp linear.sched @range -24 48 @clipmode none @type msg_float @description "Limiter: Postamp as dB.";
#P objectname limiter/postamp;
#P hidden newex 750 255 332 196617 jcom.parameter limiter/preamp @ramp linear.sched @range 0 48 @clipmode none @type msg_float @description "Limiter: Preamp as dB.";
...
#P window linecount 2;
#P hidden newex 750 57 347 196617 jcom.parameter saturation/depth @ramp linear.sched @repetitions 0 @type msg_float @range 0 99 @clipmode both @description "Saturation: Depth.";
