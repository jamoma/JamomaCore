...
#P objectname mode;
#P hidden newex 67 561 317 196617 jcom.parameter release @type msg_float @range 0 500 @clipmode low @ramp linear.sched @description "The release time (ms).";
#P objectname release;
#P window linecount 3;
#P hidden newex 67 487 338 196617 jcom.parameter lookahead @type msg_int @range 0 256 @clipmode both @ramp linear.sched @repetitions 0 @description "The number of samples (up to 256) to look ahead into the signal to see what is coming.";
#P objectname lookahead;
#P hidden newex 67 401 445 196617 jcom.parameter threshold @type msg_float @range -48 6 @clipmode none @ramp linear.sched @description "The limiter threshold (in dB below full scale). When the input signal level exceeds this threshold\\\, it will be attenuated as necessary to keep the level below the threshold.";
#P objectname threshold;
#P window linecount 2;
#P hidden newex 67 339 374 196617 jcom.parameter postamp @type msg_float @range -6 48 @clipmode none @ramp linear.sched @description "The gain in dB applied to the signal after limiting. ";
#P objectname postamp;
#P hidden newex 67 274 373 196617 jcom.parameter preamp @type msg_float @range -6 48 @clipmode none @ramp linear.sched @description "The gain in dB applied to the signal before limiting.";
#P objectname preamp;
