	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 650.0, 145.0, 40.0, 19.0 ],
					"text" : "pink~"
				}
...
,
					"patching_rect" : [ 660.0, 425.0, 36.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 435.0, 630.0, 88.0, 19.0 ],
					"presentation_rect" : [ 436.0, 629.0, 0.0, 0.0 ],
					"text" : "receive~ sound"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 495.0, 240.0, 88.0, 19.0 ],
					"text" : "receive~ sound"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1085.0, 175.0, 76.0, 19.0 ],
					"text" : "send~ sound"
				}
...
,
					"patching_rect" : [ 1085.0, 150.0, 50.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Verdana",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 400.0, 305.0, 190.0, 85.0 ],
					"presentation_rect" : [ 499.0, 416.0, 0.0, 0.0 ],
					"setstyle" : 1,
					"signed" : 1,
					"size" : 22
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 80.0, 339.0, 53.0 ],
									"presentation_rect" : [ 302.0, 376.0, 0.0, 0.0 ],
...
,
					"patching_rect" : [ 555.0, 280.0, 36.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Verdana",
						"default_fontsize" : 10.0,
...
,
					"patching_rect" : [ 665.0, 345.0, 36.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Verdana",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 605.0, 425.0, 68.0, 19.0 ],
					"presentation_rect" : [ 576.0, 419.0, 0.0, 0.0 ],
					"text" : "zplane~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 605.0, 345.0, 68.0, 19.0 ],
					"presentation_rect" : [ 578.0, 345.0, 0.0, 0.0 ],
					"text" : "waveform~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 605.0, 265.0, 84.0, 19.0 ],
					"presentation_rect" : [ 582.0, 264.0, 0.0, 0.0 ],
					"text" : "textbutton"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 583.0, 236.0, 0.0, 0.0 ],
					"text" : "tab"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 605.0, 125.0, 84.0, 19.0 ],
					"presentation_rect" : [ 581.0, 126.0, 0.0, 0.0 ],
					"text" : "spectroscope~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 605.0, 90.0, 65.0, 19.0 ],
					"presentation_rect" : [ 579.0, 90.0, 0.0, 0.0 ],
					"text" : "scrollbar"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 315.0, 665.0, 65.0, 19.0 ],
					"presentation_rect" : [ 315.0, 664.0, 0.0, 0.0 ],
					"text" : "scope~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 315.0, 615.0, 65.0, 19.0 ],
					"presentation_rect" : [ 317.0, 615.0, 0.0, 0.0 ],
					"text" : "radiogroup"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 325.0, 405.0, 65.0, 19.0 ],
					"presentation_rect" : [ 326.0, 407.0, 0.0, 0.0 ],
					"text" : "nslider"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 325.0, 305.0, 65.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 325.0, 275.0, 65.0, 19.0 ],
					"presentation_rect" : [ 327.0, 275.0, 0.0, 0.0 ],
					"text" : "meter~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 325.0, 200.0, 65.0, 19.0 ],
					"presentation_rect" : [ 323.0, 251.0, 0.0, 0.0 ],
					"text" : "incdec"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 325.0, 230.0, 65.0, 19.0 ],
					"presentation_rect" : [ 327.0, 204.0, 0.0, 0.0 ],
					"text" : "jit.fpsui"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 90.0, 65.0, 19.0 ],
					"presentation_rect" : [ 322.0, 89.0, 0.0, 0.0 ],
					"text" : "function"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 705.0, 425.0, 256.0, 256.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 705.0, 125.0, 300.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "float", "", "", "bang" ],
					"patching_rect" : [ 400.0, 90.0, 160.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 400.0, 230.0, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 495.0, 405.0, 95.0, 86.0 ],
					"setstyle" : 1,
					"signed" : 1,
					"size" : 22
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 400.0, 405.0, 75.0, 198.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 705.0, 90.0, 200.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 615.0, 18.0, 34.0 ],
					"size" : 2,
					"value" : -1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 605.0, 295.0, 68.0, 19.0 ],
					"text" : "ubutton"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 705.0, 295.0, 100.0, 40.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 705.0, 345.0, 256.0, 64.0 ],
					"textcolor" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 400.0, 665.0, 160.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 400.0, 275.0, 80.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 705.0, 265.0, 100.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 705.0, 235.0, 200.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1085.0, 90.0, 61.0, 19.0 ],
					"text" : "zl group 3"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 1085.0, 65.0, 59.5, 19.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1085.0, 115.0, 67.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 5.0, 711.0, 0.0, 0.0 ],
					"text" : "umenu"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 6.0, 679.0, 0.0, 0.0 ],
					"text" : "toggle"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 6.0, 651.0, 0.0, 0.0 ],
					"text" : "textslider"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 5.0, 602.0, 0.0, 0.0 ],
					"text" : "textedit"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 5.0, 572.0, 0.0, 0.0 ],
					"text" : "slider"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 7.0, 536.0, 0.0, 0.0 ],
					"text" : "rslider"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 4.0, 503.0, 0.0, 0.0 ],
					"text" : "object"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 6.0, 429.0, 0.0, 0.0 ],
					"text" : "number~"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 7.0, 400.0, 0.0, 0.0 ],
					"text" : "number"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 6.0, 370.0, 0.0, 0.0 ],
					"text" : "message"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 4.0, 310.0, 0.0, 0.0 ],
					"text" : "flonum"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 5.0, 265.0, 0.0, 0.0 ],
					"text" : "ezdac~"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 4.0, 245.0, 0.0, 0.0 ],
					"text" : "ezadc~"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 7.0, 197.0, 0.0, 0.0 ],
					"text" : "dropfile"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 6.0, 131.0, 0.0, 0.0 ],
					"text" : "dial"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 3.0, 70.0, 0.0, 0.0 ],
					"text" : "button"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 3.0, 60.0, 0.0, 0.0 ],
					"text" : "comment"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 240.0, 44.0, 930.0, 692.0 ],
						"bglocked" : 0,
						"defrect" : [ 240.0, 44.0, 930.0, 692.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 155.0, 590.0, 140.0, 15.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 65.0, 590.0, 77.0, 19.0 ],
									"presentation_rect" : [ 65.0, 589.0, 0.0, 0.0 ],
									"text" : "jcom.meter~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 60.0, 425.0, 74.0, 19.0 ],
									"presentation_rect" : [ 597.0, 108.0, 0.0, 0.0 ],
									"text" : "itable"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 590.0, 601.0, 0.0, 0.0 ],
									"text" : "jit.scope"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 435.0, 390.0, 74.0, 19.0 ],
									"presentation_rect" : [ 592.0, 553.0, 0.0, 0.0 ],
									"text" : "led"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 60.0, 45.0, 74.0, 19.0 ],
									"text" : "ambimonitor"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 155.0, 45.0, 200.0, 200.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "bang" ],
									"patching_rect" : [ 155.0, 425.0, 160.0, 145.0 ],
									"range" : 128,
									"size" : 128,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 435.0, 425.0, 71.0, 19.0 ],
									"presentation_rect" : [ 82.0, 459.0, 0.0, 0.0 ],
									"text" : "levelmeter~"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 81.0, 398.0, 0.0, 0.0 ],
									"text" : "kslider"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 68.0, 190.0, 0.0, 0.0 ],
									"text" : "jit.cellblock"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 60.0, 395.0, 71.0, 19.0 ],
									"presentation_rect" : [ 68.0, 166.0, 0.0, 0.0 ],
									"text" : "Gswicth2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 60.0, 375.0, 71.0, 19.0 ],
									"presentation_rect" : [ 72.0, 146.0, 0.0, 0.0 ],
									"text" : "Gswitch"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 60.0, 260.0, 71.0, 19.0 ],
									"text" : "filtergraph~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 525.0, 425.0, 128.0, 64.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 525.0, 325.0, 336.0, 53.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 205.0, 375.0, 39.0, 32.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 155.0, 375.0, 41.0, 32.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 7,
									"outlettype" : [ "list", "float", "float", "float", "float", "list", "int" ],
									"patching_rect" : [ 155.0, 260.0, 160.0, 100.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 29.5, 52.0, 1094.5, 52.0 ],
					"source" : [ "obj-59", 0 ]
				}
