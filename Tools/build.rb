...
if win32?
	build_project("#{@svn_root}../DSP/library", "JamomaDSP.vcproj", configuration, true)
else
	build_project("#{@svn_root}../DSP/library", "JamomaDSP.xcodeproj", configuration, true)
	copydir("#{@svn_root}../DSP/library/build/UninstalledProducts/JamomaDSP.framework",   "/Library/Frameworks/JamomaDSP.framework")
end
...
if("#{configuration}" == "Development")
  ...
  copydir("#{@svn_root}../DSP/examples/#{src_folder}/tt.balance~#{extension}",   "#{@svn_root}Jamoma/library/externals/#{dst_folder}/tt.balance~#{extension}")
  copydir("#{@svn_root}../DSP/examples/#{src_folder}/tt.dcblock~#{extension}",   "#{@svn_root}Jamoma/library/externals/#{dst_folder}/tt.dcblock~#{extension}")
  copydir("#{@svn_root}../DSP/examples/#{src_folder}/tt.degrade~#{extension}",   "#{@svn_root}Jamoma/library/externals/#{dst_folder}/tt.degrade~#{extension}")
  copydir("#{@svn_root}../DSP/examples/#{src_folder}/tt.filter~#{extension}",    "#{@svn_root}Jamoma/library/externals/#{dst_folder}/tt.filter~#{extension}")
  copydir("#{@svn_root}../DSP/examples/#{src_folder}/tt.gain~#{extension}",      "#{@svn_root}Jamoma/library/externals/#{dst_folder}/tt.gain~#{extension}")
  copydir("#{@svn_root}../DSP/examples/#{src_folder}/tt.limiter~#{extension}",   "#{@svn_root}Jamoma/library/externals/#{dst_folder}/tt.limiter~#{extension}")
  copydir("#{@svn_root}../DSP/examples/#{src_folder}/tt.overdrive~#{extension}", "#{@svn_root}Jamoma/library/externals/#{dst_folder}/tt.overdrive~#{extension}")
  copydir("#{@svn_root}../DSP/examples/#{src_folder}/tt.ramp~#{extension}",      "#{@svn_root}Jamoma/library/externals/#{dst_folder}/tt.ramp~#{extension}")
  copydir("#{@svn_root}../DSP/examples/#{src_folder}/tt.wavetable~#{extension}", "#{@svn_root}Jamoma/library/externals/#{dst_folder}/tt.wavetable~#{extension}")
  copydir("#{@svn_root}../DSP/examples/#{src_folder}/tt.xfade~#{extension}",     "#{@svn_root}Jamoma/library/externals/#{dst_folder}/tt.xfade~#{extension}")
  copydir("#{@svn_root}../DSP/examples/#{src_folder}/tt.zerox~#{extension}",     "#{@svn_root}Jamoma/library/externals/#{dst_folder}/tt.zerox~#{extension}")
else
...
copydir("#{@svn_root}../DSP/examples/MaxMSP/tt.balance~/tt.balance~.maxhelp",     "#{@svn_root}Jamoma/documentation/jamoma-help/tt.balance~.maxhelp")
copydir("#{@svn_root}../DSP/examples/MaxMSP/tt.dcblock~/tt.dcblock~.maxhelp",     "#{@svn_root}Jamoma/documentation/jamoma-help/tt.dcblock~.maxhelp")
copydir("#{@svn_root}../DSP/examples/MaxMSP/tt.degrade~/tt.degrade~.maxhelp",     "#{@svn_root}Jamoma/documentation/jamoma-help/tt.degrade~.maxhelp")
copydir("#{@svn_root}../DSP/examples/MaxMSP/tt.filter~/tt.filter~.maxhelp",       "#{@svn_root}Jamoma/documentation/jamoma-help/tt.filter~.maxhelp")
copydir("#{@svn_root}../DSP/examples/MaxMSP/tt.gain~/tt.gain~.maxhelp",         "#{@svn_root}Jamoma/documentation/jamoma-help/tt.gain~.maxhelp")
copydir("#{@svn_root}../DSP/examples/MaxMSP/tt.limiter~/tt.limiter~.maxhelp",     "#{@svn_root}Jamoma/documentation/jamoma-help/tt.limiter~.maxhelp")
copydir("#{@svn_root}../DSP/examples/MaxMSP/tt.overdrive~/tt.overdrive~.maxhelp", "#{@svn_root}Jamoma/documentation/jamoma-help/tt.overdrive~.maxhelp")
copydir("#{@svn_root}../DSP/examples/MaxMSP/tt.ramp~/tt.ramp~.maxhelp",           "#{@svn_root}Jamoma/documentation/jamoma-help/tt.ramp~.maxhelp")
copydir("#{@svn_root}../DSP/examples/MaxMSP/tt.wavetable~/tt.wavetable~.maxhelp", "#{@svn_root}Jamoma/documentation/jamoma-help/tt.wavetable~.maxhelp")
copydir("#{@svn_root}../DSP/examples/MaxMSP/tt.xfade~/tt.xfade~.maxhelp",         "#{@svn_root}Jamoma/documentation/jamoma-help/tt.xfade~.maxhelp")
copydir("#{@svn_root}../DSP/examples/MaxMSP/tt.zerox~/tt.zerox~.maxhelp",         "#{@svn_root}Jamoma/documentation/jamoma-help/tt.zerox~.maxhelp")
puts ""
