{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 200.0, 189.0, 744.0, 601.0 ],
		"bglocked" : 0,
		"defrect" : [ 200.0, 189.0, 744.0, 601.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 580.0, 565.0, 85.0, 19.0 ],
					"text" : "jcom.window≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 580.0, 540.0, 98.0, 19.0 ],
					"text" : "jcom.wavetable≈"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 580.0, 515.0, 83.0, 19.0 ],
					"text" : "jcom.unpack≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 580.0, 490.0, 68.0, 19.0 ],
					"text" : "jcom.split≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 580.0, 465.0, 91.0, 19.0 ],
					"text" : "jcom.pulsesub≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 580.0, 440.0, 81.0, 19.0 ],
					"text" : "jcom.phasor≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 580.0, 415.0, 70.0, 19.0 ],
					"text" : "jcom.pack≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 580.0, 390.0, 59.0, 19.0 ],
					"text" : "jcom.op≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 580.0, 365.0, 73.0, 19.0 ],
					"text" : "jcom.noise≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 580.0, 340.0, 79.0, 19.0 ],
					"text" : "jcom.matrix≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 580.0, 315.0, 108.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 580.0, 290.0, 79.0, 19.0 ],
					"text" : "jcom.limiter≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 580.0, 240.0, 65.0, 19.0 ],
					"text" : "jcom.info≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 580.0, 40.0, 93.0, 19.0 ],
					"text" : "jcom.audiounit≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 580.0, 15.0, 64.0, 19.0 ],
					"text" : "jcom.adc≈"
				}
