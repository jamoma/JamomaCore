	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation_rect" : [ 353.0, 600.0, 0.0, 0.0 ],
					"text" : "Now Testing: $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 620.0, 40.0, 93.0, 19.0 ],
					"text" : "jcom.audiounit≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 22,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 160.0, 170.0, 373.0, 43.0 ],
					"text" : "route jbogus print button zl thispatcher trigger route prepend coll js ezdac~ comment counter delay qlim speedlim bangbang combine message gate number"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 523.5, 224.0, 169.5, 224.0 ],
					"source" : [ "obj-54", 21 ]
				}
