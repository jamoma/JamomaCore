...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "wrong" ],
									"patching_rect" : [ 491.0, 427.0, 43.0, 18.0 ],
									"text" : "t wrong"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "test.assert.equal Wildcard 1. @issue 52"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "test.assert.equal Wildcard 1 2 3 @issue 52"
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 578.0, 421.5, 500.5, 421.5 ],
									"source" : [ "obj-14", 3 ]
								}
