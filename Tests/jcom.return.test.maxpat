...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 1213.75, 129.0, 150.0, 19.0 ],
													"text" : "this crashes ATM"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 1221.75, 277.0, 50.0, 17.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 1131.75, 295.0, 247.0, 43.0 ],
													"text" : "test.assert.equal jcom.return:type:array:receiveTooLongArray 1 @issue 628"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 1213.75, 240.0, 88.0, 19.0 ],
													"text" : "zl 600 compare"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 1156.75, 187.0, 137.0, 43.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 1156.75, 157.0, 74.0, 19.0 ],
													"text" : "zl 600 group"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 1143.75, 116.0, 46.0, 19.0 ],
													"text" : "uzi 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 795.0, 280.0, 56.0, 29.0 ],
													"text" : "jamoma 1 2 3"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 905.0, 435.0, 53.0, 29.0 ],
													"text" : "jamoma 1 2 3"
												}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 225.0, 250.0, 50.0, 41.0 ],
...
, 															{
																"box" : 																{
																	...
																	"text" : "test.assert.equal jcom.return:method:float 0."
																}
...
, 															{
																"box" : 																{
																	...
																	"text" : "test.assert.equal jcom.return:method:float 1"
																}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 1175.0, 270.0, 50.0, 29.0 ],
													"text" : "5.7 1 2 4 abc"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 840.0, 275.0, 50.0, 41.0 ],
													"text" : "thisIsBadNumber"
												}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 375.0, 160.0, 34.0, 19.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 375.0, 110.0, 20.0, 20.0 ]
				}
