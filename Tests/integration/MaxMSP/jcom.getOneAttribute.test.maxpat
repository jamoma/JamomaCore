...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 108.0, 78.0, 129.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 93.0, 39.0, 34.0, 20.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 119.0, 178.0, 226.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 147.0, 68.0, 19.0 ],
					"text" : "loadmess 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 73.0, 178.0, 39.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 93.0, 218.0, 67.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 93.0, 108.0, 100.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 678.0, 304.0, 114.0, 87.0 ],
					"text" : "FAIL /view/size:value \"RECEIVED: mix/weight 1.0000\" \"EXPECTED: 300 140\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 499.0, 241.0, 293.0, 34.0 ],
					"text" : "jcom.test.assert.equal /view/size:value @input /input~/view/size @compareTo 300 140 @issue 1132"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 492.0, 13.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 334.0, 248.0, 155.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 34.5, 172.0, 82.5, 172.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../Max/library/components/getOneAttribute",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
