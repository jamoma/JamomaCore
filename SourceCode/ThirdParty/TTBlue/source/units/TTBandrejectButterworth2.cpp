...
TTErr TTBandRejectButterworth2::setFrequency(const TTAttribute&, const TTValue& newValue)
{
...
TTErr TTBandRejectButterworth2::setQ(const TTAttribute&, const TTValue& newValue)
{
	attrQ = newValue;
