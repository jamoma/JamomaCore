/* 
 * AudioUnitPlugin -- AudioUnit plug-in host
...
#define thisTTClass AudioUnitPlugin
...
class AudioUnitPlugin : public TTAudioObject {
public:
	...
	/**	Constructor. */
	AudioUnitPlugin(TTValue& arguments)
...
OSStatus TTAudioUnitGetInputSamples(void*						inRefCon,
									...
									AudioBufferList*			ioData)
{
	AudioUnitPlugin* ttAudioUnit = (AudioUnitPlugin*)inRefCon;
...
TT_AUDIO_CLASS_SETUP("audiounit", "audio, processor", AudioUnitPlugin);
