{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 484.0, 180.0, 888.0, 414.0 ],
		"bglocked" : 0,
		"defrect" : [ 484.0, 180.0, 888.0, 414.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "jcom.parameter #1 @type msg_float @range/bounds 0. 1. @range/clipmode both @ramp/drive scheduler @ramp/function linear @repetitions/allow 1 @description \"signal routing level\"",
					"linecount" : 2,
					"numinlets" : 1,
					"hidden" : 1,
					"id" : "obj-11",
					...
					"outlettype" : [ "", "", "" ],
					"fontsize" : 9.0,
					"patching_rect" : [ 295.0, 250.0, 395.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "patcherargs name @size 50 14 @frgb 255 255 255 @brgb 0 0 0 @rgb2 111 111 111 @range 0. 1.",
					"linecount" : 2,
					"numinlets" : 1,
					"hidden" : 1,
					"id" : "obj-2",
					...
					"outlettype" : [ "", "" ],
					"fontsize" : 10.0,
					"patching_rect" : [ 305.0, 20.0, 306.0, 31.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 913.0, 506.0, 341.0, 272.0 ],
						"bglocked" : 0,
						"defrect" : [ 913.0, 506.0, 341.0, 272.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"id" : "obj-1",
									"numoutlets" : 0,
									"patching_rect" : [ 165.0, 170.0, 15.0, 15.0 ],
									"comment" : ""
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"fontsize" : 9.873845,
									"patching_rect" : [ 210.0, 75.0, 51.0, 18.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"fontsize" : 9.873845,
									"patching_rect" : [ 210.0, 40.0, 64.0, 18.0 ]
								}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-6", 0 ],
					"hidden" : 1,
					"midpoints" : [ 304.5, 288.0, 248.0, 288.0, 248.0, 69.0, 269.5, 69.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"hidden" : 1,
					"midpoints" : [ 601.5, 66.0, 345.0, 66.0, 345.0, 72.0, 344.5, 72.0 ]
				}
