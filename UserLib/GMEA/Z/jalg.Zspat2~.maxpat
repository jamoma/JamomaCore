{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 143.0, 125.0, 1073.0, 530.0 ],
		"bglocked" : 0,
		"defrect" : [ 143.0, 125.0, 1073.0, 530.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numoutlets" : 1,
					"patching_rect" : [ 530.0, 183.0, 35.0, 17.0 ],
					"outlettype" : [ "list" ],
					"fontname" : "Arial",
					"id" : "obj-23",
					"patcher" : 					{
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numoutlets" : 9,
					"patching_rect" : [ 319.0, 211.0, 183.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numoutlets" : 2,
					"patching_rect" : [ 383.0, 160.0, 75.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 4,
					"patching_rect" : [ 318.0, 184.0, 182.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numoutlets" : 0,
					"patching_rect" : [ 390.0, 316.0, 36.0, 17.0 ],
					"fontname" : "Arial",
					"id" : "obj-20",
					"saved_object_attributes" : 					{
						"attr_comment" : ""
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numoutlets" : 0,
					"patching_rect" : [ 352.0, 316.0, 36.0, 17.0 ],
					"fontname" : "Arial",
					"id" : "obj-19",
					"saved_object_attributes" : 					{
						"attr_comment" : ""
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numoutlets" : 0,
					"patching_rect" : [ 314.0, 316.0, 36.0, 17.0 ],
					"fontname" : "Arial",
					"id" : "obj-18",
					"saved_object_attributes" : 					{
						"attr_comment" : ""
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numoutlets" : 0,
					"patching_rect" : [ 276.0, 316.0, 36.0, 17.0 ],
					"fontname" : "Arial",
					"id" : "obj-17",
					"saved_object_attributes" : 					{
						"attr_comment" : ""
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numoutlets" : 0,
					"patching_rect" : [ 238.0, 316.0, 36.0, 17.0 ],
					"fontname" : "Arial",
					"id" : "obj-16",
					"saved_object_attributes" : 					{
						"attr_comment" : ""
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numoutlets" : 0,
					"patching_rect" : [ 200.0, 316.0, 36.0, 17.0 ],
					"fontname" : "Arial",
					"id" : "obj-15",
					"saved_object_attributes" : 					{
						"attr_comment" : ""
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numoutlets" : 0,
					"patching_rect" : [ 162.0, 316.0, 36.0, 17.0 ],
					"fontname" : "Arial",
					"id" : "obj-14",
					"saved_object_attributes" : 					{
						"attr_comment" : ""
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jcom.oscroute /volume /mode /position /output /aux.1 /aux.2 /position2",
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 8,
					"patching_rect" : [ 84.0, 74.0, 407.0, 20.0 ],
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"fontname" : "Arial",
					"id" : "obj-4"
				}
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"fontsize" : 9.0,
									"numoutlets" : 0,
									"patching_rect" : [ 432.0, 82.0, 50.0, 17.0 ],
									"fontname" : "Arial",
									"id" : "obj-54",
									"patcher" : 									{
										"fileversion" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "jcom.oscroute /x /y /rd /sps /time_ambitus",
									"numinlets" : 1,
									"fontsize" : 12.0,
									"numoutlets" : 6,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 492.5, 180.0, 490.5, 180.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-24", 0 ],
					"hidden" : 0,
					"midpoints" : [ 539.5, 205.0, 328.5, 205.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-10", 0 ],
					"hidden" : 0,
					"midpoints" : [ 315.214294, 100.0, 949.5, 100.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-11", 0 ],
					"hidden" : 0,
					"midpoints" : [ 370.642853, 99.0, 1015.5, 99.0 ]
				}
