{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 21.0, 116.0, 1152.0, 620.0 ],
		"bglocked" : 0,
		"defrect" : [ 21.0, 116.0, 1152.0, 620.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 564.0, 280.0, 401.0, 38.0 ],
					"text" : "jcom.parameter sf/pitch @type msg_float @range/bounds 0. 20. @range/clipmode both @repetitions/allow 0 @ramp/drive scheduler @description \"Select audio sample pitch.\" @priority 35",
					"varname" : "pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 386.0, 158.0, 166.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.0, 136.0, 117.0, 17.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 994.0, 258.0, 422.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 994.0, 354.0, 36.0, 36.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 994.0, 314.0, 107.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"id" : "obj-5",
					"items" : [ "anton.aif", ",", "cello-f2.aif", ",", "cherokee.aif", ",", "Copie de solopeltetmarto2.wav", ",", "drumLoop.aif", ",", "ica loulegerfadesolo.wav", ",", "jongly.aif", ",", "rainstick.aif", ",", "sho0630.aif", ",", "vibes-a1.aif" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 188.0, 408.0, 100.0, 17.0 ],
					"prefix" : "C:/Documents and Settings/niko/Mes documents/lpb/",
					"prefix_mode" : 2,
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 384.0, 114.0, 117.0, 17.0 ],
					"text" : "conformpath slash boot"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 994.0, 294.0, 56.0, 19.0 ],
					"text" : "route set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 994.0, 334.0, 70.0, 19.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 396.0, 184.0, 613.0, 28.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 328.0, 606.0, 114.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 776.0, 540.0, 428.0, 27.0 ],
					"text" : "jcom.parameter sf/rampmode @type msg_int @repetitions/allow 1 @description \"Enveloppe mode : cut, fadein, fadeout\" @priority 32",
					"varname" : "loop[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 994.0, 237.0, 107.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 123.0, 45.0, 118.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-68", 0 ],
					"hidden" : 0,
					"midpoints" : [ 129.5, 411.0, 120.0, 411.0, 120.0, 609.0, 337.5, 609.0 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"hidden" : 0,
					"midpoints" : [ 1003.5, 398.0, 979.0, 398.0, 979.0, 233.0, 1003.5, 233.0 ],
					"source" : [ "obj-45", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-68", 0 ],
					"hidden" : 0,
					"midpoints" : [ 509.5, 535.0, 619.0, 535.0, 619.0, 535.0, 706.0, 535.0, 706.0, 581.0, 337.5, 581.0 ],
					"source" : [ "obj-65", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 785.5, 572.0, 762.0, 572.0, 762.0, 513.0, 785.5, 513.0 ],
					"source" : [ "obj-76", 0 ]
				}
