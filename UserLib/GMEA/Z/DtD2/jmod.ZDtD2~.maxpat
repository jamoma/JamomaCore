{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 98.0, 44.0, 1249.0, 749.0 ],
		"bglocked" : 0,
		"defrect" : [ 98.0, 44.0, 1249.0, 749.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 180.0, 37.0, 20.0, 20.0 ],
					"size" : 202.0
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"id" : "obj-5",
					"items" : [ "10 Chute Du Mur De Berlin.aiff", ",", "11 1970 La Mort Du Général.aiff", ",", "11 Allocution De Francois Mitterand / La Guerre Du Golfe.aiff", ",", "13 Jacques Chirac Président De La République.aiff", ",", "14 Les Sans Papiers.aiff", ",", "15 Jean-Paul II Les Journées Mondiales De La Jeunesse.aiff", ",", "17 La Coupe De Monde De Football.aiff", ",", "2 Khomeiny À Téhéran / La Révolution Islamique.aiff", ",", "3 Déclaration De Valéry Giscard d'Estaing Après L'échec Du Premier Essai De La Fusée Ariane.aiff", ",", "9 1969 On Marche Sur La Lune….aiff" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 195.0, 400.0, 100.0, 17.0 ],
					"prefix" : "Servo:/Users/pascalbaltazar/Music/sons/CDs_samples/JOD-radio_CD6/",
					"prefix_mode" : 2,
					"presentation" : 1,
