{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 469.0, 71.0, 545.0, 314.0 ],
		"bglocked" : 0,
		"defrect" : [ 469.0, 71.0, 545.0, 314.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "jcom.oscroute /volume /mode /position /output /aux.1 /aux.2 /time_ambitus",
					"numinlets" : 1,
					"fontsize" : 12.0,
					"numoutlets" : 8,
					"patching_rect" : [ 86.0, 74.0, 417.0, 20.0 ],
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"fontname" : "Arial",
					"id" : "obj-4"
				}
