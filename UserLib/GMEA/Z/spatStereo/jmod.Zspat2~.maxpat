...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter record/active @type msg_toggle @description \"record to a sound file\"",
					"varname" : "record"
				}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.parameter position2/x @type msg_float @range/bounds -1. 1.@ramp/drive scheduler @description \"x-axis position\" @priority 34 @repetitions/allow 1",
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.parameter position2/y @type msg_float @range/bounds -1. 1. @ramp/drive scheduler @description \"y-axis position\" @priority 33",
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.message position2/dist @type msg_float @range/bounds 0 1.5 @ramp/drive scheduler @description \"Polar coordinate position : distance \" @repetitions/allow 1",
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.message position2/angle @type msg_float @ramp/drive scheduler @description \"Polar coordinate position : angle\" @repetitions/allow 1",
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter timeambitus/max @type msg_int @range/bounds 0 2000 @description \"Ambitus speed for mooving algo\" @repetitions/allow 1",
...
,
									...
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 108.0, 264.0, 446.0, 27.0 ],
									"text" : "jcom.parameter position/x @type msg_float @range/bounds -1. 1.@ramp/drive scheduler @description \"x-axis position\" @priority 34 @repetitions/allow 1",
									"varname" : "jmod.parameter.mxb[18]"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 174.0, 224.0, 459.0, 27.0 ],
									"text" : "jcom.parameter position/y @type msg_float @range/bounds -1. 1. @ramp/drive scheduler @description \"y-axis position\" @priority 33 @repetitions/allow 1",
									"varname" : "jmod.parameter.mxb[1]"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.message position/dist @type msg_float @range/bounds 0 1.5 @ramp/drive scheduler @description \"Polar coordinate position : distance \" @repetitions/allow 1",
									"varname" : "jmod.parameter.mxb[4]"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "jcom.message position/angle @type msg_float @ramp/drive scheduler @description \"Polar coordinate position : angle\" @repetitions/allow 1",
									"varname" : "jmod.parameter.mxb[5]"
								}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter timeambitus/min @type msg_int @range/bounds 0 2000 @description \"Ambitus speed for mooving algo\" @repetitions/allow 1",
