{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 150.0, 70.0, 300.0, 70.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
		"bglocked" : 0,
		"defrect" : [ 345.0, 44.0, 1024.0, 789.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 289.0, 642.0, 117.5, 20.0 ],
					"text" : "jcom.multi.in~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 358.0, 728.0, 95.0, 5.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 358.0, 736.0, 95.0, 5.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 341.0, 708.0, 95.0, 5.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 341.0, 716.0, 95.0, 5.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1267.0, 244.0, 151.0, 92.0 ],
					"text" : "jcom.parameter balance/range @type msg_float @range/bounds -1 1 @range/clipmode both @ramp/drive scheduler @description \"Balance of the stereo signal\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 992.0, 219.0, 128.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 994.0, 362.0, 120.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1163.0, 248.0, 19.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1155.0, 299.0, 19.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1211.0, 319.0, 19.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1240.0, 296.0, 19.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1232.0, 247.0, 19.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 278.062653, 23.156057, 19.0, 19.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1206.0, 240.0, 19.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1159.0, 253.0, 24.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1160.0, 296.0, 24.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1197.0, 316.0, 24.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1232.0, 296.0, 24.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1233.0, 256.0, 24.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1195.0, 234.0, 24.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1156.0, 243.0, 97.0, 92.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 472.0, 600.0, 149.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter pause @type msg_toggle @repetitions/allow 1 @description \"Play current sound.\" @priority 36",
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter play @type msg_toggle @repetitions/allow 1 @description \"Play current sound.\" @priority 36",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 993.0, 237.0, 145.0, 104.0 ],
					"text" : "jcom.parameter balance/angle @type msg_float @range/bounds -180 180 @range/clipmode both @ramp/drive scheduler @description \"Balance of the stereo signal\""
				}
...
, 			{
				"box" : 				{
					...
					"orientation" : 0,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 509.0, 660.0, 110.0, 10.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"id" : "obj-5",
					"items" : "poules_montage.wav",
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 195.0, 400.0, 100.0, 17.0 ],
					"prefix" : "Servo:/Users/pascalbaltazar/Music/multimicro/entrelacés/",
					"prefix_mode" : 2,
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 994.0, 338.0, 56.0, 19.0 ],
					"text" : "route set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 994.0, 386.0, 70.0, 19.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 289.0, 672.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter loopmode @type msg_toggle @repetitions/allow 0 @description \"Select the loopmode the file should be played (one shot or looped).\" @priority 34",
					"varname" : "loop"
				}
