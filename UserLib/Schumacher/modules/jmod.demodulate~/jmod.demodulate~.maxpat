{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 162.0, 206.0, 1039.0, 521.0 ],
		"bglocked" : 0,
		"defrect" : [ 162.0, 206.0, 1039.0, 521.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 672.0, 237.0, 45.0, 19.0 ],
					"text" : "mute~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 575.0, 283.0, 99.0, 19.0 ],
					"text" : "Demodulators #0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 64.0, 322.0, 90.0, 19.0 ],
					"text" : "s #0.calibration"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 1213.0, 240.0, 390.0, 303.0 ],
						"bglocked" : 0,
						"defrect" : [ 1213.0, 240.0, 390.0, 303.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 76.0, 9.0, 89.0, 19.0 ],
									"text" : "r #0.calibration"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 76.0, 31.0, 182.0, 19.0 ],
									"text" : "jcom.oscroute /numDemodulators"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 109.0, 62.0, 74.0, 20.0 ],
									"text" : "prepend set"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 85.0, 197.0, 51.0, 20.0 ],
									"text" : "append"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 85.0, 140.0, 266.0, 20.0 ],
									"text" : "combine /demodulator. int /calibrate @triggers 1"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 1 ],
									"hidden" : 0,
									"midpoints" : [ 46.5, 104.5, 218.0, 104.5 ],
									"source" : [ "obj-28", 2 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"hidden" : 0,
									"midpoints" : [ 118.5, 190.0, 94.5, 190.0 ],
									"source" : [ "obj-7", 0 ]
								}
...
,
					"patching_rect" : [ 4.0, 102.0, 43.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 147.0, 61.0, 18.0 ],
									"text" : "enable $1"
								}
...
,
					"patching_rect" : [ 87.0, 138.0, 19.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"fontname" : "Arial",
						"default_fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"id" : "obj-26",
					"maxclass" : "bpatcher",
					"name" : "spextrogram.maxpat",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 87.0, 21.0, 213.0, 49.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 105.0, 20.0, 192.0, 47.0 ]
				}
...
,
					"patching_rect" : [ 801.0, 115.0, 73.0, 24.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"fontname" : "Arial",
						"default_fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 498.0, 359.0, 459.0, 19.0 ],
					"text" : "jcom.out~ 32"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 498.104614, 383.437622, 445.258148, 19.0 ],
					"text" : "jcom.multi.in~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 497.77832, 405.189056, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "", "" ],
					"patching_rect" : [ 474.0, 189.0, 66.0, 19.0 ],
					"text" : "jcom.in~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 474.0, 153.0, 21.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 47.0, 99.0, 19.0 ],
					"text" : "Calibrate all",
					"texton" : "Calibrating"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 73.0, 23.0, 29.0, 17.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 32,
					"outlettype" : [ "signal", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 498.0, 335.0, 459.5, 19.0 ],
					"text" : "jalg.demodulate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 218.0, 153.0, 157.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 21.0, 224.0, 285.0, 31.0 ],
					"text" : "jcom.hub @module_type audio.control @description \"Demodulate AM-control-signals in an audio channel\"",
					"varname" : "jcom.hub"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 575.0, 255.0, 49.0, 19.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "open" ],
					"patching_rect" : [ 575.0, 231.0, 41.0, 19.0 ],
					"text" : "t open"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 25.0, 58.0, 28.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 23.0, 78.0, 17.0 ],
					"text" : "Demodulators:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 87.0, 160.0, 51.0, 19.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 712.0, 276.5, 584.5, 276.5 ],
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 13.5, 211.0, 30.5, 211.0 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"hidden" : 0,
					"midpoints" : [ 227.5, 211.0, 30.5, 211.0 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 483.5, 326.0, 948.0, 326.0 ],
					"source" : [ "obj-34", 0 ]
				}
