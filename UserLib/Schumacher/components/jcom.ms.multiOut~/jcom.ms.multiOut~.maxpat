{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 525.0, 248.0, 1155.0, 352.0 ],
		"bglocked" : 0,
		"defrect" : [ 525.0, 248.0, 1155.0, 352.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 65.0, 189.0, 38.0, 19.0 ],
					"text" : "zl rev"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 157.0, 289.0, 19.0 ],
					"text" : "-> this is 'downward' compatible with jcom.multi.out~\n"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 65.0, 167.0, 54.0, 19.0 ],
					"text" : "zl ecils 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 65.0, 145.0, 38.0, 19.0 ],
					"text" : "zl rev"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 35.0, 32.0, 131.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 65.0, 120.0, 139.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 80.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 132.0, 242.0, 39.0, 19.0 ],
					"text" : "offset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 823.0, 230.0, 238.0, 31.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"hidden" : 0,
					"midpoints" : [ 239.5, 237.5, 121.5, 237.5 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 74.5, 212.0, 1069.5, 212.0 ],
					"source" : [ "obj-61", 0 ]
				}
