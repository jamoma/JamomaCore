{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 276.0, 67.0, 1004.0, 573.0 ],
		"bglocked" : 0,
		"defrect" : [ 276.0, 67.0, 1004.0, 573.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 273.0, 39.0, 17.0 ],
					"text" : "mute~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 556.0, 80.0, 331.0, 28.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 468.0, 392.0, 13.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 468.0, 327.0, 13.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 556.0, 217.0, 328.0, 28.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.0, 139.0, 63.0, 17.0 ],
					"text" : "pvar Voices"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 556.0, 164.0, 350.0, 39.0 ],
					"text" : "jcom.parameter voices @type msg_int @ramp 0 @repetitions 0 @range 1 16 @clipmode both @description \"The number of audio channels that the ambisonic signal is diffused to. Changes only take effect when audio is off.\"",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 453.0, 74.0, 26.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 420.0, 311.0, 155.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 485.0, 392.0, 146.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 0.0, 140.0, 295.0, 39.0 ],
					"text" : "jcom.hub spat.jmod.sur.air~ @size 1U-half @module_type audio.no_panel @description \"Filter voices depending on distance to simulate air absorption\"",
					"varname" : "jalg.hub"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 565.5, 209.0, 551.0, 209.0, 551.0, 132.0, 565.5, 132.0 ],
					"source" : [ "obj-21", 0 ]
				}
