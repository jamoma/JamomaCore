{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 385.0, 103.0, 817.0, 603.0 ],
		"bglocked" : 0,
		"defrect" : [ 385.0, 103.0, 817.0, 603.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 632.0, 145.0, 604.0, 456.0 ],
						"bglocked" : 0,
						"defrect" : [ 632.0, 145.0, 604.0, 456.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 43.0, 73.0, 41.0, 19.0 ],
									"text" : "zl join"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 65.0, 116.0, 41.0, 19.0 ],
									"text" : "zl join"
								}
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 639.0, 304.0, 600.0, 426.0 ],
										"bglocked" : 0,
										"defrect" : [ 639.0, 304.0, 600.0, 426.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 99.0, 375.0, 49.0, 17.0 ],
									"text" : "deferlow"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 42.0, 140.0, 108.0, 19.0 ],
									"text" : "route /bird/position"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 99.0, 396.0, 142.0, 15.0 ],
									"text" : "xyz 55 0. 0. 0., rename 55 X"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 103.0, 355.0, 56.0, 19.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 42.0, 192.0, 54.0, 19.0 ],
									"text" : "zl slice 4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 42.0, 42.0, 97.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 183.0, 48.0, 345.0, 19.0 ],
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 446.5, 351.5, 51.0, 351.5 ],
									"source" : [ "obj-12", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"hidden" : 0,
									"midpoints" : [ 546.0, 205.0, 167.5, 205.0 ],
									"source" : [ "obj-9", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.0, 215.0, 186.0, 17.0 ],
					"text" : "/attractpoint -0.353125 0.415 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 208.0, 214.0, 112.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 327.0, 235.0, 106.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 343.0, 212.0, 50.0, 17.0 ],
					"text" : "/update"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 576.0, 36.0, 71.0, 19.0 ],
					"text" : "loadmess 1."
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 51.0, 70.0, 95.0, 17.0 ],
									"text" : "vexpr ($f1-0.5)*2."
								}
...
,
					"patching_rect" : [ 9.0, 190.0, 108.0, 19.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"fontsize" : 10.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 9.0, 167.0, 197.0, 19.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"hidden" : 0,
					"midpoints" : [ 352.5, 232.0, 18.5, 232.0 ],
					"source" : [ "obj-3", 0 ]
				}
