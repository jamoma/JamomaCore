{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 327.0, 178.0, 712.0, 469.0 ],
		"bglocked" : 0,
		"defrect" : [ 327.0, 178.0, 712.0, 469.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 561.0, 213.0, 46.0, 18.0 ],
					"text" : "/play 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 561.0, 152.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 385.0, 184.0, 195.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 202.0, 212.0, 60.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 147.0, 213.0, 51.0, 16.001465 ],
					"presentation_rect" : [ 147.0, 213.0, 51.0, 16.001465 ],
					"text" : [ "_($1 size)" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 534.0, 400.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 704.0, 184.0, 564.0, 323.0 ],
						"bglocked" : 0,
						"defrect" : [ 704.0, 184.0, 564.0, 323.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 445.0, 170.0, 26.0, 15.0 ],
									"text" : "loop"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 445.0, 153.0, 33.0, 15.0 ],
									"text" : "locate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 445.0, 135.0, 29.0, 15.0 ],
									"text" : "next"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 8,
									"outlettype" : [ "", "", "", "", "", "", "", "" ],
									"patching_rect" : [ 40.0, 81.0, 420.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 442.0, 106.0, 138.0, 27.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 127.0, 81.0, 83.083992, 16.001465 ],
									"presentation_rect" : [ 127.0, 81.0, 83.083992, 16.001465 ],
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 188.5, 128.0, 384.0, 128.0, 384.0, 286.0, 318.617188, 286.0 ],
									"source" : [ "obj-24", 1 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 11.0, 81.0, 304.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 385.0, 213.0, 59.0, 18.0 ],
					"text" : "/playoff 0"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"hidden" : 0,
					"midpoints" : [ 394.5, 327.5, 20.5, 327.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"hidden" : 0,
					"midpoints" : [ 210.5, 103.5, 570.5, 103.5 ],
					"source" : [ "obj-12", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 570.5, 237.0, 614.5, 237.0, 614.5, 117.0, 309.5, 117.0 ],
					"source" : [ "obj-32", 0 ]
				}
