{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 286.0, 44.0, 994.0, 506.0 ],
		"bglocked" : 0,
		"defrect" : [ 286.0, 44.0, 994.0, 506.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 326.0, 243.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 183.0, 368.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 148.0, 338.0, 89.0, 19.0 ],
					"text" : "jcom.out~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "signal", "", "" ],
					"patching_rect" : [ 167.0, 271.0, 179.0, 19.0 ],
					"text" : "jcom.in~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 268.0, 416.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 237.0, 46.0, 50.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 46.0, 121.0, 31.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 107.0, 45.0, 125.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 267.0, 358.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 237.0, 21.0, 50.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 190.0, 24.0, 60.0, 31.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 148.0, 23.0, 65.0, 19.0 ],
					"text" : "Response:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 274.0, 314.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 56.0, 38.0, 50.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 20.0, 83.0, 31.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 5.0, 20.0, 84.0, 31.0 ],
					"text" : "Samplesize in analysis:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 167.0, 241.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 108.0, 304.0, 131.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 148.0, 368.0, 20.0, 20.0 ]
				}
