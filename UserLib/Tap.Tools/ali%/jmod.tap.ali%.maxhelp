	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.0, 373.0, 600.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 505.0, 57.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 90.0, 127.0, 15.0 ],
					"text" : "/position 1. 1. ramp 2000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.0, 448.0, 600.0, 70.0 ],
					"presentation_rect" : [ 0.0, 0.0, 600.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 499.0, 240.0, 300.0, 70.0 ],
					"presentation_rect" : [ 60.0, 60.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 330.0, 251.0, 19.0 ],
					"text" : "unnecessary output values can be disabled e.g. "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 501.0, 156.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 62.0, 261.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 48.0, 174.0, 61.0, 19.0 ],
									"text" : "unpack f f"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 105.0, 227.0, 35.0, 19.0 ],
									"text" : "* -1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 73.0, 320.0, 89.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 80.0, 262.0, 48.0, 19.0 ],
									"text" : "pack f f"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 43.0, 27.0, 335.0, 60.0 ],
					"rounded" : 15
				}
...
, 			{
				"box" : 				{
					...
					"onscreen" : 0,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 348.0, 134.0, 128.0, 128.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"hidden" : 0,
					"midpoints" : [ 442.5, 287.0, 482.5, 287.0, 482.5, 125.0, 51.5, 125.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 332.5, 204.0, 344.5, 204.0, 344.5, 131.0, 357.5, 131.0 ],
					"source" : [ "obj-13", 1 ]
				}
