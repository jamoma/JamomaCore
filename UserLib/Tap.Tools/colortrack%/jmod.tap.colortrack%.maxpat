{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 243.0, 44.0, 579.0, 524.0 ],
		"bglocked" : 0,
		"defrect" : [ 243.0, 44.0, 579.0, 524.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 91.0, 44.0, 843.0, 302.0 ],
						"bglocked" : 0,
						"defrect" : [ 91.0, 44.0, 843.0, 302.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 100.0, 319.0, 15.0, 15.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 533.0, 195.0, 600.0, 426.0 ],
										"bglocked" : 0,
										"defrect" : [ 533.0, 195.0, 600.0, 426.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 45.0, 86.0, 59.0, 19.0 ],
													"text" : "route dim"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 55.0, 24.0, 15.0, 15.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 46.0, 132.0, 99.0, 19.0 ],
													"text" : "unpack 320. 240."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 45.0, 107.0, 58.0, 19.0 ],
													"text" : "zl change"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 47.0, 65.0, 76.0, 19.0 ],
													"text" : "jit.matrixinfo"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 5,
													"outlettype" : [ "", "", "", "", "" ],
													"patching_rect" : [ 228.0, 39.0, 202.0, 17.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 171.0, 97.0, 212.0, 17.0 ],
													"text" : "switch 4 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 482.0, 19.0, 15.0, 15.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 228.0, 19.0, 15.0, 15.0 ]
												}
...
, 											{
												"patchline" : 												{
													...
													"hidden" : 0,
													"midpoints" : [ 491.0, 93.0, 180.5, 93.0 ],
													"source" : [ "obj-12", 0 ]
												}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 41.0, 393.0, 187.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "nogrow", "close", "zoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 2, 2, 32768, 32768, ";", "#Q", "window", "size", 91, 44, 934, 346, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ],
									"text" : "thispatcher"
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 8.5, 334.5, 66.5, 334.5 ],
									"source" : [ "obj-28", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 19.0, 154.0, 397.0, 17.0 ],
					"text" : "jcom.hub @module_type video @description \"A fast colortracker made by Tap.Tools\"",
					"varname" : "jmod.hub"
				}
