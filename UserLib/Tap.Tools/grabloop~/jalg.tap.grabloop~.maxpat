{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 413.0, 159.0, 689.0, 363.0 ],
		"bglocked" : 0,
		"defrect" : [ 413.0, 159.0, 689.0, 363.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 14.0, 95.0, 37.0, 19.0 ],
					"text" : "* 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 15.0, 73.0, 32.5, 19.0 ],
					"text" : "+ 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 85.0, 95.0, 34.0, 19.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 101.0, 120.0, 115.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 84.0, 72.0, 34.0, 19.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 151.0, 74.0, 347.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 15.0, 50.0, 154.0, 19.0 ],
					"text" : "jcom.oscroute /pan /capture"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 94.5, 151.0, 264.5, 151.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"hidden" : 0,
					"midpoints" : [ 110.5, 151.5, 264.5, 151.5 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"hidden" : 0,
					"midpoints" : [ 406.5, 135.0, 264.5, 135.0 ],
					"source" : [ "obj-4", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"hidden" : 0,
					"midpoints" : [ 488.5, 132.0, 264.5, 132.0 ],
					"source" : [ "obj-4", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-13", 0 ],
					"hidden" : 0,
					"midpoints" : [ 242.5, 132.5, 264.5, 132.5 ],
					"source" : [ "obj-4", 1 ]
				}
