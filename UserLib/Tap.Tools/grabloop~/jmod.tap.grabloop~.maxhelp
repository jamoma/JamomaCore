{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 353.0, 161.0, 749.0, 440.0 ],
		"bgcolor" : [ 0.137255, 0.137255, 0.137255, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 353.0, 161.0, 749.0, 440.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 251.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "jmod.tap.grabloop~.maxpat",
					"numinlets" : 2,
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 315.0, 173.0, 300.0, 70.0 ],
