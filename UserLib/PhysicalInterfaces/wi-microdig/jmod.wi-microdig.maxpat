{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 311.0, 115.0, 716.0, 482.0 ],
		"bglocked" : 0,
		"defrect" : [ 311.0, 115.0, 716.0, 482.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 416.0, 260.0, 50.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 120.0, 45.0, 61.0, 19.0 ],
					"rounded" : 8.0,
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 16.0, 116.0, 578.0, 18.0 ],
					"text" : "jcom.hub @module_type control @description \"A module interfacing with the wi-microDig from Infusion Systems\"",
					"varname" : "jcom.hub"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 231.0, 292.0, 124.5, 16.0 ],
					"text" : "/reset"
				}
