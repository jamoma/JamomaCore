{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 9.0, 44.0, 1157.0, 633.0 ],
		"bglocked" : 0,
		"defrect" : [ 9.0, 44.0, 1157.0, 633.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 911.0, 102.0, 32.5, 18.0 ],
					"presentation_rect" : [ 866.0, 178.0, 0.0, 0.0 ],
					"text" : "4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 872.0, 102.0, 32.5, 18.0 ],
					"presentation_rect" : [ 824.0, 176.0, 0.0, 0.0 ],
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 838.0, 102.0, 32.5, 18.0 ],
					"presentation_rect" : [ 790.0, 177.0, 0.0, 0.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 801.0, 102.0, 32.5, 18.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 799.0, 48.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 801.0, 132.0, 47.0, 18.0 ],
					"presentation_rect" : [ 745.0, 166.0, 0.0, 0.0 ],
					"text" : "/led $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 799.0, 72.0, 76.0, 18.0 ],
					"presentation_rect" : [ 745.0, 126.0, 0.0, 0.0 ],
					"text" : "/vibration $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 69.0, 502.0, 75.0 ],
					"text" : "USAGE\n1. Setup (Pairing) Wii Remote for use with your computer using \"Bluetooth Setup Assistant.\"\n2. Push \"Sync\" button of WiiRemote or the Wii Fit board. LED(s) will start blinking.\n3. Click on init to refresh the menu with the connected devices. \n4. Click the off/on-button to start polling the device"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 589.0, 70.0, 174.0, 26.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 958.0, 139.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 958.0, 92.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 958.0, 186.0, 73.0, 20.0 ],
					"text" : "s to-module"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 958.0, 47.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 958.0, 163.0, 155.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 958.0, 119.0, 163.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 958.0, 71.0, 147.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Get data from the Nintendo Wii controllers"
				}
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "bang" ],
									"patching_rect" : [ 86.0, 23.0, 50.0, 20.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 427.0, 14.0, 217.0, 20.0 ],
					"text" : "Requires the latest wii external"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 19.0, 244.0, 253.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 920.5, 125.0, 810.5, 125.0 ],
					"source" : [ "obj-51", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"hidden" : 0,
					"midpoints" : [ 881.5, 125.0, 810.5, 125.0 ],
					"source" : [ "obj-50", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"hidden" : 0,
					"midpoints" : [ 847.5, 125.0, 810.5, 125.0 ],
					"source" : [ "obj-49", 0 ]
				}
