// wiiremote.c
//Wii Fit additions copyright Ivica Ico Bukvic and Ji-Sun Kim
...
//KJS
void setJitteroffset(WiiRemoteRef wiiremote, long value)
{
	wiiremote->jitteroffset = value;
}

void setInterpolationFactor(WiiRemoteRef wiiremote, long value)
{
...
void handleExtensionData(WiiRemoteRef wiiremote, unsigned char *dp, size_t dataLength)
{
	...
	else if (wiiremote->expType == WiiBalanceBoard)		
	{
		...
		if(wiiremote->weightKG > wiiremote->jitteroffset) //default = 2
		{
