{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 4.0, 44.0, 756.0, 617.0 ],
		"bglocked" : 0,
		"defrect" : [ 4.0, 44.0, 756.0, 617.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 687.0, 322.0, 50.0, 20.0 ],
					"presentation_rect" : [ 687.0, 322.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 625.0, 321.0, 50.0, 20.0 ],
					"presentation_rect" : [ 625.0, 321.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 572.0, 324.0, 50.0, 20.0 ],
					"presentation_rect" : [ 572.0, 324.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 518.0, 324.0, 50.0, 20.0 ],
					"presentation_rect" : [ 518.0, 324.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 463.0, 323.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 336.0, 284.0, 343.0, 20.0 ],
					"text" : "jcom.oscroute /quantity /status /duration /pause /ioi /count"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 336.0, 259.0, 136.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 19.0, 345.0, 255.0, 255.0 ]
				}
...
,
					"patching_rect" : [ 19.0, 320.0, 122.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 411.0, 321.0, 47.0, 20.0 ],
					"text" : "motion"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 390.0, 320.0, 20.0, 20.0 ]
				}
...
,
					"patching_rect" : [ 444.0, 453.0, 77.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Arial",
						"default_fontsize" : 12.0,
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 336.0, 453.0, 99.0, 20.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Arial",
						"default_fontsize" : 12.0,
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 336.0, 478.0, 271.0, 85.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 336.0, 363.0, 271.0, 85.0 ],
					"peakcolor" : [ 0.498039, 0.498039, 0.498039, 1.0 ],
					"setminmax" : [ 0.0, 2.0 ],
					"setstyle" : 5
				}
