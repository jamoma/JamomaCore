...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter room/reflection/gain.2 @dataspace gain @dataspace/unit/active linear @dataspace/unit/native linear @dataspace/unit/internal linear @repetitions/allow 0 @description \"gain of the early reflections 2nd order\"",
					"linecount" : 2,
					"fontsize" : 9.0,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 614.0, 97.0, 581.0, 27.0 ],
					"id" : "obj-160",
					"fontname" : "Arial",
					"numinlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter room/reflection/gain.1 @dataspace gain @dataspace/unit/active linear @dataspace/unit/native linear @dataspace/unit/internal linear @repetitions/allow 0 @description \"gain of the early reflections 1st order\"",
					"linecount" : 2,
					"fontsize" : 9.0,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 617.0, 57.0, 581.0, 27.0 ],
					"id" : "obj-200",
					"fontname" : "Arial",
					"numinlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "jcom.parameter room/reflection/gain.0 @dataspace gain @dataspace/unit/active linear @dataspace/unit/native linear @dataspace/unit/internal linear @repetitions/allow 0 @description \"gain of the direct sound component\"",
					"linecount" : 2,
					"fontsize" : 9.0,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 610.0, 16.0, 581.0, 27.0 ],
					"id" : "obj-201",
					"fontname" : "Arial",
					"numinlets" : 1,
					"hidden" : 1,
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 0.0, 44.0, 603.0, 740.0 ],
						"bgcolor" : [ 0.321569, 0.301961, 0.129412, 1.0 ],
						"bglocked" : 0,
						"defrect" : [ 0.0, 44.0, 603.0, 740.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 236.0, 319.0, 294.0, 230.0 ],
										"bglocked" : 0,
										"defrect" : [ 236.0, 319.0, 294.0, 230.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 1,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
...
, 											{
												"box" : 												{
													"maxclass" : "newobj",
													"text" : "jcom.message source/directivity/load_file @type msg_symbol @description \"sound source directivity preset\"",
													"linecount" : 2,
													"fontsize" : 9.0,
													"outlettype" : [ "", "", "" ],
...
, 											{
												"box" : 												{
													"maxclass" : "comment",
													"text" : "360 º",
													"presentation_rect" : [ 250.0, 187.0, 37.0, 19.0 ],
													"fontsize" : 10.0,
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 2,
													"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "grow", "close", "zoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 2, 2, 32768, 32768, ";", "#Q", "window", "size", 236, 319, 530, 549, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 5,
													"embedstate" : [ [ "CreateNFunctions", 2, "Clarinet", 50, 0.0, 1.0, 0.0, 360.0, "nan", "nan", 0.7943, "nan" ], [ "SetColor", 0, "brgb", 204, 204, 204 ], [ "SetColor", 0, "frgb", 82, 82, 82 ], [ "SetColor", 0, "rgb2", 84, 84, 84 ], [ "SetColor", 0, "rgb3", 255, 0, 0 ], [ "SetColor", 0, "rgb4", 51, 51, 51 ], [ "SetColor", 0, "rgb5", 128, 128, 128 ], [ "SetColor", 0, "rgb6", 107, 107, 107 ], [ "SetColor", 1, "brgb", 204, 204, 204 ], [ "SetColor", 1, "frgb", 82, 82, 82 ], [ "SetColor", 1, "rgb2", 107, 107, 107 ], [ "SetColor", 1, "rgb3", 255, 0, 0 ], [ "SetColor", 1, "rgb4", 51, 51, 51 ], [ "SetColor", 1, "rgb5", 128, 128, 128 ], [ "SetColor", 1, "rgb6", 107, 107, 107 ], [ "fsaa", 1 ], [ "redrawon" ], [ "mode", 1 ], [ "nbfunction", 2 ], [ "clicksustain", 1 ], [ "ghost", 20 ], [ "numcurvepoints", 12 ], [ "hiddenpoint", 0 ], [ "timedisplay", 0 ], [ "clickmove", 1 ], [ "bordersync", 1 ], [ "legend", 1 ], [ "mousereport", 1 ], [ "snap2grid", 0 ], [ "grid", 3 ], [ "autosustain", 0 ], [ "notifyrecalled", 0 ], [ "movemode", 0 ], [ "clickadd", 1 ], [ "autocursor", 1 ] ]
												}
...
, 							{
								"box" : 								{
									...
									"hidden" : 1,
									"numoutlets" : 2,
									"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "grow", "close", "zoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 2, 2, 32768, 32768, ";", "#Q", "window", "size", 0, 44, 603, 784, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ]
								}
