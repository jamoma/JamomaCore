{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 32.0, 44.0, 1236.0, 777.0 ],
		"bglocked" : 0,
		"defrect" : [ 32.0, 44.0, 1236.0, 777.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"id" : "obj-1",
					"fontsize" : 9.0,
					"patching_rect" : [ 177.0, 421.0, 50.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-2",
					"fontsize" : 9.0,
					"patching_rect" : [ 177.0, 401.0, 43.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 285.0, 44.0, 927.0, 778.0 ],
						"bglocked" : 0,
						"defrect" : [ 285.0, 44.0, 927.0, 778.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "prepend script new message_z newex 500 280 300 196617 jcom.message",
									"numinlets" : 1,
									"id" : "obj-13",
									"fontsize" : 9.0,
									"patching_rect" : [ 171.0, 681.0, 348.0, 17.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"fontname" : "Arial"
								}
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "append @repetitions/allow 0 @description \\\"Gain_of_of_the_microphone\\\" @priority",
									"numinlets" : 1,
									"id" : "obj-49",
									"fontsize" : 9.0,
									"patching_rect" : [ 180.0, -17.0, 356.0, 17.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"fontname" : "Arial"
								}
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "prepend script new parameter_gain newex 700 70 270 196617 jcom.parameter.gain",
									"numinlets" : 1,
									"id" : "obj-50",
									"fontsize" : 9.0,
									"patching_rect" : [ 181.0, -35.0, 394.0, 17.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"fontname" : "Arial"
								}
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "prepend script new parameter2 newex 830 245 270 196617 jcom.parameter",
									"numinlets" : 1,
									"id" : "obj-66",
									"fontsize" : 9.0,
									"patching_rect" : [ 184.0, -324.0, 361.0, 17.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"fontname" : "Arial"
								}
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "prepend script new parameter newex 391 200 270 196617 jcom.parameter",
									"numinlets" : 1,
									"id" : "obj-75",
									"fontsize" : 9.0,
									"patching_rect" : [ 184.0, -476.0, 355.0, 17.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"fontname" : "Arial"
								}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"fontsize" : 9.0,
					"patching_rect" : [ 177.0, 441.0, 65.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patcher" : 					{
...
, 			{
				"box" : 				{
					...
					"id" : "obj-5",
					"fontsize" : 9.0,
					"patching_rect" : [ 330.0, 153.0, 51.0, 17.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-8",
					"fontsize" : 9.0,
					"patching_rect" : [ 1136.0, 45.0, 73.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patcher" : 					{
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"fontsize" : 9.0,
									"patching_rect" : [ 453.0, 101.0, 161.0, 17.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"fontname" : "Arial"
								}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 332.0, 0.0, 71.0, 17.0 ],
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"id" : "obj-11",
					"fontsize" : 9.0,
					"patching_rect" : [ 270.0, 64.0, 55.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-12",
					"fontsize" : 9.0,
					"patching_rect" : [ 271.0, 102.0, 46.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 616.0, 360.0, 600.0, 426.0 ],
						"bglocked" : 0,
						"defrect" : [ 616.0, 360.0, 600.0, 426.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"id" : "obj-1",
									"fontsize" : 9.0,
									"patching_rect" : [ 145.0, 119.0, 56.0, 15.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"fontname" : "Arial"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"fontsize" : 9.0,
									"patching_rect" : [ 244.0, 118.0, 64.0, 15.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"fontname" : "Arial"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-5",
									"fontsize" : 9.0,
									"patching_rect" : [ 27.0, 117.0, 81.0, 15.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"fontname" : "Arial"
								}
...
, 			{
				"box" : 				{
					"maxclass" : "jsui",
					"varname" : "ACTIVE",
					"jsarguments" : [ "on", "off", 68, 68, 68, 225, 225, 225, 121, 255, 15 ],
					"numinlets" : 1,
					"id" : "obj-13",
					"patching_rect" : [ 0.0, 1.0, 25.0, 14.0 ],
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"id" : "obj-14",
					"patching_rect" : [ 96.0, 205.0, 25.0, 14.0 ],
					"numoutlets" : 2,
					"filename" : "jcom.jsui_texttoggle.js",
					"outlettype" : [ "", "" ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-15",
					"fontsize" : 9.0,
					"patching_rect" : [ 758.0, 77.0, 48.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patcher" : 					{
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"fontsize" : 9.0,
									"patching_rect" : [ 51.0, 71.0, 258.0, 17.0 ],
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"fontname" : "Arial"
								}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-16",
					"fontsize" : 9.0,
					"patching_rect" : [ 751.0, 6.0, 155.0, 27.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"id" : "obj-21",
					"patching_rect" : [ 1260.0, 225.0, 15.0, 15.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-22",
					"fontsize" : 9.0,
					"patching_rect" : [ 1216.0, 225.0, 23.0, 15.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-24",
					"fontsize" : 9.0,
					"patching_rect" : [ 739.0, 147.0, 67.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-25",
					"fontsize" : 9.0,
					"patching_rect" : [ 658.0, 85.0, 30.0, 15.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-26",
					"fontsize" : 9.0,
					"patching_rect" : [ 602.0, 82.0, 53.0, 15.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"id" : "obj-30",
					"patching_rect" : [ 575.0, 2.0, 15.0, 15.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"comment" : ""
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-31",
					"fontsize" : 9.0,
					"patching_rect" : [ 347.0, 68.0, 46.0, 17.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"fontname" : "Arial",
					"patcher" : 					{
...
, 			{
				"box" : 				{
					...
					"id" : "obj-32",
					"fontsize" : 9.0,
					"patching_rect" : [ 345.0, 24.0, 48.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"id" : "obj-33",
					"patching_rect" : [ 404.0, 26.0, 15.0, 15.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-34",
					"fontsize" : 9.0,
					"patching_rect" : [ 346.0, 45.0, 50.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"varname" : "gain_mic",
					"lockeddragscroll" : 1,
					"args" : [ 1.0, 0.0, 1.0, "@size", 40, 14 ],
					"numinlets" : 1,
					"id" : "obj-36",
					"patching_rect" : [ 415.0, 2.0, 36.0, 13.0 ],
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"id" : "obj-37",
					"fontsize" : 9.0,
					"patching_rect" : [ 167.0, 0.0, 35.0, 17.0 ],
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"id" : "obj-38",
					"fontsize" : 9.0,
					"patching_rect" : [ 131.0, 0.0, 35.0, 17.0 ],
					"numoutlets" : 2,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
					"triscale" : 0.9,
					"textcolor" : [ 0.776471, 0.776471, 0.776471, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"id" : "obj-39",
					"patching_rect" : [ 295.0, 2.0, 36.0, 13.0 ],
					"numoutlets" : 1,
					"name" : "jcom.numberslider.maxpat",
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-42",
					"fontsize" : 9.0,
					"patching_rect" : [ 684.0, 225.0, 144.0, 17.0 ],
					"numoutlets" : 11,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-43",
					"fontsize" : 9.0,
					"patching_rect" : [ 719.0, 198.0, 39.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-44",
					"fontsize" : 9.0,
					"patching_rect" : [ 675.0, 197.0, 41.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-45",
					"fontsize" : 9.0,
					"patching_rect" : [ 248.0, 0.0, 32.0, 17.0 ],
					"minimum" : -90.0,
					"numoutlets" : 2,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"id" : "obj-46",
					"fontsize" : 9.0,
					"patching_rect" : [ 215.0, 0.0, 33.0, 17.0 ],
					"numoutlets" : 2,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
					"triscale" : 0.9,
					"textcolor" : [ 0.776471, 0.776471, 0.776471, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-48",
					"fontsize" : 9.0,
					"patching_rect" : [ 191.0, 182.0, 154.0, 17.0 ],
					"numoutlets" : 11,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-52",
					"fontsize" : 9.0,
					"patching_rect" : [ 280.0, 152.0, 39.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-53",
					"fontsize" : 9.0,
					"patching_rect" : [ 234.0, 151.0, 40.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-54",
					"fontsize" : 9.0,
					"patching_rect" : [ 192.0, 151.0, 40.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-55",
					"fontsize" : 9.0,
					"patching_rect" : [ 95.0, 0.0, 35.0, 17.0 ],
					"numoutlets" : 2,
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
					"triscale" : 0.9,
					"textcolor" : [ 0.776471, 0.776471, 0.776471, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"patching_rect" : [ 25.0, 2.0, 72.0, 17.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"id" : "obj-57",
					"patching_rect" : [ -1.0, -1.0, 526.0, 19.0 ],
					"numoutlets" : 0,
					"border" : 1,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-51", 0 ],
					"hidden" : 0,
					"midpoints" : [ 186.5, 462.0, 141.5, 462.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-44", 0 ],
					"hidden" : 0,
					"midpoints" : [ 693.5, 250.0, 671.0, 250.0, 671.0, 193.0, 684.5, 193.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-42", 0 ],
					"hidden" : 0,
					"midpoints" : [ 684.5, 222.0, 693.5, 222.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 728.5, 218.0, 706.0, 218.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-43", 0 ],
					"hidden" : 0,
					"midpoints" : [ 706.0, 257.0, 668.0, 257.0, 668.0, 186.0, 728.5, 186.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-52", 0 ],
					"hidden" : 0,
					"midpoints" : [ 227.5, 214.0, 172.0, 214.0, 172.0, 139.0, 289.5, 139.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-53", 0 ],
					"hidden" : 0,
					"midpoints" : [ 214.0, 210.0, 177.0, 210.0, 177.0, 144.0, 243.5, 144.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 200.5, 206.0, 182.0, 206.0, 182.0, 150.0, 201.5, 150.0 ]
				}
