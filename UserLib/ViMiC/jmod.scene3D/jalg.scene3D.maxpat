{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 323.0, 44.0, 900.0, 678.0 ],
		"bglocked" : 0,
		"defrect" : [ 323.0, 44.0, 900.0, 678.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"varname" : "input",
					"text" : "p input",
					"patching_rect" : [ 200.0, 282.5, 46.0, 19.0 ],
					"outlettype" : [ "", "" ],
					"id" : "obj-27",
					"fontname" : "Verdana",
					"numinlets" : 2,
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 580.0, 94.0, 640.0, 480.0 ],
						"bglocked" : 0,
						"defrect" : [ 580.0, 94.0, 640.0, 480.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "+ 1",
									"patching_rect" : [ 26.0, 96.0, 32.5, 19.0 ],
									"outlettype" : [ "int" ],
									"id" : "obj-11",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "bypass",
									"patching_rect" : [ 223.0, 393.0, 45.0, 19.0 ],
									"id" : "obj-4",
...
, 							{
								"box" : 								{
									"maxclass" : "outlet",
									"patching_rect" : [ 232.0, 356.0, 25.0, 25.0 ],
									"id" : "obj-5",
									"numinlets" : 1,
									"numoutlets" : 0,
									"comment" : ""
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "to FXs",
									"patching_rect" : [ 54.0, 390.0, 45.0, 19.0 ],
									"id" : "obj-3",
									"frgb" : [ 0.337255, 0.356863, 0.690196, 1.0 ],
									"fontname" : "Verdana",
									"numinlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "outlet",
									"patching_rect" : [ 63.0, 353.0, 25.0, 25.0 ],
									"id" : "obj-1",
									"numinlets" : 1,
									"numoutlets" : 0,
									"comment" : ""
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "gate 2 2",
									"patching_rect" : [ 24.0, 133.5, 74.0, 19.0 ],
									"outlettype" : [ "", "" ],
									"id" : "obj-20",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 47.0, 44.0, 968.0, 544.0 ],
						"bglocked" : 0,
						"defrect" : [ 47.0, 44.0, 968.0, 544.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "1 $3 $5 $1 1 $6 $2 $4 1",
									"patching_rect" : [ 384.0, 289.0, 134.0, 17.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-15",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 384.0, 310.0, 96.0, 19.0 ],
									"outlettype" : [ "", "" ],
									"id" : "obj-10",
									"fontname" : "Verdana",
									"numinlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "t b b l",
									"patching_rect" : [ 357.0, 266.0, 46.0, 19.0 ],
									"outlettype" : [ "bang", "bang", "" ],
									"id" : "obj-5",
									"fontname" : "Verdana",
									"numinlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "setcell 0 0 val 1, setcell 1 0 val $3, setcell 2 0 val $5, setcell 0 1 val $1, setcell 1 1 val 1, setcell 2 1 val $6, setcell 0 2 val $2, setcell 1 2 val $4, setcell 2 2 val 1, bang",
									"linecount" : 4,
									"patching_rect" : [ 577.0, 283.0, 281.0, 53.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-8",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 292.0, 335.0, 214.0, 20.0 ],
									"outlettype" : [ "jit_matrix", "" ],
									"id" : "obj-91",
									"fontname" : "Arial",
									"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "/order rotate",
					"patching_rect" : [ 632.0, 65.0, 76.0, 17.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-12",
					"fontname" : "Verdana",
					"numinlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p mirror-TODO",
					"patching_rect" : [ 373.0, 527.0, 86.0, 19.0 ],
					"id" : "obj-10",
					"fontname" : "Verdana",
					"numinlets" : 0,
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 106.0, 44.0, 1157.0, 540.0 ],
						"bglocked" : 0,
						"defrect" : [ 106.0, 44.0, 1157.0, 540.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "t b",
									"patching_rect" : [ 301.0, 338.0, 24.0, 19.0 ],
									"outlettype" : [ "bang" ],
									"id" : "obj-14",
									"fontname" : "Verdana",
									"numinlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "jit.la.mult",
									"patching_rect" : [ 487.0, 330.0, 447.0, 19.0 ],
									"outlettype" : [ "jit_matrix", "" ],
									"id" : "obj-6",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "p",
									"patching_rect" : [ 484.0, 132.0, 100.0, 19.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-31",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 											{
												"box" : 												{
													"maxclass" : "newobj",
													"text" : "t b l",
													"patching_rect" : [ 53.0, 278.0, 32.5, 19.0 ],
													"outlettype" : [ "bang", "" ],
													"id" : "obj-1",
													"fontname" : "Verdana",
													"numinlets" : 1,
...
, 											{
												"box" : 												{
													"maxclass" : "newobj",
													"text" : "pack f f f",
													"patching_rect" : [ 66.0, 235.0, 55.0, 19.0 ],
													"outlettype" : [ "" ],
													"id" : "obj-3",
													"fontname" : "Verdana",
													"numinlets" : 3,
...
, 											{
												"box" : 												{
													"maxclass" : "newobj",
													"text" : "t b l",
													"patching_rect" : [ 61.0, 243.0, 32.5, 19.0 ],
													"outlettype" : [ "bang", "" ],
													"id" : "obj-1",
													"fontname" : "Verdana",
													"numinlets" : 1,
...
, 											{
												"box" : 												{
													"maxclass" : "newobj",
													"text" : "t b l",
													"patching_rect" : [ 64.0, 286.0, 32.5, 19.0 ],
													"outlettype" : [ "bang", "" ],
													"id" : "obj-5",
													"fontname" : "Verdana",
													"numinlets" : 1,
...
, 							{
								"box" : 								{
									...
									"linecount" : 4,
									"patching_rect" : [ 261.0, 160.0, 36.0, 53.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-62",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 			{
				"box" : 				{
					...
					"varname" : "shuffle",
					"text" : "p shuffle-TODO",
					"patching_rect" : [ 282.0, 522.0, 88.0, 19.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-8",
					"fontname" : "Verdana",
					"numinlets" : 3,
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 594.0, 94.0, 640.0, 480.0 ],
						"bglocked" : 0,
						"defrect" : [ 594.0, 94.0, 640.0, 480.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "delay 5",
									"patching_rect" : [ 233.0, 200.0, 47.0, 19.0 ],
									"outlettype" : [ "bang" ],
									"id" : "obj-2",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "inlet",
									"patching_rect" : [ 476.0, 41.0, 25.0, 25.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-29",
									"numinlets" : 0,
									"numoutlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "t b b clear",
									"patching_rect" : [ 475.0, 94.0, 62.0, 19.0 ],
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "p fit",
									"patching_rect" : [ 247.0, 56.0, 30.0, 19.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-23",
									"fontname" : "Verdana",
									"numinlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "outlet",
									"patching_rect" : [ 136.0, 413.0, 25.0, 25.0 ],
									"id" : "obj-19",
									"numinlets" : 1,
									"numoutlets" : 0,
									"comment" : ""
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "prepend",
									"patching_rect" : [ 96.0, 225.0, 52.0, 19.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-12",
									"fontname" : "Verdana",
									"numinlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "inlet",
									"patching_rect" : [ 199.0, 25.0, 25.0, 25.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-5",
									"numinlets" : 0,
									"numoutlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "button",
									"patching_rect" : [ 476.0, 71.0, 20.0, 20.0 ],
									"outlettype" : [ "bang" ],
									"id" : "obj-39",
									"numinlets" : 1,
									"numoutlets" : 1
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-12", 0 ],
									"hidden" : 0,
									"midpoints" : [ 69.5, 222.0, 105.5, 222.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 592.0, 99.0, 640.0, 480.0 ],
						"bglocked" : 0,
						"defrect" : [ 592.0, 99.0, 640.0, 480.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "op + + +",
									"patching_rect" : [ 361.0, 181.0, 58.0, 17.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-12",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "op pass pass pass",
									"patching_rect" : [ 376.0, 154.0, 101.0, 17.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-11",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "sel 1 0",
									"patching_rect" : [ 362.0, 132.0, 46.0, 19.0 ],
									"outlettype" : [ "bang", "bang", "" ],
									"id" : "obj-8",
									"fontname" : "Verdana",
									"numinlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "prepend val",
									"patching_rect" : [ 293.0, 132.0, 70.0, 19.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-7",
									"fontname" : "Verdana",
									"numinlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "jit.op @op + + + @val 0. 0. 0.",
									"patching_rect" : [ 110.0, 251.0, 166.0, 19.0 ],
									"outlettype" : [ "jit_matrix", "" ],
									"id" : "obj-6",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 640.0, 62.0, 640.0, 480.0 ],
						"bglocked" : 0,
						"defrect" : [ 640.0, 62.0, 640.0, 480.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 51.0, 74.0, 233.0, 19.0 ],
									"outlettype" : [ "", "" ],
									"id" : "obj-97",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "zl thin",
									"patching_rect" : [ 51.0, 52.0, 41.0, 19.0 ],
									"outlettype" : [ "", "" ],
									"id" : "obj-98",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "stretch random translate rotate skew",
									"patching_rect" : [ 205.0, 47.0, 198.0, 17.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-61",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "zl iter 2",
									"patching_rect" : [ 293.0, 240.0, 102.0, 19.0 ],
									"outlettype" : [ "", "" ],
									"id" : "obj-59",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 292.0, 279.0, 147.0, 17.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-60",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "t l b",
									"patching_rect" : [ 51.0, 105.0, 271.5, 19.0 ],
									"outlettype" : [ "", "bang" ],
									"id" : "obj-58",
									"fontname" : "Verdana",
									"numinlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "zl reg",
									"patching_rect" : [ 302.0, 207.0, 38.0, 19.0 ],
									"outlettype" : [ "", "" ],
									"id" : "obj-57",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "append shuffle",
									"patching_rect" : [ 133.0, 151.0, 85.0, 19.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-55",
									"fontname" : "Verdana",
									"numinlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "prepend input",
									"patching_rect" : [ 50.0, 151.0, 81.0, 19.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-50",
									"fontname" : "Verdana",
									"numinlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "zl iter 2",
									"patching_rect" : [ 50.0, 242.0, 102.0, 19.0 ],
									"outlettype" : [ "", "" ],
									"id" : "obj-47",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "zl lace",
									"patching_rect" : [ 50.0, 181.0, 102.0, 19.0 ],
									"outlettype" : [ "", "" ],
									"id" : "obj-46",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 47.0, 281.0, 133.0, 17.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-5",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "outlet",
									"patching_rect" : [ 47.0, 423.0, 25.0, 25.0 ],
									"id" : "obj-2",
									"numinlets" : 1,
									"numoutlets" : 0,
									"comment" : ""
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "route xyz aed",
									"patching_rect" : [ 174.0, 244.0, 79.0, 19.0 ],
									"outlettype" : [ "", "", "" ],
									"id" : "obj-43",
									"fontname" : "Verdana",
									"numinlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "op !pass",
									"patching_rect" : [ 220.0, 160.0, 53.0, 17.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-9",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "jcom.thru",
									"patching_rect" : [ 128.0, 189.0, 59.0, 19.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-8",
									"fontname" : "Verdana",
									"numinlets" : 1,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 395.0, 322.0, 216.0, 19.0 ],
									"outlettype" : [ "jit_matrix", "" ],
									"id" : "obj-56",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 287.0, 184.0, 868.0, 444.0 ],
										"bglocked" : 0,
										"defrect" : [ 287.0, 184.0, 868.0, 444.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 10.0,
										"default_fontface" : 0,
...
, 											{
												"box" : 												{
													"maxclass" : "newobj",
													"text" : "prepend val",
													"patching_rect" : [ 199.0, 334.0, 70.0, 19.0 ],
													"outlettype" : [ "" ],
													"id" : "obj-25",
													"fontname" : "Verdana",
													"numinlets" : 1,
...
, 											{
												"box" : 												{
													"maxclass" : "newobj",
													"text" : "prepend val",
													"patching_rect" : [ 400.0, 343.0, 70.0, 19.0 ],
													"outlettype" : [ "" ],
													"id" : "obj-11",
													"fontname" : "Verdana",
													"numinlets" : 1,
...
, 											{
												"box" : 												{
													...
													"text" : "val 0. 1. 0.",
													"linecount" : 2,
													"patching_rect" : [ 466.0, 365.0, 54.0, 29.0 ],
													"outlettype" : [ "" ],
													"id" : "obj-7",
													"fontname" : "Verdana",
													"numinlets" : 2,
...
, 											{
												"box" : 												{
													"maxclass" : "newobj",
													"text" : "vexpr $f1 *$f2",
													"patching_rect" : [ 183.0, 173.0, 87.0, 19.0 ],
													"outlettype" : [ "" ],
													"id" : "obj-20",
													"fontname" : "Verdana",
													"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "op +",
									"patching_rect" : [ 175.0, 146.0, 34.0, 17.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-18",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "op pass",
									"patching_rect" : [ 129.0, 162.0, 49.0, 17.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-17",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "sel 0 1 2",
									"patching_rect" : [ 129.0, 102.0, 155.5, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 396.0, 275.0, 225.0, 19.0 ],
									"outlettype" : [ "jit_matrix", "" ],
									"id" : "obj-5",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-8", 0 ],
									"hidden" : 0,
									"midpoints" : [ 229.5, 186.0, 189.0, 186.0, 189.0, 186.0, 137.5, 186.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-8", 0 ],
									"hidden" : 0,
									"midpoints" : [ 184.5, 186.0, 138.0, 186.0, 138.0, 186.0, 137.5, 186.0 ]
								}
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "p",
									"patching_rect" : [ 442.0, 95.0, 100.0, 19.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-31",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "gate",
									"patching_rect" : [ 394.0, 141.0, 33.0, 19.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-8",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "s #0_Scenebang",
									"patching_rect" : [ 392.0, 197.0, 95.0, 19.0 ],
									"id" : "obj-9",
									"fontname" : "Verdana",
									"numinlets" : 1,
									"fontsize" : 10.0,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "jit.op @op + + + @val 0. 0. 0.",
									"patching_rect" : [ 84.0, 276.0, 259.0, 19.0 ],
									"outlettype" : [ "jit_matrix", "" ],
									"id" : "obj-1",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "op pass pass pass",
									"patching_rect" : [ 237.0, 166.0, 101.0, 17.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-62",
									"fontname" : "Verdana",
									"numinlets" : 2,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 324.0, 63.0, 251.0, 19.0 ],
									"outlettype" : [ "", "", "", "" ],
									"id" : "obj-54",
									"fontname" : "Verdana",
									"numinlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "inlet",
									"patching_rect" : [ 324.0, 32.0, 25.0, 25.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-66",
									"numinlets" : 0,
									"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"patching_rect" : [ 49.0, 594.0, 25.0, 25.0 ],
					"id" : "obj-64",
					"numinlets" : 1,
					"numoutlets" : 0,
					"comment" : ""
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 1 ],
					"hidden" : 0,
					"midpoints" : [ 28.5, 507.0, 326.0, 507.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-4", 0 ],
					"hidden" : 0,
					"midpoints" : [ 291.5, 552.0, 56.5, 552.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-4", 0 ],
					"hidden" : 0,
					"midpoints" : [ 236.5, 547.0, 56.5, 547.0 ]
				}
