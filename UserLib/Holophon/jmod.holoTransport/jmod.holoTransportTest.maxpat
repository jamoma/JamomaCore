{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ -15.0, 44.0, 1310.0, 781.0 ],
		"bglocked" : 0,
		"defrect" : [ -15.0, 44.0, 1310.0, 781.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1120.0, 385.0, 84.0, 17.0 ],
					"presentation_rect" : [ 1121.0, 386.0, 0.0, 0.0 ],
					"text" : "export BBB.txt"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1195.0, 415.0, 75.0, 17.0 ],
					"text" : "save AAA.txt"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1030.0, 520.0, 32.5, 17.0 ],
					"presentation_rect" : [ 1032.0, 519.0, 0.0, 0.0 ],
					"text" : "sort"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1245.0, 590.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 1190.0, 590.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 1135.0, 590.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1090.0, 625.0, 156.0, 19.0 ],
					"text" : "pak /track.1/position 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1080.0, 505.0, 55.751953, 17.0 ],
					"presentation_rect" : [ 1080.0, 505.0, 55.751953, 17.0 ],
					"text" : [ "_set $1 $2" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1175.0, 515.0, 35.0, 17.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1080.0, 430.0, 54.0, 19.0 ],
					"text" : "zl slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1120.0, 470.0, 96.0, 17.0 ],
					"presentation_rect" : [ 1120.0, 470.0, 96.0, 17.0 ],
					"text" : [ "_(new tuple $*1)" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 855.0, 715.0, 50.0, 41.0 ],
					"text" : "xyz 1 0.14 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 860.0, 670.0, 219.0, 19.0 ],
					"text" : "jcom.position2ambimonitor @prefix track"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1080.0, 545.0, 101.183594, 18.0 ],
					"persistence" : 0,
					"presentation_rect" : [ 1080.0, 545.0, 101.183594, 18.0 ],
					"scope" : 0,
					"text" : "dict"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 975.0, 630.0, 61.0, 20.0 ],
					"text" : "s toDBAP"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 33,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 68.0, 586.0, 300.0, 35.0 ],
					"presentation_rect" : [ 790.0, 478.0, 300.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 68.0, 386.0, 300.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 976.0, 158.0, 37.0, 21.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 976.0, 131.0, 122.0, 21.0 ],
					"text" : "r holo.edit"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1070.0, 326.0, 113.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1003.0, 75.0, 74.0, 19.0 ],
					"text" : "s OSC-debug"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1090.0, 345.0, 113.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 771.0, 329.0, 59.0, 17.0 ],
					"text" : "/msg blou"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 690.0, 630.0, 32.0, 19.0 ],
					"text" : "print"
				}
