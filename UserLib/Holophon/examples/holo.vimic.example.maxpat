{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 1711.0, -749.0, 845.0, 848.0 ],
		"bglocked" : 0,
		"defrect" : [ 1711.0, -749.0, 845.0, 848.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.0, 806.0, 287.0, 18.0 ],
					"text" : "/source.1/position 2.92238 -4.05705 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 71.0, 502.0, 300.0, 210.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 71.0, 316.0, 300.0, 175.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 448.0, 295.0, 37.0, 18.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 379.0, 318.0, 200.0, 400.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.0, 717.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 592.0, 634.0, 69.0, 17.0 ],
					"text" : "loadmess 10."
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 89.0, 132.0, 88.0, 20.0 ],
									"text" : "vexpr $f1 * 10."
								}
...
,
					"patching_rect" : [ 13.0, 471.0, 49.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 593.0, 329.0, 150.0, 70.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 592.0, 427.0, 200.0, 200.0 ],
					"presentation" : 1,
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 576.0, 505.0, 35.0, 17.0 ],
									"text" : "s cmd"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 468.0, 301.0, 103.0, 17.0 ],
...
,
					"patching_rect" : [ 593.0, 405.0, 100.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"fontname" : "Verdana",
						"default_fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 591.0, 679.0, 33.0, 17.0 ],
					"triscale" : 0.9
				}
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 125.0, 347.0, 36.0, 17.0 ],
									"text" : "s cmd"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 17.0, 143.0, 103.0, 17.0 ],
									"text" : "prepend /microphones."
								}
...
,
					"patching_rect" : [ 625.0, 679.0, 64.0, 17.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"fontname" : "Arial",
						"default_fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 593.0, 654.0, 50.0, 20.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 68.0, 345.0, 72.0, 19.0 ],
									"text" : "prepend xyz"
								}
...
,
					"patching_rect" : [ 380.0, 296.0, 58.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"fontname" : "Verdana",
						"default_fontname" : "Verdana",
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 600.5, 697.0, 679.5, 697.0 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 80.5, 302.0, 379.0, 302.0, 379.0, 293.0, 389.5, 293.0 ],
					"source" : [ "obj-7", 0 ]
				}
