//aka.wiiremote.c
//1.04 : 2009:02.17 (added 'jitteroffset')
//1.03 : 2009:01.13 (a few lingering bugs, code clean-up)
//1.02 : 2009:01.12 (more stability improvements and bug fixes, now board connects on first try, added documentation)
//1.01 : 2008.12.15 (fixed recentering bug)
//1.00 : 2008.12.10
//Wii Fit functionality and other improvements copyright Ivica Ico Bukvic and Ji-Sun Kim with contributions from Sabrina Killian
...
//KJS
void akawiiremote_jitteroffset(t_akawiiremote *x, long value);
...
#endif /* PD */
{
	...
	post("disis.aka.wiiremote 1.04 by Ivica Ico Bukvic and Ji-Sun Kim (based on aka.wiimote 1.0B7-UB by Masayuki Akamatsu)");
	...
	class_addmethod(wiiremote_class,(t_method)akawiiremote_jitteroffset,gensym("jitteroffset"), A_DEFLONG, 0);
	...
	//KJS
	addmess((method)akawiiremote_jitteroffset,"jitteroffset", A_DEFLONG, 0);
...
void akawiiremote_jitteroffset(t_akawiiremote *x, long value)
{
	if (x->wiiremote != nil)
	{
		if (wiiremote_isconnected(x->wiiremote))
		{
			setJitteroffset(x->wiiremote, value);
		}
	}
}
