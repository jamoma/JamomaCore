{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 160.0, 44.0, 1280.0, 732.0 ],
		"bglocked" : 0,
		"defrect" : [ 160.0, 44.0, 1280.0, 732.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"numoutlets" : 0,
					"presentation_rect" : [ 5.0, 63.0, 80.0, 4.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"numoutlets" : 0,
					"presentation_rect" : [ 5.0, 40.0, 80.0, 4.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 10.0,
					"presentation_rect" : [ 281.0, 34.0, 23.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"minimum" : -48.0,
					"presentation_rect" : [ 258.0, 46.0, 28.0, 19.0 ],
					"maximum" : 15.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"minimum" : -48.0,
					"presentation_rect" : [ 258.0, 24.0, 28.0, 19.0 ],
					"maximum" : 15.0
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 186.0, 47.0, 38.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"borderoncolor" : [ 0.4, 0.4, 0.4, 0.423529 ],
					"bgcolor" : [ 0.74902, 0.74902, 0.74902, 0.0 ],
					"presentation_rect" : [ 186.0, 24.0, 38.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"borderoncolor" : [ 0.4, 0.4, 0.4, 0.423529 ],
					"bgcolor" : [ 0.74902, 0.74902, 0.74902, 0.0 ],
					"presentation_rect" : [ 121.0, 24.0, 64.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"borderoncolor" : [ 0.4, 0.4, 0.4, 0.423529 ],
					"bgcolor" : [ 0.74902, 0.74902, 0.74902, 0.0 ],
					"presentation_rect" : [ 121.0, 47.0, 64.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 226.0, 46.0, 25.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 10.0,
					"presentation_rect" : [ 4.0, 47.0, 216.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
					"presentation_rect" : [ 226.0, 23.0, 25.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 10.0,
					"presentation_rect" : [ 242.0, 34.0, 17.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 10.0,
					"presentation_rect" : [ 4.0, 24.0, 217.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 261.0, 44.0, 1000.0, 726.0 ],
						"bglocked" : 0,
						"defrect" : [ 261.0, 44.0, 1000.0, 726.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"fontsize" : 9.873845,
									"outlettype" : [ "", "" ],
									"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "grow", "close", "zoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 2, 2, 32768, 32768, ";", "#Q", "window", "size", 261, 44, 1261, 796, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ]
								}
