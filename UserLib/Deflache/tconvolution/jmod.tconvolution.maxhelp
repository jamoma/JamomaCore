{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 485.0, 44.0, 693.0, 758.0 ],
		"bglocked" : 0,
		"defrect" : [ 485.0, 44.0, 693.0, 758.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 438.0, 151.0, 56.0, 20.0 ],
					"numoutlets" : 1,
					"id" : "obj-29",
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 438.0, 126.0, 60.0, 20.0 ],
					"numoutlets" : 1,
					"id" : "obj-28",
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "/file:/repetitions/allow 1",
					"fontname" : "Arial",
					"hidden" : 1,
					"numinlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 438.0, 178.0, 132.0, 18.0 ],
					"numoutlets" : 1,
					"id" : "obj-11",
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"patching_rect" : [ 504.0, 148.0, 34.0, 19.0 ],
					"numoutlets" : 0,
					"id" : "obj-25"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Limitations:\n- Max/MSP Signal Vector Size MUST be set to maximum SegmentSize / 16\n(16 for SegmentSize 256, 32 for 512, 64 for 1024 etc...); at 256 I get harmonic distorsion. Changing Signal Vector size while buffers full is problematic.\n- Only first channel of impulse response files will be loaded\n- If IR is longer than Max IR length indicated in module, tail won't be loaded\n- Segment Size and Reverse take effect when DAC is switched off, or when loading new IR",
					"linecount" : 9,
					"fontname" : "Verdana",
					"numinlets" : 1,
					"fontsize" : 10.0,
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"patching_rect" : [ 21.0, 95.0, 403.0, 116.0 ],
					"numoutlets" : 0,
					"id" : "obj-12"
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 1,
					"numinlets" : 5,
					"patching_rect" : [ 21.0, 415.0, 302.0, 72.0 ],
					"numoutlets" : 5,
					"id" : "obj-8",
					"args" : [ "/tconvolution~" ],
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 4 ],
					"hidden" : 0,
					"midpoints" : [ 618.5, 402.0, 313.5, 402.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 3 ],
					"hidden" : 0,
					"midpoints" : [ 478.0, 402.0, 242.75, 402.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 2 ],
					"hidden" : 0,
					"midpoints" : [ 618.5, 402.0, 172.0, 402.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-8", 1 ],
					"hidden" : 0,
					"midpoints" : [ 478.0, 411.0, 168.0, 411.0, 168.0, 411.0, 101.25, 411.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 101.25, 507.0, 170.0, 507.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 172.0, 507.0, 310.5, 507.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 242.75, 507.0, 477.0, 507.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 313.5, 507.0, 617.5, 507.0 ]
				}
