{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 14.0, 44.0, 1375.0, 808.0 ],
		"bglocked" : 0,
		"defrect" : [ 14.0, 44.0, 1375.0, 808.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 535.0, 573.0, 57.0, 17.0 ],
					"text" : "r #0-!freeze"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 438.0, 367.0, 57.0, 17.0 ],
					"text" : "r #0-!freeze"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 177.0, 421.0, 57.0, 17.0 ],
					"text" : "r #0-!freeze"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 69.0, 399.0, 57.0, 17.0 ],
					"text" : "r #0-!freeze"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 27.0, 358.0, 63.0, 18.0 ],
					"text" : "s #0-!freeze"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 81.0, 423.0, 32.5, 19.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 427.0, 19.0, 22.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 479.0, 385.0, 47.0, 18.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 27.0, 306.0, 121.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 564.0, 595.0, 47.0, 18.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 438.0, 407.0, 54.0, 18.0 ],
					"text" : "/random"
				}
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 0.003922, 0.003922, 1.0, 0.0 ],
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"hbgcolor" : [ 0.0, 0.0, 0.0, 0.0 ],
					"htextcolor" : [ 0.0, 0.2, 1.0, 1.0 ],
					"id" : "obj-54",
					"ignoreclick" : 1,
					"maxclass" : "flonum",
					"maximum" : 1.0,
					...
					"patching_rect" : [ 479.0, 406.0, 53.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 252.0, 84.0, 44.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"frgb" : [ 0.003922, 0.003922, 1.0, 1.0 ],
					"id" : "obj-108",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 577.0, 526.0, 41.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 182.0, 85.0, 30.0, 18.0 ],
					"text" : "/step",
					"textcolor" : [ 0.003922, 0.003922, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 857.0, 688.0, 52.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 205.0, 84.0, 37.0, 19.0 ],
					"textcolor" : [ 0.003922, 0.003922, 1.0, 1.0 ],
					"triangle" : 0,
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 749.0, 700.0, 35.0, 18.0 ],
					"text" : "* -1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 749.0, 678.0, 32.5, 18.0 ],
					"text" : "- 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 564.0, 699.0, 32.5, 18.0 ],
					"text" : "/ 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 564.0, 678.0, 32.5, 18.0 ],
					"text" : "+ 0."
				}
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 0.533333, 0.533333, 1.0, 1.0 ],
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 564.0, 623.0, 218.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 21.0, 66.948517, 275.0, 16.0 ],
					"size" : 1000.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 696.0, 761.0, 45.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 105.0, 85.0, 39.0, 18.0 ],
					"text" : "/range",
					"textcolor" : [ 0.003922, 0.003922, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 519.0, 816.0, 44.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 23.0, 85.0, 40.0, 18.0 ],
					"text" : "/center",
					"textcolor" : [ 0.003922, 0.003922, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 564.0, 816.0, 53.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 57.0, 84.0, 40.0, 19.0 ],
					"textcolor" : [ 0.003922, 0.003922, 1.0, 1.0 ],
					"triangle" : 0,
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 749.0, 762.0, 39.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 138.0, 84.0, 39.0, 19.0 ],
					"textcolor" : [ 0.003922, 0.003922, 1.0, 1.0 ],
					"triangle" : 0,
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 440.0, 445.0, 339.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 27.0, 275.0, 48.0, 19.0 ],
					"text" : "jcom.in"
				}
...
,
					"patching_rect" : [ 507.0, 350.0, 102.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1009.0, 332.0, 55.0, 18.0 ],
					"text" : "route set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1061.0, 382.0, 55.0, 18.0 ],
					"text" : "route set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 118.0, 533.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 105.0, 444.0, 43.0, 19.0 ],
					"text" : "gate 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 203.0, 444.0, 33.0, 19.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 158.0, 251.0, 99.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 87.0, 274.0, 68.0, 19.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 27.0, 333.0, 37.0, 19.0 ],
					"text" : "== 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 553.0, 405.0, 20.0, 20.0 ]
				}
...
,
					"patching_rect" : [ 1043.0, 423.0, 41.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontname" : "Arial",
						"globalpatchername" : "",
						"default_fontsize" : 12.0,
...
,
					"patching_rect" : [ 995.0, 423.0, 41.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontname" : "Arial",
						"globalpatchername" : "",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 995.0, 392.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 995.0, 500.0, 70.0, 18.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 995.0, 480.0, 55.0, 18.0 ],
					"text" : "pak 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1009.0, 354.0, 32.5, 18.0 ],
					"text" : "/ 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 995.0, 458.0, 32.5, 18.0 ],
					"text" : "- 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1029.0, 458.0, 32.5, 18.0 ],
					"text" : "+ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 203.0, 478.0, 45.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 248.0, 37.0, 34.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "MetroTime[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 154.0, 478.0, 43.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 275.0, 37.0, 23.0, 19.0 ],
					"text" : "ms"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1226.0, 370.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 22.0, 16.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1256.0, 400.0, 65.0, 19.0 ],
					"text" : "On/Off"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1356.0, 108.0, 35.0, 18.0 ],
					"text" : "* -1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1356.0, 86.0, 32.5, 18.0 ],
					"text" : "- 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1222.0, 114.0, 32.5, 18.0 ],
					"text" : "/ 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1222.0, 93.0, 32.5, 18.0 ],
					"text" : "+ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1222.0, 38.0, 168.0, 12.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 21.0, 22.0, 275.0, 16.0 ],
					"size" : 3000.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 1009.0, 283.0, 46.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 96.47171, 37.411858, 35.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 935.0, 284.0, 101.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 23.47171, 37.41185, 101.0, 19.0 ],
					"text" : "/randomness",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 1222.0, 169.0, 45.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 177.0, 37.0, 37.0, 19.0 ],
					"textcolor" : [ 0.05098, 0.0, 1.0, 1.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "MetroTime[1]"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1177.0, 169.0, 52.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 134.0, 37.0, 58.0, 19.0 ],
					"text" : "/period",
					"textcolor" : [ 0.101961, 0.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 275.0, 115.0, 74.0, 17.0 ],
					"text" : "/preset/read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 85.0, 115.0, 187.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 129.0, 479.0, 18.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.800354, 65.948517, 19.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 135.0, 137.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 115.0, 37.0, 17.0 ],
					"text" : "/init"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 129.0, 369.0, 141.0, 19.0 ],
					"text" : "jalg.drunkpath.maxpat",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 165.0, 326.0, 19.0 ],
					"text" : "jcom.hub @description \"generates a path with random period\"",
					"varname" : "jcom.hub"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 138.5, 337.5, 516.5, 337.5 ],
					"source" : [ "obj-26", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 573.5, 727.0, 426.5, 727.0, 426.5, 341.0, 599.5, 341.0 ],
					"source" : [ "obj-102", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 599.5, 386.5, 601.5, 386.5 ],
					"source" : [ "obj-33", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-62", 0 ],
					"hidden" : 0,
					"midpoints" : [ 1365.5, 139.0, 1018.5, 139.0 ],
					"source" : [ "obj-70", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 1004.5, 527.0, 902.0, 527.0, 902.0, 16.0, 1231.5, 16.0 ],
					"source" : [ "obj-141", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 1281.5, 233.0, 1144.0, 257.0 ],
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-40", 0 ],
					"hidden" : 0,
					"midpoints" : [ 109.5, 157.0, 24.5, 157.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-40", 0 ],
					"hidden" : 0,
					"midpoints" : [ 54.5, 149.0, 24.5, 149.0 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-40", 0 ],
					"hidden" : 0,
					"midpoints" : [ 94.5, 153.0, 24.5, 153.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-40", 0 ],
					"hidden" : 0,
					"midpoints" : [ 284.5, 161.0, 27.0, 161.0, 27.0, 161.0, 24.5, 161.0 ],
					"source" : [ "obj-48", 0 ]
				}
