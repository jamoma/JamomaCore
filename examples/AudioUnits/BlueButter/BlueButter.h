...
#ifndef __BlueButter_h__
#define __BlueButter_h__
...
// AU Class
class BlueButter : public AUEffectBase
{
public:

	// Life Cycle
	
	BlueButter(AudioUnit component);
	...
	{ 
		return new BlueButterKernel(this); 
	}
	...
	{
		return kBlueButterVersion; 
	}
	
	
protected:
	// Processor Class
	class BlueButterKernel : public AUKernelBase		// most of the real work happens here
	{
	public:
		BlueButterKernel(AUEffectBase *inAudioUnit )
