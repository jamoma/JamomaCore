{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 140.0, 44.0, 984.0, 607.0 ],
		"bglocked" : 0,
		"defrect" : [ 140.0, 44.0, 984.0, 607.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 653.0, 326.0, 50.0, 17.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 70.0, 345.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 521.0, 239.0, 75.0, 17.0 ],
					"text" : "frequencyMh"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 414.0, 238.0, 76.0, 17.0 ],
					"text" : "frequencyLm"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 549.0, 329.0, 56.0, 17.0 ],
					"text" : "gainH $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 459.0, 326.0, 56.0, 17.0 ],
					"text" : "gainM $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.0, 329.0, 54.0, 17.0 ],
					"text" : "gainL $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 521.0, 219.0, 56.0, 19.0 ],
					"text" : "* 20000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 521.0, 153.0, 64.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 418.0, 151.0, 64.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 416.0, 217.0, 56.0, 19.0 ],
					"text" : "* 20000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 458.0, 259.0, 64.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 372.0, 259.0, 64.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 180.0, 425.0, 556.0, 19.0 ],
					"text" : "tt.hmlshelf~ 4"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 54.5, 410.0, 368.5, 410.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 54.5, 404.0, 547.5, 404.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 54.5, 398.0, 726.5, 398.0 ],
					"source" : [ "obj-24", 0 ]
				}
