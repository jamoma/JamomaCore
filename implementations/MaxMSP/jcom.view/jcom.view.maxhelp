	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 105.0, 120.0, 44.0, 19.0 ],
					"text" : "TODO"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 38.0, 120.0, 61.0, 19.0 ],
					"text" : "jcom.view"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@name", "jcom.view", "@description", "remote control and listening to a parameter|message|return" ],
					"bgmode" : 1,
					"embed" : 1,
					"id" : "obj-2",
					"maxclass" : "bpatcher",
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 0.0, 0.0, 1328.0, 70.0 ],
						"bglocked" : 1,
						"defrect" : [ 0.0, 0.0, 1328.0, 70.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
...
, 							{
								"box" : 								{
									...
									"id" : "obj-34",
									"ignoreclick" : 1,
									"items" : [ ",", "Launch html reference page for jcom.view", ",", "Launch Jamoma overview patch", ",", "Credits and acknowledgements", ",", "Show the bug tracker entries for jcom.view", ",", "How to report a bug?", ",", "Paypal donation via pledgie.com" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
