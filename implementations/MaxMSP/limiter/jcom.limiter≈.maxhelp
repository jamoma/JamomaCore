...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 344.0, 351.0, 79.0, 19.0 ],
					"text" : "jcom.limiter~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 435.0, 425.0, 65.0, 19.0 ],
					"text" : "jcom.info≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 385.0, 490.0, 65.0, 19.0 ],
					"text" : "jcom.info≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 370.0, 79.0, 19.0 ],
					"text" : "jcom.limiter≈"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 20.0, 395.0, 73.0, 19.0 ],
					"text" : "jcom.unpack≈ 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 20.0, 315.0, 66.0, 19.0 ],
					"text" : "jcom.pack≈ 2"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"hidden" : 0,
					"midpoints" : [ 29.5, 301.0, 76.5, 301.0 ],
					"source" : [ "obj-35", 0 ]
				}
