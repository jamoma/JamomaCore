...
,
		"rect" : [ 1.0, 44.0, 1007.0, 503.0 ],
		"bglocked" : 0,
		"defrect" : [ 1.0, 44.0, 1007.0, 503.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 655.0, 177.0, 180.0, 48.0 ],
					"text" : "or select model followed by relative address to select which parameter to manage"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 655.0, 138.0, 180.0, 34.0 ],
...
,
						"rect" : [ 590.0, 286.0, 195.0, 140.0 ],
						"bglocked" : 0,
						"defrect" : [ 590.0, 286.0, 195.0, 140.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 5.0, 104.0, 99.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 5.0, 75.0, 32.5, 18.0 ],
									"text" : "$2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "list" ],
									"patching_rect" : [ 5.0, 53.0, 58.0, 20.0 ],
									"text" : "listfunnel"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "########################" ],
									"patching_rect" : [ 5.0, 31.0, 183.0, 20.0 ],
									"text" : "t l ########################"
								}
						...
						"lines" : [ 							{
								"patchline" : 								{
									"destination" : [ "obj-3", 0 ],
									"hidden" : 0,
									"midpoints" : [ 178.5, 98.0, 14.5, 98.0 ],
									"source" : [ "obj-1", 1 ]
								}
...
,
					"patching_rect" : [ 423.0, 412.0, 114.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 445.0, 183.0, 202.0, 32.0 ],
					"text" : "namespace /mouse active /degrade~ bitdepth samplerateRatio"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 844.0, 308.0, 144.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 677.0, 320.0, 150.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "names" ],
					"patching_rect" : [ 587.0, 364.0, 53.0, 20.0 ],
					"text" : "t names"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "error" ],
					"patching_rect" : [ 533.0, 364.0, 43.0, 20.0 ],
					"text" : "t error"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "done" ],
					"patching_rect" : [ 478.0, 364.0, 44.0, 20.0 ],
					"text" : "t done"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 478.0, 389.0, 61.0, 20.0 ],
					"text" : "print read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 313.0, 341.0, 294.0, 20.0 ],
					"text" : "route names current namespace read error"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.0, 363.0, 43.0, 18.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 182.0, 287.0, 159.0, 18.0 ],
					"text" : "names, current, namespace"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 444.0, 90.0, 194.0, 48.0 ],
					"text" : "Select the namespace to manage. The order of addresses precises the order for the recall."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 677.0, 405.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 671.0, 305.0, 320.0, 180.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 445.0, 147.0, 173.0, 18.0 ],
					"text" : "namespace /mouse /degrade~"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 542.5, 386.0, 487.5, 386.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 487.5, 362.5, 596.5, 362.5 ],
					"source" : [ "obj-14", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 454.5, 310.5, 235.5, 310.5 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-47", 0 ],
					"hidden" : 0,
					"midpoints" : [ 596.5, 483.0, 176.0, 483.0, 176.0, 310.0, 235.5, 310.0 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-63", 0 ],
					"hidden" : 0,
					"midpoints" : [ 377.5, 434.0, 322.5, 434.0 ],
					"source" : [ "obj-66", 0 ]
				}
