...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 343.0, 271.0, 238.0, 62.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 22.0, 448.0, 205.0, 18.0 ],
									"text" : "filter/set hub mode inclusion, explore"
								}
...
, 							{
								"box" : 								{
									...
									"framecolor" : [ 0.619608, 0.0, 0.360784, 0.701961 ],
									"id" : "obj-6",
									"items" : [ "degrade.1/in/amplitude.2", ",", "degrade.2/in/amplitude.2" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "degrade~.module.maxpat",
				"bootpath" : "/Users/jln/@Jamoma/Jamoma/Modules/Modular/Max/modules/audio/degrade~",
