{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 80.0, 53.0, 834.0, 726.0 ],
		"bglocked" : 0,
		"defrect" : [ 80.0, 53.0, 834.0, 726.0 ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 293.0, 44.0, 642.0, 821.0 ],
						"bglocked" : 0,
						"defrect" : [ 293.0, 44.0, 642.0, 821.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 190.0, 731.0, 345.0, 31.0 ],
									"text" : "- dump outlet to get back attribute's value by sending a message with the name of an attribute without argument"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 40.0, 731.0, 134.0, 19.0 ],
									"text" : "Right:"
								}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 125.0, 76.0, 805.0, 445.0 ],
						"bglocked" : 0,
						"defrect" : [ 125.0, 76.0, 805.0, 445.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 515.0, 44.0, 148.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 418.0, 309.0, 154.0, 17.0 ],
									"text" : "/my_toggle"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 515.0, 275.0, 57.0, 19.0 ],
									"text" : "jcom.hub"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 642.0, 675.0, 50.0, 17.0 ],
					"text" : "jcom.ui"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 577.0, 675.0, 57.0, 17.0 ],
					"text" : "jcom.hub"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 80.0, 366.0, 57.0, 19.0 ],
					"text" : "jcom.hub",
					"varname" : "jcom.hub"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-23", 0 ],
					"hidden" : 1,
					"midpoints" : [ 651.5, 698.0, 439.5, 698.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-23", 0 ],
					"hidden" : 1,
					"midpoints" : [ 586.5, 698.0, 439.5, 698.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 89.5, 472.0, 313.5, 472.0 ],
					"source" : [ "obj-70", 0 ]
				}
