...
private:
	...
	TTErr setDrive(const TTValue& value, const TTAttribute&);

	/**	Setter for the mode attribute. */
	TTErr setDCBlocker(const TTValue& value, const TTAttribute&);

	/**	Setter for the mode attribute. */
	TTErr setMode(const TTValue& value, const TTAttribute&);
